# Joplin — full product reference

**Evidence status:** `complete`  
**Product:** [https://joplinapp.org/](https://joplinapp.org/)  
**Upstream owner:** Joplin  
**Captured:** 2026-08-17T00:26:05.132261Z

## Authentic motion evidence

[Open local webm motion](media/motion.webm) — 640×360, 8.0 s, 96 frames, 37162 bytes.

Source: [https://www.youtube.com/watch?v=BtXgBYebR_Y](https://www.youtube.com/watch?v=BtXgBYebR_Y)  
...
SHA-256: `6a42b20d1418b9d8470e734ac942452705795a9d0bcd028ffc4980ac494ff18b`

## Retained key states

| State | Frame | Relationship to motion |
|---|---|---|
| launch and task context | ![launch and task context](media/state-1.png) | Extracted from `media/motion.webm`; 640×360; SHA-256 `5a72ada8bbb81f33ab45cea7876812439bf2fc77b807eb343fadd8fb6698dd2f` |
| focused primary-action state | ![focused primary-action state](media/state-2.png) | Extracted from `media/motion.webm`; 640×360; SHA-256 `7332a44f46f3f8e9f4194728279b7675768f2eca883162694afb6cc1fb5e0156` |
| first-success result | ![first-success result](media/state-3.png) | Extracted from `media/motion.webm`; 640×360; SHA-256 `4aa94314e180e3c9f39121d04a892240cfd2ee579f1a983a1444823d26f45f62` |
...
- Product source page: https://joplinapp.org/
- Original media/source recording: https://www.youtube.com/watch?v=BtXgBYebR_Y
- Upstream recording owner: Joplin
...
- Local motion bytes/SHA-256: 37162 / `6a42b20d1418b9d8470e734ac942452705795a9d0bcd028ffc4980ac494ff18b`
