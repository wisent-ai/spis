# Shotcut — full product reference

**Evidence status:** `complete`  
**Product:** [https://www.shotcut.org/](https://www.shotcut.org/)  
**Upstream owner:** Shotcut  
**Captured:** 2026-08-17T00:26:12.660037Z

## Authentic motion evidence

[Open local webm motion](media/motion.webm) — 640×360, 8.0 s, 96 frames, 46323 bytes.

Source: [https://www.youtube.com/watch?v=Z_ReXmLEGRA](https://www.youtube.com/watch?v=Z_ReXmLEGRA)  
...
SHA-256: `f87e694f70254e1130d0019512970f4b25b922d5ead15756ba6d6da792e0d771`

## Retained key states

| State | Frame | Relationship to motion |
|---|---|---|
| launch and task context | ![launch and task context](media/state-1.png) | Extracted from `media/motion.webm`; 640×360; SHA-256 `66b16f0c52813cb4da79e6782bb1f9a0dd538f56eb369eed8aaacf11c9480438` |
| focused primary-action state | ![focused primary-action state](media/state-2.png) | Extracted from `media/motion.webm`; 640×360; SHA-256 `8809538db7b2ae77fb1d1e6c3b5db4fdb473bd3714653dcbb907ed78f0d3af16` |
| first-success result | ![first-success result](media/state-3.png) | Extracted from `media/motion.webm`; 640×360; SHA-256 `047e91e28d169f6c8da24970c43caa9a76d584b943cbc46d4f92d39dd6030e3f` |
...
- Product source page: https://www.shotcut.org/
- Original media/source recording: https://www.youtube.com/watch?v=Z_ReXmLEGRA
- Upstream recording owner: Shotcut
...
- Local motion bytes/SHA-256: 46323 / `f87e694f70254e1130d0019512970f4b25b922d5ead15756ba6d6da792e0d771`
