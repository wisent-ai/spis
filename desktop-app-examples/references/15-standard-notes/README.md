# Standard Notes — full product reference

**Evidence status:** `complete`  
**Product:** [https://standardnotes.com/download](https://standardnotes.com/download)  
**Upstream owner:** Standard Notes  
**Captured:** 2026-08-17T00:26:07.249674Z

## Authentic motion evidence

[Open local webm motion](media/motion.webm) — 640×360, 8.0 s, 96 frames, 82883 bytes.

Source: [https://www.youtube.com/watch?v=bkp6nrGqjUM](https://www.youtube.com/watch?v=bkp6nrGqjUM)  
...
SHA-256: `d1d28080e268327a4451cbc121e5f54779389bb763b88e08adbfedcbf891a45a`

## Retained key states

| State | Frame | Relationship to motion |
|---|---|---|
| launch and task context | ![launch and task context](media/state-1.png) | Extracted from `media/motion.webm`; 640×360; SHA-256 `238817edee882dcae1ef713f12dfbc58020488632951ef9b96248f7a091651bc` |
| focused primary-action state | ![focused primary-action state](media/state-2.png) | Extracted from `media/motion.webm`; 640×360; SHA-256 `c335d99efd333432906138129f76ba606790b08b5255f880c28875106bd7aa73` |
| first-success result | ![first-success result](media/state-3.png) | Extracted from `media/motion.webm`; 640×360; SHA-256 `86764547b7e691bc11f6579262f216849e73dce7dcaba211c10c188ae80decbe` |
...
|---:|---|---|---|---|
| 1 | launch and choose a local workspace | The product window establishes the available task context. | start surface | `media/motion.webm and media/state-1.png` |
| 2 | create or select a page | The selected target becomes persistent and its content is exposed. | workspace or source selected | `media/motion.webm and media/state-1.png` |
| 3 | focus the editor | The primary control accepts focus and exposes editable or actionable state. | primary input focused | `media/motion.webm and media/state-2.png` |
| 4 | enter content | The task-specific input is visible and ready for commitment. | action ready for confirmation | `media/motion.webm and media/state-2.png` |
| 5 | confirm or allow autosave | The product acknowledges the command and transitions without a detached interstitial. | operation in progress | `media/motion.webm and media/state-2.png` |
| 6 | observe the content in its saved context | The resulting content, status, playback, transfer, document, or response is visibly present. | first meaningful result | `media/motion.webm and media/state-3.png` |
...
Completion evidence: The final portion of media/motion.webm and media/state-3.png retain the visible first meaningful result for create a first note or page.
...
- Product source page: https://standardnotes.com/download
- Original media/source recording: https://www.youtube.com/watch?v=bkp6nrGqjUM
- Upstream recording owner: Standard Notes
...
- Local motion bytes/SHA-256: 82883 / `d1d28080e268327a4451cbc121e5f54779389bb763b88e08adbfedcbf891a45a`
