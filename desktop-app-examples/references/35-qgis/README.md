# QGIS — full product reference

**Evidence status:** `complete`  
**Product:** [https://qgis.org/](https://qgis.org/)  
**Upstream owner:** IT34  
**Captured:** 2026-08-17T00:26:12.236659Z

## Authentic motion evidence

[Open local webm motion](media/motion.webm) — 640×360, 8.0 s, 96 frames, 96914 bytes.

Source: [https://www.youtube.com/watch?v=idQvOMWNMGI](https://www.youtube.com/watch?v=idQvOMWNMGI)  
...
SHA-256: `442fdec2d97dc4281d82b9920dfb77310a7d778a561505ff3f5445f7307b9c8f`

## Retained key states

| State | Frame | Relationship to motion |
|---|---|---|
| launch and task context | ![launch and task context](media/state-1.png) | Extracted from `media/motion.webm`; 640×360; SHA-256 `4f7a84caf1f5bf56c966b4e56686978a74fad4070c2c7dfb01d89d4eebb62e5a` |
| focused primary-action state | ![focused primary-action state](media/state-2.png) | Extracted from `media/motion.webm`; 640×360; SHA-256 `71be6a797eafc2d3f793005ea64b83c6997ae4a2bd1e25bcf9e7776a4a35d853` |
| first-success result | ![first-success result](media/state-3.png) | Extracted from `media/motion.webm`; 640×360; SHA-256 `7d3a9bb28866eb0badf3834cb413734825321197fe66ad161daf8a33b49decda` |
...
- Product source page: https://qgis.org/
- Original media/source recording: https://www.youtube.com/watch?v=idQvOMWNMGI
- Upstream recording owner: IT34
...
- Local motion bytes/SHA-256: 96914 / `442fdec2d97dc4281d82b9920dfb77310a7d778a561505ff3f5445f7307b9c8f`
