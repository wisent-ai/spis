# Logseq — full product reference

**Evidence status:** `complete`  
**Product:** [https://logseq.com/](https://logseq.com/)  
**Upstream owner:** Logseq  
**Captured:** 2026-08-17T00:26:06.900719Z

## Authentic motion evidence

[Open local webm motion](media/motion.webm) — 640×360, 8.0 s, 96 frames, 40685 bytes.

Source: [https://www.youtube.com/watch?v=hz2BacySDXE](https://www.youtube.com/watch?v=hz2BacySDXE)  
...
SHA-256: `06a09c5af0ef097bafeced6f87a789da619b0ecfc9114472fb23d3c32d1a796f`

## Retained key states

| State | Frame | Relationship to motion |
|---|---|---|
| launch and task context | ![launch and task context](media/state-1.png) | Extracted from `media/motion.webm`; 640×360; SHA-256 `9b3fabd6264c7f08915f35d52e285201a3deb28f4bacb8209982092544a5a933` |
| focused primary-action state | ![focused primary-action state](media/state-2.png) | Extracted from `media/motion.webm`; 640×360; SHA-256 `aaea709efee4672c9bd4c28f7ab375bc67f66a946008efbb940a42979322b64e` |
| first-success result | ![first-success result](media/state-3.png) | Extracted from `media/motion.webm`; 640×360; SHA-256 `4ac3650ca9d05865004d0a25f358e6b1899ba11a4d3fa587e8d0aa22d84445da` |
...
- Product source page: https://logseq.com/
- Original media/source recording: https://www.youtube.com/watch?v=hz2BacySDXE
- Upstream recording owner: Logseq
...
- Local motion bytes/SHA-256: 40685 / `06a09c5af0ef097bafeced6f87a789da619b0ecfc9114472fb23d3c32d1a796f`
