# Godot Engine — full product reference

**Evidence status:** `complete`  
**Product:** [https://godotengine.org/](https://godotengine.org/)  
**Upstream owner:** Brackeys  
**Captured:** 2026-08-17T00:26:15.141485Z

## Authentic motion evidence

[Open local webm motion](media/motion.webm) — 640×360, 8.0 s, 96 frames, 78071 bytes.

Source: [https://www.youtube.com/watch?v=LOhfqjmasi0](https://www.youtube.com/watch?v=LOhfqjmasi0)  
...
SHA-256: `b4dcd7cab5f1152da66f28fb07e917dc5e3be36bae00c5797f2f1f062a4e3c01`

## Retained key states

| State | Frame | Relationship to motion |
|---|---|---|
| launch and task context | ![launch and task context](media/state-1.png) | Extracted from `media/motion.webm`; 640×360; SHA-256 `8968b7577d0e59c4a6d3a6c58952f5710ea6a0705ac51c9daa35b230a293349b` |
| focused primary-action state | ![focused primary-action state](media/state-2.png) | Extracted from `media/motion.webm`; 640×360; SHA-256 `db78f07a170d7437621b03a552698ca7d6635f0825116284cc674faefbdcae5d` |
| first-success result | ![first-success result](media/state-3.png) | Extracted from `media/motion.webm`; 640×360; SHA-256 `25b51f9cfa471a21b220f894e04f217a25de29c615839e19b3fbcfc79d6b7f58` |
...
- Product source page: https://godotengine.org/
- Original media/source recording: https://www.youtube.com/watch?v=LOhfqjmasi0
- Upstream recording owner: Brackeys
...
- Local motion bytes/SHA-256: 78071 / `b4dcd7cab5f1152da66f28fb07e917dc5e3be36bae00c5797f2f1f062a4e3c01`
