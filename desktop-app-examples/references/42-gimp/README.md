# GIMP — full product reference

**Evidence status:** `complete`  
**Product:** [https://www.gimp.org/](https://www.gimp.org/)  
**Upstream owner:** GNU Image Manipulation Program  
**Captured:** 2026-08-17T00:26:13.693578Z

## Authentic motion evidence

[Open local webm motion](media/motion.webm) — 640×360, 8.0 s, 96 frames, 65473 bytes.

Source: [https://www.youtube.com/watch?v=-MnTVb59iwc](https://www.youtube.com/watch?v=-MnTVb59iwc)  
...
SHA-256: `d3f3e3679845d20e675190f142eaa5192e62b80656812216b3bf1bef2c6cb15d`

## Retained key states

| State | Frame | Relationship to motion |
|---|---|---|
| launch and task context | ![launch and task context](media/state-1.png) | Extracted from `media/motion.webm`; 640×360; SHA-256 `c8eb7dca005aeedeb927010bf66c469e3252e720787feaddc7de183ad721ae7b` |
| focused primary-action state | ![focused primary-action state](media/state-2.png) | Extracted from `media/motion.webm`; 640×360; SHA-256 `8ad277cef3136e164a02ff7375d284741bc2d71c70b79dd77e92f261e551d6b6` |
| first-success result | ![first-success result](media/state-3.png) | Extracted from `media/motion.webm`; 640×360; SHA-256 `7884cba3b3d9943921b070d6895db5ad665ffe2cccc6823169da072d34ae5e8c` |
...
- Product source page: https://www.gimp.org/
- Original media/source recording: https://www.youtube.com/watch?v=-MnTVb59iwc
- Upstream recording owner: GNU Image Manipulation Program
...
- Local motion bytes/SHA-256: 65473 / `d3f3e3679845d20e675190f142eaa5192e62b80656812216b3bf1bef2c6cb15d`
