# Microsoft Defender for Cloud recommendations — full product reference

**Evidence status:** complete  
**Product:** [Microsoft Defender for Cloud recommendations](https://learn.microsoft.com/en-us/azure/defender-for-cloud/review-security-recommendations)  
**Upstream owner:** Microsoft Security  
...
The local motion is an authentic upstream product demonstration retained through Downloaded the upstream-published YouTube video through the Cobalt media gateway, then transcoded a continuous 12-second excerpt beginning at source timestamp 70s; no frames were synthesized. It is not an animation synthesized from the state images.

| Property | Value |
|---|---|
| Source | [https://www.youtube.com/watch?v=nE6tFjP7Juc&t=70s](https://www.youtube.com/watch?v=nE6tFjP7Juc&t=70s) |
| Local file | [`media/journey.mp4`](media/journey.mp4) |
| Kind | `video/mp4` |
| Dimensions | 256 × 144 |
| Duration / frames | 12.012 seconds / 360 frames |
| Bytes | 32993 |
| SHA-256 | `fccd4d690a24ded2bca844151f19c55a0620e885f1c39711c5dc63917655c53e` |
| Capture method | Downloaded the upstream-published YouTube video through the Cobalt media gateway, then transcoded a continuous 12-second excerpt beginning at source timestamp 70s; no frames were synthesized |
...
|---|---|---|
| evidence ready | ![Microsoft Defender for Cloud recommendations evidence ready](media/state-01.png) | `79d3691b709053fd0fd746c7ea2d5a47ed62da2b17552f6361e3672cd78636fa` |
| overview visible | ![Microsoft Defender for Cloud recommendations overview visible](media/state-02.png) | `83fb2f3c24c92570a0d8c4aad2e0ab530d01f2122ab5722c645c296a02834239` |
| paused detail | ![Microsoft Defender for Cloud recommendations paused detail](media/state-03.png) | `20950edf07fa597860e45611c81e250412f03cae08344d8056ad0b706a6243d2` |
| deeper evidence | ![Microsoft Defender for Cloud recommendations deeper evidence](media/state-04.png) | `13f6c1686393bd30055234f85db8cf7252d66f9ba18ea3a0a4945ba0dc8ecdb9` |
| completion evidence | ![Microsoft Defender for Cloud recommendations completion evidence](media/state-05.png) | `fdc9ff50a37aeed1e1f39a904d64a82106142e317125d9cfc305645103ec8b44` |

## First-success investigation journey

**Actor:** A reviewer validating a summary claim against product-native evidence  
**Goal:** Study recommendation detail pages that connect severity, affected resources, policy rationale, remediation steps, and exemption actions.
