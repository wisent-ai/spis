# Jenkins Blue Ocean — full product reference

**Evidence status:** complete  
**Product:** [Jenkins Blue Ocean](https://www.jenkins.io/doc/book/blueocean/)  
**Upstream owner:** Jenkins  
...
| Property | Value |
|---|---|
| Source | [https://www.youtube.com/watch?v=NSpl0kbdIYg&t=180s](https://www.youtube.com/watch?v=NSpl0kbdIYg&t=180s) |
| Local file | [`media/journey.mp4`](media/journey.mp4) |
| Kind | `video/mp4` |
| Dimensions | 1280 × 720 |
| Duration / frames | 12.0 seconds / 360 frames |
| Bytes | 42487 |
| SHA-256 | `74d1d8dbe61d095a16074955504ac3b341b71869f93cb508f91282b39ab7b373` |
...
|---|---|---|
| evidence ready | ![Jenkins Blue Ocean evidence ready](media/state-01.png) | `dc79786ac892f3330fd5f011cc3d6436bb4d21bfc317efc95a66ad20ee49100b` |
| overview visible | ![Jenkins Blue Ocean overview visible](media/state-02.png) | `01e991d581d6e54cb3c4976bc874fed83f7b3f89ed5d7f3b2897fbbec267d075` |
| paused detail | ![Jenkins Blue Ocean paused detail](media/state-03.png) | `742b11a9d965ef23ed8be1e49cabe0ff9f68f797df379f8ce8571cfbe535ae53` |
| deeper evidence | ![Jenkins Blue Ocean deeper evidence](media/state-04.png) | `af9a8259ead3a51597c87b318fa8b866e54706d145a1364ee4af5deb8070a914` |
| completion evidence | ![Jenkins Blue Ocean completion evidence](media/state-05.png) | `b9ad4ae29279994c2789dc6e5f191a78d366770b8ee219c8bc7156c2cd68975d` |

## First-success investigation journey

**Actor:** A reviewer validating a summary claim against product-native evidence  
**Goal:** Study the visual pipeline and stage-level log drill-down pattern for locating failures without losing the overall execution structure.
