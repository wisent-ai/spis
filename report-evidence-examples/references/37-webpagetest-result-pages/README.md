# WebPageTest result pages — full product reference

**Evidence status:** complete  
**Product:** [WebPageTest result pages](https://www.webpagetest.org/)  
**Upstream owner:** WebPageTest by Catchpoint  
...
| Property | Value |
|---|---|
| Source | [https://www.youtube.com/watch?v=vp9Fga1uB8s&t=180s](https://www.youtube.com/watch?v=vp9Fga1uB8s&t=180s) |
| Local file | [`media/journey.mp4`](media/journey.mp4) |
| Kind | `video/mp4` |
| Dimensions | 256 × 144 |
| Duration / frames | 12.0 seconds / 360 frames |
| Bytes | 24532 |
| SHA-256 | `a286f9351eec1d93fc2573fd6507434654739b39312e105d830e8bfe4b8e1e24` |
...
|---|---|---|
| evidence ready | ![WebPageTest result pages evidence ready](media/state-01.png) | `d74c857bb78e0c6510f3f4e0dbfc2f7a966ea75d23c1737184dddc93996977ab` |
| overview visible | ![WebPageTest result pages overview visible](media/state-02.png) | `cd88f705eb08d96536891abba53d16efc1403471b6c1e0d83ce98f6e4e528e60` |
| paused detail | ![WebPageTest result pages paused detail](media/state-03.png) | `f8c7a13bc90e3d7ad311ac05f1912ef96cfa890619f84b0e93416b99df248766` |
| deeper evidence | ![WebPageTest result pages deeper evidence](media/state-04.png) | `d4fcd8aaa6653e1501031b372c2207ae694edd5774b157bf8d7b9ecf82c9a28a` |
| completion evidence | ![WebPageTest result pages completion evidence](media/state-05.png) | `08ee3b4a5a6022dac4e33b9ed66d4a5224c71d7a1bbfcf4243aa4e9fe6917989` |

## First-success investigation journey

**Actor:** A reviewer validating a summary claim against product-native evidence  
**Goal:** Study the test summary, filmstrip, waterfall, metrics, and repeat-view comparison for tying performance claims to captured run evidence.
