# GitLab pipeline details — full product reference

**Evidence status:** complete  
**Product:** [GitLab pipeline details](https://docs.gitlab.com/ci/pipelines/)  
...
| Property | Value |
|---|---|
| Source | [https://www.youtube.com/watch?v=W_DsNl5aAVk&t=180s](https://www.youtube.com/watch?v=W_DsNl5aAVk&t=180s) |
| Local file | [`media/journey.mp4`](media/journey.mp4) |
| Kind | `video/mp4` |
| Dimensions | 256 × 144 |
| Duration / frames | 12.0 seconds / 360 frames |
| Bytes | 38649 |
| SHA-256 | `d4a869d8e1d16ea63b15350fb818962f63420c1ee7e8c8293d5b2bea5b611ad7` |
...
|---|---|---|
| evidence ready | ![GitLab pipeline details evidence ready](media/state-01.png) | `02f4e91fafca6ae9a54e7eb3e062126071ab808f9dae51f052d567797a3ee576` |
| overview visible | ![GitLab pipeline details overview visible](media/state-02.png) | `3955216d51767607f338beabf993df3d9e7e5bc535a6ad74a5f9e67f75d88fbc` |
| paused detail | ![GitLab pipeline details paused detail](media/state-03.png) | `62a5b140af2bf37d9ff05b6e2ee3c59239af646964a9cf2bf09810449bc550d7` |
| deeper evidence | ![GitLab pipeline details deeper evidence](media/state-04.png) | `9a001c7b85492a5fba755a832b37746364f1997089989310a5b881caca6cf75f` |
| completion evidence | ![GitLab pipeline details completion evidence](media/state-05.png) | `06c70c2cd7e491849287c8e57ef6fbe65ed246bc45abe386ff33de55083fe44e` |

## First-success investigation journey

**Actor:** A reviewer validating a summary claim against product-native evidence  
**Goal:** Study the pipeline graph and job detail transition, which preserves dependency context while exposing logs, artifacts, and retry actions.
