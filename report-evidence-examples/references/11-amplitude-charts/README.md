# Amplitude Charts — full product reference

**Evidence status:** complete  
**Product:** [Amplitude Charts](https://amplitude.com/docs/analytics/charts)  
**Upstream owner:** Amplitude  
...
The local motion is an authentic upstream product demonstration retained through Downloaded the upstream-published YouTube video through the Cobalt media gateway, then transcoded a continuous 12-second excerpt beginning at source timestamp 166s; no frames were synthesized. It is not an animation synthesized from the state images.

| Property | Value |
|---|---|
| Source | [https://www.youtube.com/watch?v=uh6laOWxR5A&t=166s](https://www.youtube.com/watch?v=uh6laOWxR5A&t=166s) |
| Local file | [`media/journey.mp4`](media/journey.mp4) |
| Kind | `video/mp4` |
| Dimensions | 256 × 144 |
| Duration / frames | 11.97 seconds / 287 frames |
| Bytes | 21060 |
| SHA-256 | `ce7c1633c2dd234fb415273965a099304c0f10c3eeddae679f923325910e130e` |
| Capture method | Downloaded the upstream-published YouTube video through the Cobalt media gateway, then transcoded a continuous 12-second excerpt beginning at source timestamp 166s; no frames were synthesized |
...
|---|---|---|
| evidence ready | ![Amplitude Charts evidence ready](media/state-01.png) | `84c8d33255bb302f1caaebee2015ab3cfe4defdac47978f135570d18ce5a0f72` |
| overview visible | ![Amplitude Charts overview visible](media/state-02.png) | `84c8d33255bb302f1caaebee2015ab3cfe4defdac47978f135570d18ce5a0f72` |
| paused detail | ![Amplitude Charts paused detail](media/state-03.png) | `4fc692a20dcfbc97ae3c185aa0694e0575623a4da6e5a297a307d1a35eafd9f4` |
| deeper evidence | ![Amplitude Charts deeper evidence](media/state-04.png) | `749de26e01c4d7b1c03bcf04767eea45101c729fbf745fc35c134d6dbda02948` |
| completion evidence | ![Amplitude Charts completion evidence](media/state-05.png) | `d183497b9f3be2739bfb61028dcdeaa0c431b5bbf55f99510acb97a21725cafd` |

## First-success investigation journey

**Actor:** A reviewer validating a summary claim against product-native evidence  
**Goal:** Study chart-specific controls for segmentation, cohorts, and conversion windows, with definitions kept visible beside behavioral results.
