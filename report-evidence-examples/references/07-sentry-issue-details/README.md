# Sentry Issue Details — full product reference

**Evidence status:** complete  
**Product:** [Sentry Issue Details](https://docs.sentry.io/product/issues/issue-details/)  
...
| Property | Value |
|---|---|
| Source | [https://www.youtube.com/watch?v=4djseRVSan8&t=93s](https://www.youtube.com/watch?v=4djseRVSan8&t=93s) |
| Local file | [`media/journey.mp4`](media/journey.mp4) |
| Kind | `video/mp4` |
| Dimensions | 256 × 144 |
| Duration / frames | 12.0 seconds / 360 frames |
| Bytes | 27031 |
| SHA-256 | `9dddb40e22ed7d76fd457ce847332a5fb34a3add6cdf47efe0e9025df9769be2` |
...
|---|---|---|
| evidence ready | ![Sentry Issue Details evidence ready](media/state-01.png) | `b4eaed27cebdc44b5cc110dddc47c4e8ad2cfaf31c2ae97b3aa4f50e424b2678` |
| overview visible | ![Sentry Issue Details overview visible](media/state-02.png) | `ec424d47378424b4c0fd9ecba6f21ce94d27fd8682f83b28b594161c26ee5593` |
| paused detail | ![Sentry Issue Details paused detail](media/state-03.png) | `d881208113591af64212ee9fefcdac6fbe89e2f853f3465ad60a9239b182daf6` |
| deeper evidence | ![Sentry Issue Details deeper evidence](media/state-04.png) | `c4315539de2ad9a0691aaa8d404b244b3f73c1933248663328af2a2b0be4d643` |
| completion evidence | ![Sentry Issue Details completion evidence](media/state-05.png) | `be72b3fa5734228604c86a24697343d9f56d4fbe73be3fa62dca7c696761d5ea` |

## First-success investigation journey

**Actor:** A reviewer validating a summary claim against product-native evidence  
**Goal:** Study the issue detail layout that connects stack trace evidence, breadcrumbs, tags, frequency, ownership, and resolution actions.
