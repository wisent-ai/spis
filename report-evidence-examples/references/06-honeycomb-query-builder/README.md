# Honeycomb Query Builder — full product reference

**Evidence status:** complete  
**Product:** [Honeycomb Query Builder](https://docs.honeycomb.io/investigate/query/)  
**Upstream owner:** Honeycomb  
...
The local motion is an authentic upstream product demonstration retained through Downloaded the upstream-published YouTube video through the Cobalt media gateway, then transcoded a continuous 12-second excerpt beginning at source timestamp 77s; no frames were synthesized. It is not an animation synthesized from the state images.

| Property | Value |
|---|---|
| Source | [https://www.youtube.com/watch?v=hQKSlB7Ck68&t=77s](https://www.youtube.com/watch?v=hQKSlB7Ck68&t=77s) |
| Local file | [`media/journey.mp4`](media/journey.mp4) |
| Kind | `video/mp4` |
| Dimensions | 256 × 144 |
| Duration / frames | 12.0 seconds / 360 frames |
| Bytes | 91705 |
| SHA-256 | `d8fb0f3a8433811dd8b45794f0cceb741dd7f65171e5e6ceaa543222e641e407` |
| Capture method | Downloaded the upstream-published YouTube video through the Cobalt media gateway, then transcoded a continuous 12-second excerpt beginning at source timestamp 77s; no frames were synthesized |
...
|---|---|---|
| evidence ready | ![Honeycomb Query Builder evidence ready](media/state-01.png) | `1ff7bdb10806b7f8d514736c5bbea7cca3a8f215f7ad4000b44e5975e28cfb08` |
| overview visible | ![Honeycomb Query Builder overview visible](media/state-02.png) | `0a93c61fabdca2e547707f0f837519b55175f041c723932f5e37ba9d1b4b4b14` |
| paused detail | ![Honeycomb Query Builder paused detail](media/state-03.png) | `fa51cab21327d3f0324ac523ea4cf450fb3f402f9920d0dca196e84ef70a830d` |
| deeper evidence | ![Honeycomb Query Builder deeper evidence](media/state-04.png) | `05775101779e39840368cc10046ae8973dfe3a46095be9b2fa4bfe7dbfadf8b3` |
| completion evidence | ![Honeycomb Query Builder completion evidence](media/state-05.png) | `0d773ea6f76c0f5701fcddf92ac36e86ecafdf5011d2515f195a95681b6ff015` |

## First-success investigation journey

**Actor:** A reviewer validating a summary claim against product-native evidence  
**Goal:** Study the visual query composition and result breakdown workflow for comparing dimensions without hiding the underlying query definition.
