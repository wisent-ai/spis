# AWS Security Hub findings — full product reference

**Evidence status:** complete  
**Product:** [AWS Security Hub findings](https://docs.aws.amazon.com/securityhub/latest/userguide/securityhub-findings.html)  
...
The local motion is an authentic upstream product demonstration retained through Downloaded the upstream-published YouTube video through the Cobalt media gateway, then transcoded a continuous 12-second excerpt beginning at source timestamp 80s; no frames were synthesized. It is not an animation synthesized from the state images.

| Property | Value |
|---|---|
| Source | [https://www.youtube.com/watch?v=nBusvrDEjdk&t=80s](https://www.youtube.com/watch?v=nBusvrDEjdk&t=80s) |
| Local file | [`media/journey.mp4`](media/journey.mp4) |
| Kind | `video/mp4` |
| Dimensions | 256 × 144 |
| Duration / frames | 12.0 seconds / 360 frames |
| Bytes | 21784 |
| SHA-256 | `df6c18afd90ed7d664c6a1982c6245651036d862b0ea51526801502816696b01` |
| Capture method | Downloaded the upstream-published YouTube video through the Cobalt media gateway, then transcoded a continuous 12-second excerpt beginning at source timestamp 80s; no frames were synthesized |
...
|---|---|---|
| evidence ready | ![AWS Security Hub findings evidence ready](media/state-01.png) | `c482effe6097da8bd9ac192bd595343754762108944e8f93209fd0847fda1e0f` |
| overview visible | ![AWS Security Hub findings overview visible](media/state-02.png) | `2c3dc9548d1674a587806d7c27d02dcc974c1bbcae98cc88c9278cb8b24cde65` |
| paused detail | ![AWS Security Hub findings paused detail](media/state-03.png) | `2c3dc9548d1674a587806d7c27d02dcc974c1bbcae98cc88c9278cb8b24cde65` |
| deeper evidence | ![AWS Security Hub findings deeper evidence](media/state-04.png) | `2c3dc9548d1674a587806d7c27d02dcc974c1bbcae98cc88c9278cb8b24cde65` |
| completion evidence | ![AWS Security Hub findings completion evidence](media/state-05.png) | `7bb8c4ede507cac96853ce6fca0fdb0ad3b3a87d820019ee6dcfe56aa03546e3` |

## First-success investigation journey

**Actor:** A reviewer validating a summary claim against product-native evidence  
**Goal:** Study normalized finding records with provider provenance, severity, resource context, workflow status, and links to remediation actions.
