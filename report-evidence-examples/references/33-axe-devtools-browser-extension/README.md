# axe DevTools browser extension — full product reference

**Evidence status:** complete  
**Product:** [axe DevTools browser extension](https://docs.deque.com/devtools-for-web/4/en/overview)  
**Upstream owner:** Deque Systems  
...
The local motion is an authentic upstream product demonstration retained through Downloaded the upstream-published YouTube video through the Cobalt media gateway, then transcoded a continuous 12-second excerpt beginning at source timestamp 66s; no frames were synthesized. It is not an animation synthesized from the state images.

| Property | Value |
|---|---|
| Source | [https://www.youtube.com/watch?v=INY9hgHVoRk&t=66s](https://www.youtube.com/watch?v=INY9hgHVoRk&t=66s) |
| Local file | [`media/journey.mp4`](media/journey.mp4) |
| Kind | `video/mp4` |
| Dimensions | 256 × 144 |
| Duration / frames | 12.0 seconds / 360 frames |
| Bytes | 53825 |
| SHA-256 | `45f955742bfb656b8575605dabe43c2ee3762ab0ceef7cb0e2287aec6243452a` |
| Capture method | Downloaded the upstream-published YouTube video through the Cobalt media gateway, then transcoded a continuous 12-second excerpt beginning at source timestamp 66s; no frames were synthesized |
...
|---|---|---|
| evidence ready | ![axe DevTools browser extension evidence ready](media/state-01.png) | `b946ce7ec356de18f85932b7638db398bea96a1b3e2f0ab2e84fa4794d760114` |
| overview visible | ![axe DevTools browser extension overview visible](media/state-02.png) | `436eb379d02acba2245102ce8f292016c57761944086bfd9484a5e6e569cf05d` |
| paused detail | ![axe DevTools browser extension paused detail](media/state-03.png) | `05f438833146a4d697b3d69d9dc6d8aa4fd4a7e356ac99439653fe6740c5ad17` |
| deeper evidence | ![axe DevTools browser extension deeper evidence](media/state-04.png) | `369cd92f1313722355c29464d55640d0dcc9c0d80539f555c5417d27bc810819` |
| completion evidence | ![axe DevTools browser extension completion evidence](media/state-05.png) | `388610e1fee34359980136c49347bb9d1af3282a5c4fcbb64fc8bc206edd19ec` |

## First-success investigation journey

**Actor:** A reviewer validating a summary claim against product-native evidence  
**Goal:** Study issue lists that pair impact severity and rule rationale with highlighted page elements, source evidence, and repair guidance.
