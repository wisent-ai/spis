# OWASP ZAP reports — full product reference

**Evidence status:** complete  
**Product:** [OWASP ZAP reports](https://www.zaproxy.org/docs/desktop/addons/report-generation/)  
**Upstream owner:** OWASP Foundation  
...
The local motion is an authentic upstream product demonstration retained through Downloaded the upstream-published YouTube video through the Cobalt media gateway, then transcoded a continuous 12-second excerpt beginning at source timestamp 360s; no frames were synthesized. It is not an animation synthesized from the state images.

| Property | Value |
|---|---|
| Source | [https://www.youtube.com/watch?v=SRego4k0XIo&t=360s](https://www.youtube.com/watch?v=SRego4k0XIo&t=360s) |
| Local file | [`media/journey.mp4`](media/journey.mp4) |
| Kind | `video/mp4` |
| Dimensions | 256 × 144 |
| Duration / frames | 11.979 seconds / 359 frames |
| Bytes | 42651 |
| SHA-256 | `cfda7bec71ea9c0390dd9958a00a0fb8f3a51814d2e0263dda3ed45e7626b83c` |
| Capture method | Downloaded the upstream-published YouTube video through the Cobalt media gateway, then transcoded a continuous 12-second excerpt beginning at source timestamp 360s; no frames were synthesized |
...
|---|---|---|
| evidence ready | ![OWASP ZAP reports evidence ready](media/state-01.png) | `63a2615fd13d60b670019de679acf41f6dbb89dc3cc8317bca8738b2751d6589` |
| overview visible | ![OWASP ZAP reports overview visible](media/state-02.png) | `b2428dfe700954b8629dbbd6843ada2e2f60bdcd7760fc755845b16dfb4a89b3` |
| paused detail | ![OWASP ZAP reports paused detail](media/state-03.png) | `4e4650cdd2edb6ada6c92a696f3bff469f418c97786651d38a3e855ca43414f7` |
| deeper evidence | ![OWASP ZAP reports deeper evidence](media/state-04.png) | `9d263f9e75a62990c893e86d8d5b7daa2c5718708e24da1f2dfff033254f553e` |
| completion evidence | ![OWASP ZAP reports completion evidence](media/state-05.png) | `6cf6b2ef3ae8d790ce582b6b9c9d365800573e2c211768e02385e93cab3c567c` |

## First-success investigation journey

**Actor:** A reviewer validating a summary claim against product-native evidence  
**Goal:** Study configurable report generation that preserves alert risk, confidence, affected URLs, evidence, and remediation guidance for export.
