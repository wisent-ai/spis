# Parca — full product reference

**Evidence status:** complete  
**Product:** [Parca](https://www.parca.dev/docs/overview)  
**Upstream owner:** Parca  
...
| Property | Value |
|---|---|
| Source | [https://www.youtube.com/watch?v=-WXZVmQvRCw&t=180s](https://www.youtube.com/watch?v=-WXZVmQvRCw&t=180s) |
| Local file | [`media/journey.mp4`](media/journey.mp4) |
| Kind | `video/mp4` |
| Dimensions | 256 × 144 |
| Duration / frames | 12.0 seconds / 288 frames |
| Bytes | 31180 |
| SHA-256 | `f9c05ed05fb557d1bec578cd383c37d84399ba841ef9fad5270fa5c5881da2a0` |
...
|---|---|---|
| evidence ready | ![Parca evidence ready](media/state-01.png) | `ea036870527420b53341382771c16bbeee99cc35b0cdb58080e58e3c860d9616` |
| overview visible | ![Parca overview visible](media/state-02.png) | `b55fa662ff9bdad656097e609e3aad0e20fb1e0271a5b88c07788af3999fb24b` |
| paused detail | ![Parca paused detail](media/state-03.png) | `e10603ffed6b009c57f2d1cd9ed749f025698ae0598fadeb33a391732b81fd96` |
| deeper evidence | ![Parca deeper evidence](media/state-04.png) | `ee018bed2c7dbdb5f9058df9bd33198b95683883fc4c517d164d9319f141f860` |
| completion evidence | ![Parca completion evidence](media/state-05.png) | `39b8a5971990ad49b1ac415bc45d5b4bbf632fa7c6e892300c9bfd85be547a05` |

## First-success investigation journey

**Actor:** A reviewer validating a summary claim against product-native evidence  
**Goal:** Study label-based profile selection and interactive flame graphs that preserve query scope while drilling into stack-frame evidence.
