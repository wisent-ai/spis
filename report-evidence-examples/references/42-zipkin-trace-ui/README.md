# Zipkin trace UI — full product reference

**Evidence status:** complete  
**Product:** [Zipkin trace UI](https://zipkin.io/pages/quickstart.html)  
**Upstream owner:** Twitter University  
...
The local motion is an authentic upstream product demonstration retained through Downloaded the upstream-published YouTube video through the Cobalt media gateway, then transcoded a continuous 12-second excerpt beginning at source timestamp 600s; no frames were synthesized. It is not an animation synthesized from the state images.

| Property | Value |
|---|---|
| Source | [https://www.youtube.com/watch?v=EP4prWJIWvc&t=600s](https://www.youtube.com/watch?v=EP4prWJIWvc&t=600s) |
| Local file | [`media/journey.mp4`](media/journey.mp4) |
| Kind | `video/mp4` |
| Dimensions | 256 × 144 |
| Duration / frames | 12.012 seconds / 288 frames |
| Bytes | 16848 |
| SHA-256 | `8cd4e7c2d5f804a7c42b2e81e81588dd178ca3a1c611b03b3753d20426eba795` |
| Capture method | Downloaded the upstream-published YouTube video through the Cobalt media gateway, then transcoded a continuous 12-second excerpt beginning at source timestamp 600s; no frames were synthesized |
...
|---|---|---|
| evidence ready | ![Zipkin trace UI evidence ready](media/state-01.png) | `88ccfe3619f8f40351e62044eb850aaa9bc426844e973bba1e1429e0aa0b5a34` |
| overview visible | ![Zipkin trace UI overview visible](media/state-02.png) | `519cd2d3986959de65fa46deae75f1818bda4a7cecd50d00689c9b51e32460d3` |
| paused detail | ![Zipkin trace UI paused detail](media/state-03.png) | `08dae1fabe66720c14c0bf41bb4fc9902e30c2e52eb904c8c0f083f9b55f7a68` |
| deeper evidence | ![Zipkin trace UI deeper evidence](media/state-04.png) | `0f35124fcd01fdde7e1efca66b040493bfebaad5bf7033a28d503b2ae57a4ea9` |
| completion evidence | ![Zipkin trace UI completion evidence](media/state-05.png) | `6362cad0af83e3e309c4317e8afd7491e048b1251174b3a91e401367235c42d2` |

## First-success investigation journey

**Actor:** A reviewer validating a summary claim against product-native evidence  
**Goal:** Study dependency-aware trace lookup and waterfall inspection for comparing service latency while retaining span annotations and identifiers.
