# Apache Superset Explore — full product reference

**Evidence status:** complete  
**Product:** [Apache Superset Explore](https://superset.apache.org/docs/using-superset/exploring-data/)  
**Upstream owner:** The ASF  
...
| Property | Value |
|---|---|
| Source | [https://www.youtube.com/watch?v=7YnpKLZ1PRM&t=180s](https://www.youtube.com/watch?v=7YnpKLZ1PRM&t=180s) |
| Local file | [`media/journey.mp4`](media/journey.mp4) |
| Kind | `video/mp4` |
| Dimensions | 256 × 144 |
| Duration / frames | 12.012 seconds / 360 frames |
| Bytes | 25362 |
| SHA-256 | `2b48f4edec907943b2a08d16bd560a74a4597f6542582a8272550ed57303a24e` |
...
|---|---|---|
| evidence ready | ![Apache Superset Explore evidence ready](media/state-01.png) | `6f8f40b1e93d95ad26b79cb3e44bffd60ab96a2a5b080a1cae05241ed104840a` |
| overview visible | ![Apache Superset Explore overview visible](media/state-02.png) | `abaa7b0c2349fc85081f8f9e617d274b8bd6c423d73ef6bed81332d14c595333` |
| paused detail | ![Apache Superset Explore paused detail](media/state-03.png) | `38b31cd908ccc4222e1cc04773dcfcf052fe9db7092c9d5e886912b8f2028d96` |
| deeper evidence | ![Apache Superset Explore deeper evidence](media/state-04.png) | `2bcbd2dc7ec0d438c4c41a618e9bc6b9ec022276cb68c34307a433da25a2c6a2` |
| completion evidence | ![Apache Superset Explore completion evidence](media/state-05.png) | `b528bbe5577d6b3b36d7941f9d4086e640f78eeded2bbfc17c3bbc25fe84b652` |

## First-success investigation journey

**Actor:** A reviewer validating a summary claim against product-native evidence  
**Goal:** Study the no-code Explore workflow, where dataset, metric, filter, visualization, and query controls remain inspectable and reproducible.
