# GitHub Actions workflow run details — full product reference

**Evidence status:** complete  
**Product:** [GitHub Actions workflow run details](https://docs.github.com/en/actions/monitoring-and-troubleshooting-workflows/monitoring-workflows/viewing-workflow-run-history)  
...
| Property | Value |
|---|---|
| Source | [https://www.youtube.com/watch?v=BQrohJ3PT7I&t=121s](https://www.youtube.com/watch?v=BQrohJ3PT7I&t=121s) |
| Local file | [`media/journey.mp4`](media/journey.mp4) |
| Kind | `video/mp4` |
| Dimensions | 256 × 144 |
| Duration / frames | 11.979 seconds / 359 frames |
| Bytes | 41638 |
| SHA-256 | `a874782f6db6a8783e8f8e0ecadfef310e16eadb693f9166487557ef880af329` |
...
|---|---|---|
| evidence ready | ![GitHub Actions workflow run details evidence ready](media/state-01.png) | `88efda41c8a80aed5155be2831387ed1e710251c77921b44cf0f250988bbd435` |
| overview visible | ![GitHub Actions workflow run details overview visible](media/state-02.png) | `669407d6228e9f89d8443826226fa94d60ac931156d7d2b5494a47c242107e4f` |
| paused detail | ![GitHub Actions workflow run details paused detail](media/state-03.png) | `9e2953586a8cddff44dfd5e4ab3821b2c8156f0b734f8f24fc12e3a9d029a975` |
| deeper evidence | ![GitHub Actions workflow run details deeper evidence](media/state-04.png) | `df5354d24f29cd8e16a9fc2eed2002908fbb5aca3874347f98b5e68616c68518` |
| completion evidence | ![GitHub Actions workflow run details completion evidence](media/state-05.png) | `9e0e44af68ab595f1658470c60102144f691651cdca72396315074a108b3b487` |

## First-success investigation journey

**Actor:** A reviewer validating a summary claim against product-native evidence  
**Goal:** Study the job-and-step hierarchy, searchable logs, timestamps, artifacts, and rerun controls for diagnosing a specific workflow execution.
