# Dynatrace Problems — full product reference

**Evidence status:** complete  
**Product:** [Dynatrace Problems](https://docs.dynatrace.com/docs/dynatrace-intelligence/problems-app)  
**Upstream owner:** Dynatrace  
...
The local motion is an authentic upstream product demonstration retained through Downloaded the upstream-published YouTube video through the Cobalt media gateway, then transcoded a continuous 12-second excerpt beginning at source timestamp 155s; no frames were synthesized. It is not an animation synthesized from the state images.

| Property | Value |
|---|---|
| Source | [https://www.youtube.com/watch?v=Tud2K3zyync&t=155s](https://www.youtube.com/watch?v=Tud2K3zyync&t=155s) |
| Local file | [`media/journey.mp4`](media/journey.mp4) |
| Kind | `video/mp4` |
| Dimensions | 256 × 144 |
| Duration / frames | 12.0 seconds / 360 frames |
| Bytes | 20285 |
| SHA-256 | `ca36bd953c484a2d85b1637fd7babf6bea591601fafef9e8728f875cde663169` |
| Capture method | Downloaded the upstream-published YouTube video through the Cobalt media gateway, then transcoded a continuous 12-second excerpt beginning at source timestamp 155s; no frames were synthesized |
...
|---|---|---|
| evidence ready | ![Dynatrace Problems evidence ready](media/state-01.png) | `a552757af05038900c600602269318ffd92b3a542d6b9617fbcd96a82e74d829` |
| overview visible | ![Dynatrace Problems overview visible](media/state-02.png) | `23d2ecdcd0212b1baa0419aaa9b47ac2c29e6d657ed0955fa9caae1ee2a97263` |
| paused detail | ![Dynatrace Problems paused detail](media/state-03.png) | `15c23d6734294c93a231c3c959a4f945b864a630b50c8b8f828b20b2c6ab9c17` |
| deeper evidence | ![Dynatrace Problems deeper evidence](media/state-04.png) | `a901cc63680bd5ca205c6b873460fcb434285daf89eac169deaca7dfa8b9bb56` |
| completion evidence | ![Dynatrace Problems completion evidence](media/state-05.png) | `4d0bb6ef0a5e64f06e631ce8c7ac5031352c7af2bcbb11dbbfa7c1982054d396` |

## First-success investigation journey

**Actor:** A reviewer validating a summary claim against product-native evidence  
**Goal:** Study causal problem grouping and impact summaries that link detected symptoms to affected entities and recommended investigation paths.
