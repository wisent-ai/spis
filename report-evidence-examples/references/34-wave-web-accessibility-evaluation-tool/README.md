# WAVE web accessibility evaluation tool — full product reference

**Evidence status:** complete  
**Product:** [WAVE web accessibility evaluation tool](https://wave.webaim.org/)  
**Upstream owner:** WebAIM - Web Accessibility in Mind  
...
The local motion is an authentic upstream product demonstration retained through Downloaded the upstream-published YouTube video through the Cobalt media gateway, then transcoded a continuous 12-second excerpt beginning at source timestamp 170s; no frames were synthesized. It is not an animation synthesized from the state images.

| Property | Value |
|---|---|
| Source | [https://www.youtube.com/watch?v=ITUDiTgAZY0&t=170s](https://www.youtube.com/watch?v=ITUDiTgAZY0&t=170s) |
| Local file | [`media/journey.mp4`](media/journey.mp4) |
| Kind | `video/mp4` |
| Dimensions | 256 × 144 |
| Duration / frames | 12.0 seconds / 360 frames |
| Bytes | 25179 |
| SHA-256 | `190de70b739dbe1e71067be4967502a8bf588a2cfcd2c5ad6b39e4335914ae51` |
| Capture method | Downloaded the upstream-published YouTube video through the Cobalt media gateway, then transcoded a continuous 12-second excerpt beginning at source timestamp 170s; no frames were synthesized |
...
|---|---|---|
| evidence ready | ![WAVE web accessibility evaluation tool evidence ready](media/state-01.png) | `83638f624f38e794edbc8ee4422f32b56f3f1343769f6dfe3b80665b26dfd610` |
| overview visible | ![WAVE web accessibility evaluation tool overview visible](media/state-02.png) | `da45d029c282955a602df5c35630d59dd3ca06dfea149c37127ba90488614737` |
| paused detail | ![WAVE web accessibility evaluation tool paused detail](media/state-03.png) | `0968bf9c9522857e7168b789b9555eb61f94ce4b27165e4f405ec9ec2e9d2bed` |
| deeper evidence | ![WAVE web accessibility evaluation tool deeper evidence](media/state-04.png) | `4e70f0ed59060d4ac3226f5acf437eec1ba360724533435d0bb76ff090162f75` |
| completion evidence | ![WAVE web accessibility evaluation tool completion evidence](media/state-05.png) | `68484e65e78b2d75459621917182546f9b3a89fa9ad458d32fce4439f2dd7465` |

## First-success investigation journey

**Actor:** A reviewer validating a summary claim against product-native evidence  
**Goal:** Study in-page annotation icons and the details sidebar for connecting accessibility findings directly to their rendered-page locations.
