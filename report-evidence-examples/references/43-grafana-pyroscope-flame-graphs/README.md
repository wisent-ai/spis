# Grafana Pyroscope flame graphs — full product reference

**Evidence status:** complete  
**Product:** [Grafana Pyroscope flame graphs](https://grafana.com/docs/pyroscope/latest/view-and-analyze-profile-data/flamegraphs/)  
...
The local motion is an authentic upstream product demonstration retained through Downloaded the upstream-published YouTube video through the Cobalt media gateway, then transcoded a continuous 12-second excerpt beginning at source timestamp 109s; no frames were synthesized. It is not an animation synthesized from the state images.

| Property | Value |
|---|---|
| Source | [https://www.youtube.com/watch?v=XL2yTCPy2e0&t=109s](https://www.youtube.com/watch?v=XL2yTCPy2e0&t=109s) |
| Local file | [`media/journey.mp4`](media/journey.mp4) |
| Kind | `video/mp4` |
| Dimensions | 256 × 144 |
| Duration / frames | 12.0 seconds / 300 frames |
| Bytes | 38166 |
| SHA-256 | `dd3e0f25fbc3d865e38e9054db67e19a02249a1c9948d6fdc7fc6a730d40d366` |
| Capture method | Downloaded the upstream-published YouTube video through the Cobalt media gateway, then transcoded a continuous 12-second excerpt beginning at source timestamp 109s; no frames were synthesized |
...
|---|---|---|
| evidence ready | ![Grafana Pyroscope flame graphs evidence ready](media/state-01.png) | `c3aee3a1846a30073a93d0d401e619f069cead698e2db7ec4f314f828c1729d4` |
| overview visible | ![Grafana Pyroscope flame graphs overview visible](media/state-02.png) | `5f7c19307cdabb451b534c6fee16da36396fcadb4d74cc4bed9ec542e8a0b6f8` |
| paused detail | ![Grafana Pyroscope flame graphs paused detail](media/state-03.png) | `b50dc0304395303c0f13e5ffe20a4f554888a690370cc7945a688e61276ec2dd` |
| deeper evidence | ![Grafana Pyroscope flame graphs deeper evidence](media/state-04.png) | `6d71e75a8badaa6ef4cdfcb3790fbb8b4e17eda66ec446722430cce66af28688` |
| completion evidence | ![Grafana Pyroscope flame graphs completion evidence](media/state-05.png) | `b59ba90974d06d78de48e57a423b5f0485f9f81ece018c40983f8d707e2e4457` |

## First-success investigation journey

**Actor:** A reviewer validating a summary claim against product-native evidence  
**Goal:** Study flame-graph navigation and profile comparison for identifying expensive call paths and quantifying changes between selected periods.
