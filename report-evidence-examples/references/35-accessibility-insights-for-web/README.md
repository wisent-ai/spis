# Accessibility Insights for Web — full product reference

**Evidence status:** complete  
**Product:** [Accessibility Insights for Web](https://accessibilityinsights.io/docs/web/overview/)  
**Upstream owner:** Accessibility Insights  
...
| Property | Value |
|---|---|
| Source | [https://www.youtube.com/watch?v=XVvBJoEe4Is&t=49s](https://www.youtube.com/watch?v=XVvBJoEe4Is&t=49s) |
| Local file | [`media/journey.mp4`](media/journey.mp4) |
| Kind | `video/mp4` |
| Dimensions | 256 × 144 |
| Duration / frames | 12.0 seconds / 360 frames |
| Bytes | 36062 |
| SHA-256 | `2ab65637a59ff8a88f1d8330fba7b66afabdb612fd6d3837aa19f6c8329601f7` |
...
|---|---|---|
| evidence ready | ![Accessibility Insights for Web evidence ready](media/state-01.png) | `7268ca46b8bd36560936f9017e08bc165397a9c673e437d275eb6bfc68c91e55` |
| overview visible | ![Accessibility Insights for Web overview visible](media/state-02.png) | `75b05737af88f91d4a88b2a987919ffd77395419eb9dfa7c993e7bb82b9dbb40` |
| paused detail | ![Accessibility Insights for Web paused detail](media/state-03.png) | `29b11df368340af1867dd06f4ec122de91c3422cd2e0a716737dfa391c253f31` |
| deeper evidence | ![Accessibility Insights for Web deeper evidence](media/state-04.png) | `43d76bb61daedfd1c1fa08ce96c40117b17f4fbfefcda76d9b2384ac88b23af9` |
| completion evidence | ![Accessibility Insights for Web completion evidence](media/state-05.png) | `8481d4bb8697721fb93bec56e3bd64b1b22351729d64e903ceb90a8f5bf6ec89` |

## First-success investigation journey

**Actor:** A reviewer validating a summary claim against product-native evidence  
**Goal:** Study the progression from automated checks to guided assessment, with requirement-level instructions, evidence capture, and result export.
