# Jaeger UI — full product reference

**Evidence status:** complete  
**Product:** [Jaeger UI](https://www.jaegertracing.io/docs/latest/frontend-ui/)  
**Upstream owner:** CNCF [Cloud Native Computing Foundation]  
...
| Property | Value |
|---|---|
| Source | [https://www.youtube.com/watch?v=gH_JzIXFshI&t=180s](https://www.youtube.com/watch?v=gH_JzIXFshI&t=180s) |
| Local file | [`media/journey.mp4`](media/journey.mp4) |
| Kind | `video/mp4` |
| Dimensions | 256 × 144 |
| Duration / frames | 12.0 seconds / 288 frames |
| Bytes | 31470 |
| SHA-256 | `80db2ac37e85ea95fa74885e7f169dc72546069b65c743795a16801cbbe29bb8` |
...
|---|---|---|
| evidence ready | ![Jaeger UI evidence ready](media/state-01.png) | `e9506b43667554a9b05b4a604349101d0e3002c4bd563b209b154aea80f5f10e` |
| overview visible | ![Jaeger UI overview visible](media/state-02.png) | `9a1c65daa85cd9fa4ef4174a8f837ac14af30c184d18518eba5ba50a8d7a3a9c` |
| paused detail | ![Jaeger UI paused detail](media/state-03.png) | `ca0cd266387cd9d3c52463b40687bf5114078f65ac59db2a9371590198089e75` |
| deeper evidence | ![Jaeger UI deeper evidence](media/state-04.png) | `841ee90418d8cb852f264e014206d258836c9e59135477ecadf819ea60368bba` |
| completion evidence | ![Jaeger UI completion evidence](media/state-05.png) | `782c360ba81a085b7e52c4900febd3c51c1d5b13f0cbb4dc8db0cb9e4ce94ae8` |

## First-success investigation journey

**Actor:** A reviewer validating a summary claim against product-native evidence  
**Goal:** Study trace search followed by span waterfall drill-down, with service, operation, tags, logs, and timing retained as causal evidence.
