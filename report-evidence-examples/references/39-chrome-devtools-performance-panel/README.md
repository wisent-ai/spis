# Chrome DevTools Performance panel — full product reference

**Evidence status:** complete  
**Product:** [Chrome DevTools Performance panel](https://developer.chrome.com/docs/devtools/performance/overview)  
...
The local motion is an authentic upstream product demonstration retained through Downloaded the upstream-published YouTube video through the Cobalt media gateway, then transcoded a continuous 12-second excerpt beginning at source timestamp 88s; no frames were synthesized. It is not an animation synthesized from the state images.

| Property | Value |
|---|---|
| Source | [https://www.youtube.com/watch?v=M5oe010pYbA&t=88s](https://www.youtube.com/watch?v=M5oe010pYbA&t=88s) |
| Local file | [`media/journey.mp4`](media/journey.mp4) |
| Kind | `video/mp4` |
| Dimensions | 256 × 144 |
| Duration / frames | 12.012 seconds / 288 frames |
| Bytes | 100246 |
| SHA-256 | `a10373aac9ec0baeb3677a78999ddd0f16884c2500e43a79bac0ba56e791ec68` |
| Capture method | Downloaded the upstream-published YouTube video through the Cobalt media gateway, then transcoded a continuous 12-second excerpt beginning at source timestamp 88s; no frames were synthesized |
...
|---|---|---|
| evidence ready | ![Chrome DevTools Performance panel evidence ready](media/state-01.png) | `685a7a840206d28aed112a69a478ae85f8592dca98adc074e0f08c2991860bd2` |
| overview visible | ![Chrome DevTools Performance panel overview visible](media/state-02.png) | `c1e4c0f4fc845aadc501c69bdf204d674fd95d931afd349f6fbc661043130ae7` |
| paused detail | ![Chrome DevTools Performance panel paused detail](media/state-03.png) | `1054b3064b9bf622075032c4af09100e2e2725f00f203769da5da6444297004a` |
| deeper evidence | ![Chrome DevTools Performance panel deeper evidence](media/state-04.png) | `5fbc3722c91b75e7fca79b275c7f73aba52b4f9cc7252a60741ec7af48c0996c` |
| completion evidence | ![Chrome DevTools Performance panel completion evidence](media/state-05.png) | `16fc58f155a4ab3fb4d0b21fe91af3961496064313c14bbce8c2420ade959e02` |

## First-success investigation journey

**Actor:** A reviewer validating a summary claim against product-native evidence  
**Goal:** Study the synchronized timeline, flame chart, screenshots, and detail panes for tracing a visible slowdown to specific main-thread work.
