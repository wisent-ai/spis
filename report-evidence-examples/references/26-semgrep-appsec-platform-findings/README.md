# Semgrep AppSec Platform findings — full product reference

**Evidence status:** complete  
**Product:** [Semgrep AppSec Platform findings](https://docs.semgrep.dev/semgrep-code/findings)  
**Upstream owner:** semgrep  
...
| Property | Value |
|---|---|
| Source | [https://www.youtube.com/watch?v=MMR78pgYx_k&t=34s](https://www.youtube.com/watch?v=MMR78pgYx_k&t=34s) |
| Local file | [`media/journey.mp4`](media/journey.mp4) |
| Kind | `video/mp4` |
| Dimensions | 256 × 144 |
| Duration / frames | 11.97 seconds / 287 frames |
| Bytes | 46886 |
| SHA-256 | `091b365e7ee4b5c74cdb902b7a6f10c76de7e2b9cd31cbae5fc7e30db11d3bd2` |
...
|---|---|---|
| evidence ready | ![Semgrep AppSec Platform findings evidence ready](media/state-01.png) | `3c5a73e71897cb35a0ecf4b25a560e6e24f8b3c40a8afc21e9ed607b3b019bb2` |
| overview visible | ![Semgrep AppSec Platform findings overview visible](media/state-02.png) | `62f3923a68cf97974b5747163beb21703eb2de1f19d6d86beb689013b1cee31a` |
| paused detail | ![Semgrep AppSec Platform findings paused detail](media/state-03.png) | `2c09e64bf0dd6817c2878861c7d09b4052187303280189b27589cdc170676ceb` |
| deeper evidence | ![Semgrep AppSec Platform findings deeper evidence](media/state-04.png) | `3872be102423103185bada8e4dcae3de4773699d42e4171e696d3266594dfb6f` |
| completion evidence | ![Semgrep AppSec Platform findings completion evidence](media/state-05.png) | `e62db3a01b422b66ebe0ef75a6b9eef58808a2dcca729033169123c655604db8` |

## First-success investigation journey

**Actor:** A reviewer validating a summary claim against product-native evidence  
**Goal:** Study finding triage that combines rule identity, source location, severity, status, and code evidence with remediation workflow controls.
