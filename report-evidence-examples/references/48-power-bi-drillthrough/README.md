# Power BI drillthrough — full product reference

**Evidence status:** complete  
**Product:** [Power BI drillthrough](https://learn.microsoft.com/en-us/power-bi/create-reports/desktop-drillthrough)  
**Upstream owner:** Guy in a Cube  
...
The local motion is an authentic upstream product demonstration retained through Downloaded the upstream-published YouTube video through the Cobalt media gateway, then transcoded a continuous 12-second excerpt beginning at source timestamp 53s; no frames were synthesized. It is not an animation synthesized from the state images.

| Property | Value |
|---|---|
| Source | [https://www.youtube.com/watch?v=eYxRHJ0hB_E&t=53s](https://www.youtube.com/watch?v=eYxRHJ0hB_E&t=53s) |
| Local file | [`media/journey.mp4`](media/journey.mp4) |
| Kind | `video/mp4` |
| Dimensions | 256 × 144 |
| Duration / frames | 11.979 seconds / 359 frames |
| Bytes | 66678 |
| SHA-256 | `8ad25127a713f7a751e0e84bf7722060c8cb35012bae5d450b2932190c7bcf22` |
| Capture method | Downloaded the upstream-published YouTube video through the Cobalt media gateway, then transcoded a continuous 12-second excerpt beginning at source timestamp 53s; no frames were synthesized |
...
|---|---|---|
| evidence ready | ![Power BI drillthrough evidence ready](media/state-01.png) | `52b6a5c04d5046fad28fe4d46c8beea7173d46f7e84493cb896f81056791498c` |
| overview visible | ![Power BI drillthrough overview visible](media/state-02.png) | `d0beb7078e6393923836c508b1ca8b63e4f2faaf230766a0757b0f2306cf6eea` |
| paused detail | ![Power BI drillthrough paused detail](media/state-03.png) | `ff9a1a21419423936000a21be5dd970c316d9bd6c5f8e8295316e02008f74e56` |
| deeper evidence | ![Power BI drillthrough deeper evidence](media/state-04.png) | `568154f72b5d1aee3d1ff80fc3260c4ccefab28f7ce0b319d0c2b7ed3279bdc8` |
| completion evidence | ![Power BI drillthrough completion evidence](media/state-05.png) | `2404bcb45d6888266fb2a94364bd6ec6e775d7d7364553dbf5561020b9b9c469` |

## First-success investigation journey

**Actor:** A reviewer validating a summary claim against product-native evidence  
**Goal:** Study context-preserving drillthrough from a summary visual to a detail page, including carried filters and an explicit return path.
