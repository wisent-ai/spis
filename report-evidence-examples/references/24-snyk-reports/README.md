# Snyk Reports — full product reference

**Evidence status:** complete  
**Product:** [Snyk Reports](https://docs.snyk.io/manage-risk/reporting)  
**Upstream owner:** Snyk  
...
| Property | Value |
|---|---|
| Source | [https://www.youtube.com/watch?v=9RHM4ybvyT8&t=180s](https://www.youtube.com/watch?v=9RHM4ybvyT8&t=180s) |
| Local file | [`media/journey.mp4`](media/journey.mp4) |
| Kind | `video/mp4` |
| Dimensions | 256 × 144 |
| Duration / frames | 12.0 seconds / 360 frames |
| Bytes | 17898 |
| SHA-256 | `c95d06017b1169b637987539d0e33b6051a282c79e06b015c3d0c96141e39c66` |
...
|---|---|---|
| evidence ready | ![Snyk Reports evidence ready](media/state-01.png) | `64b75f7834beb22a59ecdc245609e128068cf3385436bddd593499d3f56715c3` |
| overview visible | ![Snyk Reports overview visible](media/state-02.png) | `a73b58b5e3ec912e8ace0a751c63de43f1303542629a44d8d071cb97b25d6f73` |
| paused detail | ![Snyk Reports paused detail](media/state-03.png) | `a73b58b5e3ec912e8ace0a751c63de43f1303542629a44d8d071cb97b25d6f73` |
| deeper evidence | ![Snyk Reports deeper evidence](media/state-04.png) | `fcbc6c46338c3aa4fbb875dc2d01fbb208ee0d5649ecf8cc75a36639763cb7e8` |
| completion evidence | ![Snyk Reports completion evidence](media/state-05.png) | `59b57f174757cb94b0da087a750db3a9412d07bd1a836191cdf320e3b208975e` |

## First-success investigation journey

**Actor:** A reviewer validating a summary claim against product-native evidence  
**Goal:** Study issue reporting by project, severity, and status, with export-oriented views for communicating remediation progress and exposure.
