# 05. Svelte Documentation — observed search/learn-to-first-answer reference

**Evidence status:** complete  
**Official product:** [https://svelte.dev/docs/svelte/overview](https://svelte.dev/docs/svelte/overview)  
**Playable motion:** [motion.webm](media/motion.webm)  
**Captured:** 2026-08-16T23:06:22.683Z

This is a real live-product recording from a Weles browser on the Stado-selected dedicated `charless-mac-mini` host, not an animation synthesized from catalog stills. It retains a five-state path from landing through failed lookup, recovery with **runes**, and the first useful official answer.

## Local evidence

- [`media/motion.webm`](media/motion.webm): 640×360, 13.48 seconds, 337 decoded frames, 384101 bytes, SHA-256 `02a006665359967b87bbc4750f5615ab952d315d9d2b8aac88a75ba047d74cb0`.
...
|---|---|---:|---|
| landing | [media/state-01-landing.png](media/state-01-landing.png) | 960×540 | `16bc2927deff50de63a0d1359131f595b63b7857544da3c7d9cdc048b3f8a3ba` |
| search open | [media/state-02-search-open.png](media/state-02-search-open.png) | 960×540 | `16bc2927deff50de63a0d1359131f595b63b7857544da3c7d9cdc048b3f8a3ba` |
| failed search | [media/state-03-failed-search.png](media/state-03-failed-search.png) | 960×540 | `cb9ed3f45a337e3c126246ee15c259c2012bcd68f63527c18d8055971f74618e` |
| recovered results | [media/state-04-results.png](media/state-04-results.png) | 960×540 | `a3d3e343040bf694907efb63bfbe54bd209b22259d3b87a9feb664cf23ba77fe` |
| first answer | [media/state-05-answer.png](media/state-05-answer.png) | 960×540 | `fb4447d9499dcdba33c3303a4885a440476e4e6e6c12611d85dfaa612cf860c6` |

## First-success journey

**Actor:** A public documentation visitor looking for one product concept  
**Goal:** Reach the first useful Svelte Documentation answer for “runes”
...
| 4 | Cancel the failed route and request “runes” | Recover with relevant documentation feedback | recovered results | media/state-04-results.png |
...
The failure is deliberately observable: `zzwissent-no-result-7f3c9` produces no useful answer. Recovery is also retained: that route is abandoned, **runes** is requested, a relevant result/learn state appears, and the official canonical answer renders. Completion is `media/state-05-answer.png` plus the closing motion.
...
| Enter impossible query | Enter or request zzwissent-no-result-7f3c9 | The product returns an unmatched/failed lookup state | No useful answer exists for the deliberately impossible query | Replace it with “runes” | media/state-03-failed-search.png and media/motion.webm |
...
| Submit learn query | Enter or request “runes” | The product renders relevant documentation feedback | A narrow query can yield no exact match | Use the broader recorded product term and official route | media/state-04-results.png and media/motion.webm |
...
- **Timing:** brief; 13.48 seconds total.
...
- Upstream owner: Svelte Documentation (svelte.dev).
- Product/source URL: https://svelte.dev/docs/svelte/overview.
