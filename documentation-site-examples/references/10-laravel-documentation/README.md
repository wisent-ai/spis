# 10. Laravel Documentation — observed search/learn-to-first-answer reference

**Evidence status:** complete  
**Official product:** [https://laravel.com/docs](https://laravel.com/docs)  
...
- [`media/motion.webm`](media/motion.webm): 640×360, 10.6 seconds, 265 decoded frames, 174584 bytes, SHA-256 `bec4d5242194f532ff7633be4378af709b91c5a21ba34c412775ebb971fdfca5`.
...
|---|---|---:|---|
| landing | [media/state-01-landing.png](media/state-01-landing.png) | 960×540 | `aed56bb5f906d87703e50415676d18d4e1dbbaf403fc618008197a7ad0ba08be` |
| search open | [media/state-02-search-open.png](media/state-02-search-open.png) | 960×540 | `d5cc650393ed7558e771bd0b3aeb1d67040503a0a5892a47c2b899b3733e9920` |
| failed search | [media/state-03-failed-search.png](media/state-03-failed-search.png) | 960×540 | `f3c6aa1da8f57b66aabdc2f482385a5152e8d9db34c39bf04cdadffad89072fb` |
| recovered results | [media/state-04-results.png](media/state-04-results.png) | 960×540 | `0b116b3dbbb3bf50f5d63762cef7af4dedb2773a13e6d8108aa0cc18f8198785` |
| first answer | [media/state-05-answer.png](media/state-05-answer.png) | 960×540 | `4039e295bd66e4c1c3fb533dea02c763ad286503f60bc4d20224eceefb4b8707` |

## First-success journey

**Actor:** A public documentation visitor looking for one product concept  
**Goal:** Reach the first useful Laravel Documentation answer for “routing”
...
- **Timing:** brief; 10.6 seconds total.
...
- Upstream owner: Laravel Documentation (laravel.com).
- Product/source URL: https://laravel.com/docs.
