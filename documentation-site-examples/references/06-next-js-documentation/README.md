# 06. Next.js Documentation — observed search/learn-to-first-answer reference

**Evidence status:** complete  
**Official product:** [https://nextjs.org/docs](https://nextjs.org/docs)  
...
- [`media/motion.webm`](media/motion.webm): 640×360, 9.56 seconds, 239 decoded frames, 290350 bytes, SHA-256 `e299bf56dd67a3438e29391dffc273a0717703bb3036797de286e7f349585bf0`.
...
|---|---|---:|---|
| landing | [media/state-01-landing.png](media/state-01-landing.png) | 960×540 | `1dee8958b005ba2b889a111ea04b1bfd70357a82d99c54158ab26c5c2e12f721` |
| search open | [media/state-02-search-open.png](media/state-02-search-open.png) | 960×540 | `614c05c0d7f4626fd6c5e77301653daf843560ece4d4926d0ee0f8824f401124` |
| failed search | [media/state-03-failed-search.png](media/state-03-failed-search.png) | 960×540 | `2d3b24fb911fad485aabaffd947eef9e6fdcb707994dfb50f5395297cbd352df` |
| recovered results | [media/state-04-results.png](media/state-04-results.png) | 960×540 | `44955a378fe729c18f4a7a878b4f37e587f1fe41025404570d8a97fcb077ff4b` |
| first answer | [media/state-05-answer.png](media/state-05-answer.png) | 960×540 | `b5fceb0cf0c20717e53f66fd640d9c112268d5f5176b4575faffb8b601ac89f8` |

## First-success journey

**Actor:** A public documentation visitor looking for one product concept  
**Goal:** Reach the first useful Next.js Documentation answer for “routing”
...
- **Timing:** brief; 9.56 seconds total.
...
- Upstream owner: Next.js Documentation (nextjs.org).
- Product/source URL: https://nextjs.org/docs.
