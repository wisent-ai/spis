# 16. Kotlin Documentation — observed search/learn-to-first-answer reference

**Evidence status:** complete  
**Official product:** [https://kotlinlang.org/docs/home.html](https://kotlinlang.org/docs/home.html)  
**Playable motion:** [motion.webm](media/motion.webm)  
**Captured:** 2026-08-16T23:06:22.683Z

This is a real live-product recording from a Weles browser on the Stado-selected dedicated `charless-mac-mini` host, not an animation synthesized from catalog stills. It retains a five-state path from landing through failed lookup, recovery with **coroutines**, and the first useful official answer.

## Local evidence

- [`media/motion.webm`](media/motion.webm): 640×360, 14.44 seconds, 361 decoded frames, 503545 bytes, SHA-256 `80074d4f6f76bd85eb1446df8567b691aab727bb678751d83cbd0aeeca5b271f`.
...
|---|---|---:|---|
| landing | [media/state-01-landing.png](media/state-01-landing.png) | 960×540 | `eb4dce7e5f2095ba5f0ccd058e9b64e47eb85a8a961e40f2582c2a653af1af68` |
| search open | [media/state-02-search-open.png](media/state-02-search-open.png) | 960×540 | `eb4dce7e5f2095ba5f0ccd058e9b64e47eb85a8a961e40f2582c2a653af1af68` |
| failed search | [media/state-03-failed-search.png](media/state-03-failed-search.png) | 960×540 | `6734211663d1d7af13f6be5b1c9dd2740e7e552ed72db8e24e5f4b679e7aec0c` |
| recovered results | [media/state-04-results.png](media/state-04-results.png) | 960×540 | `6734211663d1d7af13f6be5b1c9dd2740e7e552ed72db8e24e5f4b679e7aec0c` |
| first answer | [media/state-05-answer.png](media/state-05-answer.png) | 960×540 | `732dc594964ea85f584fa94b43a92cf37b9a34a535447ba5e78d669a8d8c3d22` |

## First-success journey

**Actor:** A public documentation visitor looking for one product concept  
**Goal:** Reach the first useful Kotlin Documentation answer for “coroutines”
...
| 4 | Cancel the failed route and request “coroutines” | Recover with relevant documentation feedback | recovered results | media/state-04-results.png |
...
The failure is deliberately observable: `zzwissent-no-result-7f3c9` produces no useful answer. Recovery is also retained: that route is abandoned, **coroutines** is requested, a relevant result/learn state appears, and the official canonical answer renders. Completion is `media/state-05-answer.png` plus the closing motion.
...
| Enter impossible query | Enter or request zzwissent-no-result-7f3c9 | The product returns an unmatched/failed lookup state | No useful answer exists for the deliberately impossible query | Replace it with “coroutines” | media/state-03-failed-search.png and media/motion.webm |
...
| Submit learn query | Enter or request “coroutines” | The product renders relevant documentation feedback | A narrow query can yield no exact match | Use the broader recorded product term and official route | media/state-04-results.png and media/motion.webm |
...
- **Timing:** brief; 14.44 seconds total.
...
- Upstream owner: Kotlin Documentation (kotlinlang.org).
- Product/source URL: https://kotlinlang.org/docs/home.html.
