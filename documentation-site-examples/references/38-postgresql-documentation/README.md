# 38. PostgreSQL Documentation — observed search/learn-to-first-answer reference

**Evidence status:** complete  
**Official product:** [https://www.postgresql.org/docs/](https://www.postgresql.org/docs/)  
**Playable motion:** [motion.webm](media/motion.webm)  
**Captured:** 2026-08-16T23:06:22.683Z

This is a real live-product recording from a Weles browser on the Stado-selected dedicated `charless-mac-mini` host, not an animation synthesized from catalog stills. It retains a five-state path from landing through failed lookup, recovery with **indexes**, and the first useful official answer.

## Local evidence

- [`media/motion.webm`](media/motion.webm): 640×360, 12.92 seconds, 323 decoded frames, 223329 bytes, SHA-256 `989ae039324cd1a9045bc22b26f37bf36b0925ee4183714e229aa3c010cfdc0d`.
...
|---|---|---:|---|
| landing | [media/state-01-landing.png](media/state-01-landing.png) | 960×540 | `a4a3b112a86abd54a517028394aff6f206246aff8873a51ef1d3f1006c2202c8` |
| search open | [media/state-02-search-open.png](media/state-02-search-open.png) | 960×540 | `a4a3b112a86abd54a517028394aff6f206246aff8873a51ef1d3f1006c2202c8` |
| failed search | [media/state-03-failed-search.png](media/state-03-failed-search.png) | 960×540 | `31162f24a32cb32f0c513abfd5fc0c4caf8f3f9c7ebb059403cc0267b84e9b96` |
| recovered results | [media/state-04-results.png](media/state-04-results.png) | 960×540 | `33a723b950eb017b5a0c86b422a4a87486a7b003767f1c109e04b76e52289bb1` |
| first answer | [media/state-05-answer.png](media/state-05-answer.png) | 960×540 | `62d3e70472a43e9335f2038f7de5e195fbfa4363320a06d8291197ed6e03a970` |

## First-success journey

**Actor:** A public documentation visitor looking for one product concept  
**Goal:** Reach the first useful PostgreSQL Documentation answer for “indexes”
...
| 4 | Cancel the failed route and request “indexes” | Recover with relevant documentation feedback | recovered results | media/state-04-results.png |
...
| Enter impossible query | Enter or request zzwissent-no-result-7f3c9 | The product returns an unmatched/failed lookup state | No useful answer exists for the deliberately impossible query | Replace it with “indexes” | media/state-03-failed-search.png and media/motion.webm |
...
| Submit learn query | Enter or request “indexes” | The product renders relevant documentation feedback | A narrow query can yield no exact match | Use the broader recorded product term and official route | media/state-04-results.png and media/motion.webm |
...
- **Timing:** brief; 12.92 seconds total.
...
- Upstream owner: PostgreSQL Documentation (www.postgresql.org).
- Product/source URL: https://www.postgresql.org/docs/.
