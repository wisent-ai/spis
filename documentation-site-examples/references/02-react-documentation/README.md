# 02. React Documentation — observed search/learn-to-first-answer reference

**Evidence status:** complete  
**Official product:** [https://react.dev/](https://react.dev/)  
**Playable motion:** [motion.webm](media/motion.webm)  
**Captured:** 2026-08-16T23:06:22.683Z

This is a real live-product recording from a Weles browser on the Stado-selected dedicated `charless-mac-mini` host, not an animation synthesized from catalog stills. It retains a five-state path from landing through failed lookup, recovery with **state**, and the first useful official answer.

## Local evidence

- [`media/motion.webm`](media/motion.webm): 640×360, 8.68 seconds, 217 decoded frames, 142752 bytes, SHA-256 `c4dd763cb6c45e7a8f97e58e2bc0dc1c7f53b6eacca2e28bb77e94a9805cdf2b`.
...
|---|---|---:|---|
| landing | [media/state-01-landing.png](media/state-01-landing.png) | 960×540 | `a4c4003e64dfe7caab0805152992922025868520d9561dfd99632b48670d1a6b` |
| search open | [media/state-02-search-open.png](media/state-02-search-open.png) | 960×540 | `a4c4003e64dfe7caab0805152992922025868520d9561dfd99632b48670d1a6b` |
| failed search | [media/state-03-failed-search.png](media/state-03-failed-search.png) | 960×540 | `57327f5a16fd701dd737dadd0b1792caae58bde333712f3727f541f21e8b2b9f` |
| recovered results | [media/state-04-results.png](media/state-04-results.png) | 960×540 | `0be00ddbf030e9334e7ba93b419fc6be55ddba9b619ac5beb2976133556ce700` |
| first answer | [media/state-05-answer.png](media/state-05-answer.png) | 960×540 | `160ae9bbfff29a4f2dc0c7e32b0776a20dd23fbe2b1c5537f67e1567f718a50b` |

## First-success journey

**Actor:** A public documentation visitor looking for one product concept  
**Goal:** Reach the first useful React Documentation answer for “state”
...
| 4 | Cancel the failed route and request “state” | Recover with relevant documentation feedback | recovered results | media/state-04-results.png |
...
The failure is deliberately observable: `zzwissent-no-result-7f3c9` produces no useful answer. Recovery is also retained: that route is abandoned, **state** is requested, a relevant result/learn state appears, and the official canonical answer renders. Completion is `media/state-05-answer.png` plus the closing motion.
...
| Enter impossible query | Enter or request zzwissent-no-result-7f3c9 | The product returns an unmatched/failed lookup state | No useful answer exists for the deliberately impossible query | Replace it with “state” | media/state-03-failed-search.png and media/motion.webm |
...
| Submit learn query | Enter or request “state” | The product renders relevant documentation feedback | A narrow query can yield no exact match | Use the broader recorded product term and official route | media/state-04-results.png and media/motion.webm |
...
- **Timing:** brief; 8.68 seconds total.
...
- Upstream owner: React Documentation (react.dev).
- Product/source URL: https://react.dev/.
