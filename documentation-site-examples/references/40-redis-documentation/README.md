# 40. Redis Documentation — observed search/learn-to-first-answer reference

**Evidence status:** complete  
**Official product:** [https://redis.io/docs/latest/](https://redis.io/docs/latest/)  
**Playable motion:** [motion.webm](media/motion.webm)  
**Captured:** 2026-08-16T23:10:48.113Z

This is a real live-product recording from a Weles browser on the Stado-selected dedicated `charless-mac-mini` host, not an animation synthesized from catalog stills. It retains a five-state path from landing through failed lookup, recovery with **data types**, and the first useful official answer.

## Local evidence

- [`media/motion.webm`](media/motion.webm): 640×360, 8.76 seconds, 219 decoded frames, 219723 bytes, SHA-256 `99084eca5bad09982a646e50729d89180a9105ae821f71be84b9a257e4cb7346`.
...
|---|---|---:|---|
| landing | [media/state-01-landing.png](media/state-01-landing.png) | 960×540 | `773dd05be5f42f5ca5bf6b5777a1291632827ee3bbea6ccc8454f45e67b46398` |
| search open | [media/state-02-search-open.png](media/state-02-search-open.png) | 960×540 | `a0648f562e80fec4375c86d6875f9367e81368f7dfd218ac6323e7dd3b97a0cc` |
| failed search | [media/state-03-failed-search.png](media/state-03-failed-search.png) | 960×540 | `27903ee65b7a096c671ad9f5730dafd333ff2cf84728b348a7e4c4033ac1543b` |
| recovered results | [media/state-04-results.png](media/state-04-results.png) | 960×540 | `a0648f562e80fec4375c86d6875f9367e81368f7dfd218ac6323e7dd3b97a0cc` |
| first answer | [media/state-05-answer.png](media/state-05-answer.png) | 960×540 | `3eda6ef75a965bb7be93848520be4620799f6c10190fc960b718da737f05c384` |

## First-success journey

**Actor:** A public documentation visitor looking for one product concept  
**Goal:** Reach the first useful Redis Documentation answer for “data types”
...
| 4 | Cancel the failed route and request “data types” | Recover with relevant documentation feedback | recovered results | media/state-04-results.png |
...
The failure is deliberately observable: `zzwissent-no-result-7f3c9` produces no useful answer. Recovery is also retained: that route is abandoned, **data types** is requested, a relevant result/learn state appears, and the official canonical answer renders. Completion is `media/state-05-answer.png` plus the closing motion.
...
| Enter impossible query | Enter or request zzwissent-no-result-7f3c9 | The product returns an unmatched/failed lookup state | No useful answer exists for the deliberately impossible query | Replace it with “data types” | media/state-03-failed-search.png and media/motion.webm |
...
| Submit learn query | Enter or request “data types” | The product renders relevant documentation feedback | A narrow query can yield no exact match | Use the broader recorded product term and official route | media/state-04-results.png and media/motion.webm |
...
- **Timing:** brief; 8.76 seconds total.
...
- Upstream owner: Redis Documentation (redis.io).
- Product/source URL: https://redis.io/docs/latest/.
