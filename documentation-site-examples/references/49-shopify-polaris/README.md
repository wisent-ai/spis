# 49. Shopify Polaris — observed search/learn-to-first-answer reference

**Evidence status:** complete  
**Official product:** [https://polaris.shopify.com/](https://polaris.shopify.com/)  
...
- [`media/motion.webm`](media/motion.webm): 640×360, 9.8 seconds, 245 decoded frames, 334327 bytes, SHA-256 `e832a053250bfffc03ff4008f7fb5d7630df2654bc0b31105da6ae564d7e064f`.
...
|---|---|---:|---|
| landing | [media/state-01-landing.png](media/state-01-landing.png) | 960×540 | `313f6404e87a39c98317a70204e97799e1cbc6cc874aaeaf59626169ef5e9785` |
| search open | [media/state-02-search-open.png](media/state-02-search-open.png) | 960×540 | `3151ca8c026a89d3cf4f043f62799ef658e3aa4ca3afeb5239bfcbcad57c430c` |
| failed search | [media/state-03-failed-search.png](media/state-03-failed-search.png) | 960×540 | `2f8003b0691576b88e384249e6876a9c18472a1a8e27389efee6a8e5f8cb898f` |
| recovered results | [media/state-04-results.png](media/state-04-results.png) | 960×540 | `0d39bd908f2661d742f8967ef397888d1ad2507cfdf07cdf3a0ecce304da0e3c` |
| first answer | [media/state-05-answer.png](media/state-05-answer.png) | 960×540 | `dbb92bcea94e0f51ba23f5e7fb90780f461ab7330602d9612a0a1072c851035c` |

## First-success journey

**Actor:** A public documentation visitor looking for one product concept  
**Goal:** Reach the first useful Shopify Polaris answer for “button”
...
- **Timing:** brief; 9.8 seconds total.
...
- Upstream owner: Shopify Polaris (polaris.shopify.com).
- Product/source URL: https://polaris.shopify.com/.
