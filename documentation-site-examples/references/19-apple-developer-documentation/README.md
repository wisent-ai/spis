# 19. Apple Developer Documentation — observed search/learn-to-first-answer reference

**Evidence status:** complete  
**Official product:** [https://developer.apple.com/documentation/](https://developer.apple.com/documentation/)  
**Playable motion:** [motion.webm](media/motion.webm)  
**Captured:** 2026-08-16T23:06:22.683Z

This is a real live-product recording from a Weles browser on the Stado-selected dedicated `charless-mac-mini` host, not an animation synthesized from catalog stills. It retains a five-state path from landing through failed lookup, recovery with **SwiftUI**, and the first useful official answer.

## Local evidence

- [`media/motion.webm`](media/motion.webm): 640×360, 14.44 seconds, 361 decoded frames, 261188 bytes, SHA-256 `6fd37ca8cce1b289eb316413e1cd66d30c52c5ffa74d71bd7f463712c3388a7a`.
...
|---|---|---:|---|
| landing | [media/state-01-landing.png](media/state-01-landing.png) | 960×540 | `d6148623e96aac13728a8205ce6843c2ff38622b0f35a8e6595641747ff6b567` |
| search open | [media/state-02-search-open.png](media/state-02-search-open.png) | 960×540 | `067e086622f3088217915a850992b112f78ed0cba4e8b6b4ea5ec39361725ee4` |
| failed search | [media/state-03-failed-search.png](media/state-03-failed-search.png) | 960×540 | `7a56a806245c336ebd35aad868525aca693e04b2271a12aace74f5646bb3a2b3` |
| recovered results | [media/state-04-results.png](media/state-04-results.png) | 960×540 | `21f8890591b3883550488a7575c7fda5f7d3562d4502893afb29f44704725fca` |
| first answer | [media/state-05-answer.png](media/state-05-answer.png) | 960×540 | `f61b3d2a92a3080d648cbde62bfa368d28bb518087f7441042d5fb5447dd0429` |

## First-success journey

**Actor:** A public documentation visitor looking for one product concept  
**Goal:** Reach the first useful Apple Developer Documentation answer for “SwiftUI”
...
| 4 | Cancel the failed route and request “SwiftUI” | Recover with relevant documentation feedback | recovered results | media/state-04-results.png |
...
| Enter impossible query | Enter or request zzwissent-no-result-7f3c9 | The product returns an unmatched/failed lookup state | No useful answer exists for the deliberately impossible query | Replace it with “SwiftUI” | media/state-03-failed-search.png and media/motion.webm |
...
| Submit learn query | Enter or request “SwiftUI” | The product renders relevant documentation feedback | A narrow query can yield no exact match | Use the broader recorded product term and official route | media/state-04-results.png and media/motion.webm |
...
- Upstream owner: Apple Developer Documentation (developer.apple.com).
- Product/source URL: https://developer.apple.com/documentation/.
