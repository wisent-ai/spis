# 09. Ruby on Rails Guides — observed search/learn-to-first-answer reference

**Evidence status:** complete  
**Official product:** [https://guides.rubyonrails.org/](https://guides.rubyonrails.org/)  
...
- [`media/motion.webm`](media/motion.webm): 640×360, 8.88 seconds, 222 decoded frames, 123698 bytes, SHA-256 `06dff39fff5a8083bc458f754ce24612c1aecc773e1da365ebc765d8e5a8d1bc`.
...
|---|---|---:|---|
| landing | [media/state-01-landing.png](media/state-01-landing.png) | 960×540 | `1a0e294e14190bac26dabdab8c8dc6eb2d2319d96e36d774c89fa82ee636b54b` |
| search open | [media/state-02-search-open.png](media/state-02-search-open.png) | 960×540 | `1a0e294e14190bac26dabdab8c8dc6eb2d2319d96e36d774c89fa82ee636b54b` |
| failed search | [media/state-03-failed-search.png](media/state-03-failed-search.png) | 960×540 | `6115d677ba8c8e12060589ab3160c48b2ebfd369a2f4740448c5b47e4f5a26cc` |
| recovered results | [media/state-04-results.png](media/state-04-results.png) | 960×540 | `6115d677ba8c8e12060589ab3160c48b2ebfd369a2f4740448c5b47e4f5a26cc` |
| first answer | [media/state-05-answer.png](media/state-05-answer.png) | 960×540 | `c8ef37dc10ff8529dbcbeaf3154ee9982feaca3cc981839a49610d03b88ac8ed` |

## First-success journey

**Actor:** A public documentation visitor looking for one product concept  
**Goal:** Reach the first useful Ruby on Rails Guides answer for “routing”
...
- **Timing:** brief; 8.88 seconds total.
...
- Upstream owner: Ruby on Rails Guides (guides.rubyonrails.org).
- Product/source URL: https://guides.rubyonrails.org/.
