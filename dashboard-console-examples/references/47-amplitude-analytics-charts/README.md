# Amplitude Analytics Charts — observed product reference

- **Evidence status:** complete
- **Product:** [https://amplitude.com/docs/analytics/charts](https://amplitude.com/docs/analytics/charts)
- **Official motion source:** [Chart Types in Amplitude](https://www.youtube.com/watch?v=upUZS1i-MH4)
- **Upstream owner/channel:** Amplitude
- **Captured:** 2026-08-16
- **Local motion:** [play `media/product-motion.mp4`](media/product-motion.mp4) (640×360, 15.000s, 450 frames, 141054 bytes, SHA-256 `02d2ca67cbb2cd0e647640d20bdaff03b1b89d8145118fa285588b1ed8fab842`)
- **Observed source interval:** 150.00–165.00s
...
|---|---|---|---:|---:|---|
| entry context | [`media/state-1.png`](media/state-1.png) | frame from `media/product-motion.mp4` | 640×360 | 93102 | `63e0905949084950f4188d2d7d4d590431ddabd6cb4f671a5528ffc9ca2f19db` |
| focused working state | [`media/state-2.png`](media/state-2.png) | frame from `media/product-motion.mp4` | 640×360 | 95565 | `ee7855bf7656d8d92c9a5f4b0813525786bfa10cd521bae01abd2887c937299b` |
| first-success result | [`media/state-3.png`](media/state-3.png) | frame from `media/product-motion.mp4` | 640×360 | 118348 | `037ca479a17f0e3fd978aef02fe08714e5a07e407c751a077547ac620d7d8d84` |

## First-success journey

**Actor:** Operator using Amplitude Analytics Charts  
...
The motion is an excerpt of an owner-published real-product recording, not a synthesized animation. Source: [Chart Types in Amplitude](https://www.youtube.com/watch?v=upUZS1i-MH4), published by **Amplitude**. Local state files are direct frame extractions from the local MP4 and can be inspected offline. All byte counts and SHA-256 values are recorded in [`reference.json`](reference.json).
