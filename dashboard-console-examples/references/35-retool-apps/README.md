# Retool Apps — observed product reference

- **Evidence status:** complete
- **Product:** [https://retool.com/](https://retool.com/)
- **Official motion source:** [How to build multipage apps in Retool](https://www.youtube.com/watch?v=_TnHl8VYLs4)
- **Upstream owner/channel:** Retool
- **Captured:** 2026-08-16
- **Local motion:** [play `media/product-motion.mp4`](media/product-motion.mp4) (564×360, 14.967s, 449 frames, 114969 bytes, SHA-256 `3a78588d9469f8d0033a3b60849d0a0b205b337a38ae1ad2d70221d54302bb8e`)
- **Observed source interval:** 27.45–42.42s
...
|---|---|---|---:|---:|---|
| entry context | [`media/state-1.png`](media/state-1.png) | frame from `media/product-motion.mp4` | 564×360 | 81506 | `20b5e3144181a2b726b5d8ec13a5a42e79619978ff13e0a6e2d5837be38887f7` |
| focused working state | [`media/state-2.png`](media/state-2.png) | frame from `media/product-motion.mp4` | 564×360 | 85448 | `42627fb7c46ceaaa332677fa28c7c17bc391eb49adadf91ced858a9189c67de3` |
| first-success result | [`media/state-3.png`](media/state-3.png) | frame from `media/product-motion.mp4` | 564×360 | 69970 | `284805900602f374be62a6172285dc1fb2ded83a3675766ddd16962e8150db03` |

## First-success journey

**Actor:** Operator using Retool Apps  
...
The motion is an excerpt of an owner-published real-product recording, not a synthesized animation. Source: [How to build multipage apps in Retool](https://www.youtube.com/watch?v=_TnHl8VYLs4), published by **Retool**. Local state files are direct frame extractions from the local MP4 and can be inspected offline. All byte counts and SHA-256 values are recorded in [`reference.json`](reference.json).
