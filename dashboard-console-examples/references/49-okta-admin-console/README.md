# Okta Admin Console — observed product reference

- **Evidence status:** complete
- **Product:** [https://help.okta.com/oie/en-us/content/topics/dashboard/dashboard.htm](https://help.okta.com/oie/en-us/content/topics/dashboard/dashboard.htm)
- **Official motion source:** [Govern Okta Admin Roles](https://www.youtube.com/watch?v=JyeJhv5E09E)
- **Upstream owner/channel:** Okta
- **Captured:** 2026-08-16
- **Local motion:** [play `media/product-motion.mp4`](media/product-motion.mp4) (542×360, 14.960s, 374 frames, 47691 bytes, SHA-256 `174024368d3792e62f9926f7090b5e66584998052f284e82b73b6e7bce79139a`)
- **Observed source interval:** 66.45–81.41s
...
|---|---|---|---:|---:|---|
| entry context | [`media/state-1.png`](media/state-1.png) | frame from `media/product-motion.mp4` | 542×360 | 68663 | `4cb12252a5c06e2005bfe5d4d1cc4640869be7a26d95bc1b5e61037dbaf784a6` |
| focused working state | [`media/state-2.png`](media/state-2.png) | frame from `media/product-motion.mp4` | 542×360 | 69154 | `2f5177f34c130befc8e03dc0041dacb9c3e78cc7cbec0ab8dafd7c47c2fc6317` |
| first-success result | [`media/state-3.png`](media/state-3.png) | frame from `media/product-motion.mp4` | 542×360 | 65290 | `e3975aab3223c0c8e1ca2fb971fafce82c0391cbba7a151f9d30ee489ed27ee3` |

## First-success journey

**Actor:** Operator using Okta Admin Console  
...
The motion is an excerpt of an owner-published real-product recording, not a synthesized animation. Source: [Govern Okta Admin Roles](https://www.youtube.com/watch?v=JyeJhv5E09E), published by **Okta**. Local state files are direct frame extractions from the local MP4 and can be inspected offline. All byte counts and SHA-256 values are recorded in [`reference.json`](reference.json).
