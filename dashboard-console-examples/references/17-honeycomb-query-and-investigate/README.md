# Honeycomb Query and Investigate — observed product reference

- **Evidence status:** complete
- **Product:** [https://docs.honeycomb.io/investigate/](https://docs.honeycomb.io/investigate/)
- **Official motion source:** [Honeycomb AI SRE investigation](https://www.youtube.com/watch?v=09G2RUUd4cs)
- **Upstream owner/channel:** Honeycomb
- **Captured:** 2026-08-16
- **Local motion:** [play `media/product-motion.mp4`](media/product-motion.mp4) (640×360, 15.000s, 360 frames, 226390 bytes, SHA-256 `ddd53b2eaf6e775012db0f08766cb609abdfb13521a2003ead8cf7956155f11f`)
- **Observed source interval:** 23.25–38.25s
...
|---|---|---|---:|---:|---|
| entry context | [`media/state-1.png`](media/state-1.png) | frame from `media/product-motion.mp4` | 640×360 | 127819 | `41143a5a1b602cb6605f61a9c7403657394f67f49a82d76cc2d40fd1bd212dcc` |
| focused working state | [`media/state-2.png`](media/state-2.png) | frame from `media/product-motion.mp4` | 640×360 | 142186 | `52c3e60456a48e60d138907135e5b7dae10f94ccef94b3bf45a648b3284f82d1` |
| first-success result | [`media/state-3.png`](media/state-3.png) | frame from `media/product-motion.mp4` | 640×360 | 161835 | `b04d3937d5fb731b42320313bfa50275465a1e1881e4e80b77773bfc5b07e5ef` |

## First-success journey

**Actor:** Operator using Honeycomb Query and Investigate  
...
The motion is an excerpt of an owner-published real-product recording, not a synthesized animation. Source: [Honeycomb AI SRE investigation](https://www.youtube.com/watch?v=09G2RUUd4cs), published by **Honeycomb**. Local state files are direct frame extractions from the local MP4 and can be inspected offline. All byte counts and SHA-256 values are recorded in [`reference.json`](reference.json).
