# Cloudflare Dashboard — observed product reference

- **Evidence status:** complete
- **Product:** [https://dash.cloudflare.com/](https://dash.cloudflare.com/)
- **Official motion source:** [Cloudflare Access: Product Demo](https://www.youtube.com/watch?v=eshlmtPh4m4)
- **Upstream owner/channel:** Cloudflare
- **Captured:** 2026-08-16
- **Local motion:** [play `media/product-motion.mp4`](media/product-motion.mp4) (640×360, 15.000s, 450 frames, 95968 bytes, SHA-256 `fccbfcae6d7d6646429e7b8e1a4957e5122370b58754edb28628e2093456a8cd`)
- **Observed source interval:** 48.30–63.30s
...
|---|---|---|---:|---:|---|
| entry context | [`media/state-1.png`](media/state-1.png) | frame from `media/product-motion.mp4` | 640×360 | 18303 | `0aa6e0d9f2f70b95fef3e6555089237ee64d2ca9fe82c3b5b7fa395df1b740fa` |
| focused working state | [`media/state-2.png`](media/state-2.png) | frame from `media/product-motion.mp4` | 640×360 | 85947 | `db3de42ad4d245a6c9da50fc5725bf813ef539afcd1d3da06cf3a0cdd77d38e8` |
| first-success result | [`media/state-3.png`](media/state-3.png) | frame from `media/product-motion.mp4` | 640×360 | 56967 | `61c8037fd2ab7c230168e9291b2c41a744f0808dcd677fd3b84dec93a3d8d4d9` |

## First-success journey

**Actor:** Operator using Cloudflare Dashboard  
...
The motion is an excerpt of an owner-published real-product recording, not a synthesized animation. Source: [Cloudflare Access: Product Demo](https://www.youtube.com/watch?v=eshlmtPh4m4), published by **Cloudflare**. Local state files are direct frame extractions from the local MP4 and can be inspected offline. All byte counts and SHA-256 values are recorded in [`reference.json`](reference.json).
