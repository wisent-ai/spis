# Datadog Dashboards — observed product reference

- **Evidence status:** complete
- **Product:** [https://docs.datadoghq.com/dashboards/](https://docs.datadoghq.com/dashboards/)
- **Official motion source:** [Datadog Service Catalog Demo](https://www.youtube.com/watch?v=1r3J3WCmah0)
- **Upstream owner/channel:** Datadog
- **Captured:** 2026-08-16
- **Local motion:** [play `media/product-motion.mp4`](media/product-motion.mp4) (640×360, 14.967s, 449 frames, 231788 bytes, SHA-256 `aad014c5d1f94ee9589b754d91fd7d3766b6c190e27da0b02137b072b3734fa7`)
- **Observed source interval:** 53.25–68.22s
...
|---|---|---|---:|---:|---|
| entry context | [`media/state-1.png`](media/state-1.png) | frame from `media/product-motion.mp4` | 640×360 | 212357 | `d64106a0db0d87f63320fa28c93373e85c6ac09971037828e14ee500c35478e3` |
| focused working state | [`media/state-2.png`](media/state-2.png) | frame from `media/product-motion.mp4` | 640×360 | 230436 | `323bad341ede95bf3e9da7e6ed8e1412da5a959c4214501730c9efc28543ae36` |
| first-success result | [`media/state-3.png`](media/state-3.png) | frame from `media/product-motion.mp4` | 640×360 | 171285 | `5bfbbef18dd845b140b36777110b5afe5bca6dcda20cb5309c24e5350610eea3` |

## First-success journey

**Actor:** Operator using Datadog Dashboards  
...
The motion is an excerpt of an owner-published real-product recording, not a synthesized animation. Source: [Datadog Service Catalog Demo](https://www.youtube.com/watch?v=1r3J3WCmah0), published by **Datadog**. Local state files are direct frame extractions from the local MP4 and can be inspected offline. All byte counts and SHA-256 values are recorded in [`reference.json`](reference.json).
