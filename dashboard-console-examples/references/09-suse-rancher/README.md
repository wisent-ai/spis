# SUSE Rancher — observed product reference

- **Evidence status:** complete
- **Product:** [https://www.rancher.com/products/rancher](https://www.rancher.com/products/rancher)
- **Official motion source:** [SUSE Rancher Prime AI Crew Demo](https://www.youtube.com/watch?v=lBPp3gDfc40)
- **Upstream owner/channel:** SUSE
- **Captured:** 2026-08-16
- **Local motion:** [play `media/product-motion.mp4`](media/product-motion.mp4) (640×360, 15.015s, 450 frames, 89145 bytes, SHA-256 `d93ce59c03c5ecaf462051d99d2715343395cdcd86c22518017b9462f475cd68`)
- **Observed source interval:** 19.05–34.06s
...
|---|---|---|---:|---:|---|
| entry context | [`media/state-1.png`](media/state-1.png) | frame from `media/product-motion.mp4` | 640×360 | 73270 | `aa6cc9975108339a9a56618605b1aaf309ae2d30c61a5b9a3060f55677939f59` |
| focused working state | [`media/state-2.png`](media/state-2.png) | frame from `media/product-motion.mp4` | 640×360 | 79069 | `f0afdd91c14f7332d40c06abe6e2d080438f86fb5c8703e7649ef9a322df22ae` |
| first-success result | [`media/state-3.png`](media/state-3.png) | frame from `media/product-motion.mp4` | 640×360 | 76724 | `ad4f6b2c28c7a6d164450e53958b25db881656e43702e5419ac7b9ef8d824eba` |

## First-success journey

**Actor:** Operator using SUSE Rancher  
...
The motion is an excerpt of an owner-published real-product recording, not a synthesized animation. Source: [SUSE Rancher Prime AI Crew Demo](https://www.youtube.com/watch?v=lBPp3gDfc40), published by **SUSE**. Local state files are direct frame extractions from the local MP4 and can be inspected offline. All byte counts and SHA-256 values are recorded in [`reference.json`](reference.json).
