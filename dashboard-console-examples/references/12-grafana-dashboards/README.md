# Grafana Dashboards — observed product reference

- **Evidence status:** complete
- **Product:** [https://grafana.com/docs/grafana/latest/dashboards/](https://grafana.com/docs/grafana/latest/dashboards/)
- **Official motion source:** [Understanding Dashboards in Grafana](https://www.youtube.com/watch?v=vTiIkdDwT-0)
- **Upstream owner/channel:** Grafana
- **Captured:** 2026-08-16
- **Local motion:** [play `media/product-motion.mp4`](media/product-motion.mp4) (640×360, 14.982s, 449 frames, 85254 bytes, SHA-256 `90f70725dfc834a58d1dcd776fd5721abc47084377786610001346843be6aba6`)
- **Observed source interval:** 52.80–67.78s
...
|---|---|---|---:|---:|---|
| entry context | [`media/state-1.png`](media/state-1.png) | frame from `media/product-motion.mp4` | 640×360 | 79758 | `a5b8e768192dc24ab9284bf32b98d68a577c9432127d905c658cf730cad7851b` |
| focused working state | [`media/state-2.png`](media/state-2.png) | frame from `media/product-motion.mp4` | 640×360 | 89339 | `b7b1733f783bef3551e77145d3939e57f05377c448e7d9e1f328ef6719e9e94a` |
| first-success result | [`media/state-3.png`](media/state-3.png) | frame from `media/product-motion.mp4` | 640×360 | 60592 | `33e9fabfc7e5d2b84d0bfcc6dd0af32e7229d39d27c3c96fee2b0ae756da0d2b` |

## First-success journey

**Actor:** Operator using Grafana Dashboards  
...
The motion is an excerpt of an owner-published real-product recording, not a synthesized animation. Source: [Understanding Dashboards in Grafana](https://www.youtube.com/watch?v=vTiIkdDwT-0), published by **Grafana**. Local state files are direct frame extractions from the local MP4 and can be inspected offline. All byte counts and SHA-256 values are recorded in [`reference.json`](reference.json).
