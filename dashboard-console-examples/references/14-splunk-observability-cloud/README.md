# Splunk Observability Cloud — observed product reference

- **Evidence status:** complete
- **Product:** [https://www.splunk.com/en_us/products/observability.html](https://www.splunk.com/en_us/products/observability.html)
- **Official motion source:** [Splunk Synthetic Monitoring product demo](https://www.youtube.com/watch?v=frqXK0W777k)
- **Upstream owner/channel:** Splunk
- **Captured:** 2026-08-16
- **Local motion:** [play `media/product-motion.mp4`](media/product-motion.mp4) (640×360, 15.000s, 450 frames, 94400 bytes, SHA-256 `0c4705d27e0cfac7f02cc7e0f29b783d5b08867b642fd005baaea67c399fb508`)
- **Observed source interval:** 24.00–39.00s
...
|---|---|---|---:|---:|---|
| entry context | [`media/state-1.png`](media/state-1.png) | frame from `media/product-motion.mp4` | 640×360 | 100915 | `21f43e21cbdb671d6923abcfb1f5a82d80b1d7137bf0319720079ade864cc9e4` |
| focused working state | [`media/state-2.png`](media/state-2.png) | frame from `media/product-motion.mp4` | 640×360 | 101805 | `111159fbbeab43a05b0448a77699d93f2e5dfe3a1629809a16bae8347c152992` |
| first-success result | [`media/state-3.png`](media/state-3.png) | frame from `media/product-motion.mp4` | 640×360 | 81901 | `2b5ff9628050e6046683c570c179fff10dc92a9aa9ca5b41651ac121a55c6698` |

## First-success journey

**Actor:** Operator using Splunk Observability Cloud  
...
The motion is an excerpt of an owner-published real-product recording, not a synthesized animation. Source: [Splunk Synthetic Monitoring product demo](https://www.youtube.com/watch?v=frqXK0W777k), published by **Splunk**. Local state files are direct frame extractions from the local MP4 and can be inspected offline. All byte counts and SHA-256 values are recorded in [`reference.json`](reference.json).
