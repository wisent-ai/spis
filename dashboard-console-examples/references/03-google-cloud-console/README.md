# Google Cloud Console — observed product reference

- **Evidence status:** complete
- **Product:** [https://cloud.google.com/cloud-console](https://cloud.google.com/cloud-console)
- **Official motion source:** [How to use the Google Cloud Console](https://www.youtube.com/watch?v=27Pb5g7bEAA)
- **Upstream owner/channel:** Google Cloud Tech
- **Captured:** 2026-08-16
- **Local motion:** [play `media/product-motion.mp4`](media/product-motion.mp4) (640×360, 15.015s, 360 frames, 113266 bytes, SHA-256 `72e892f68cb24eebd1ba87ebbf4d0a47d97c72dd8fc876de237e8d1717a4a2e6`)
- **Observed source interval:** 135.00–150.01s
...
|---|---|---|---:|---:|---|
| entry context | [`media/state-1.png`](media/state-1.png) | frame from `media/product-motion.mp4` | 640×360 | 99688 | `5af415b85b4d385ea326f7c2d356fc708b327fa92ddd9fb8efbfce310732d0d1` |
| focused working state | [`media/state-2.png`](media/state-2.png) | frame from `media/product-motion.mp4` | 640×360 | 111029 | `8bf409fc0104c164d71ea85af3071c2a729244f7d40fee3adc0016233648dea0` |
| first-success result | [`media/state-3.png`](media/state-3.png) | frame from `media/product-motion.mp4` | 640×360 | 84735 | `9fc5a8a9d23492a16a71919b0129e64370f09bcbf03d62403a864dd79e3ca159` |

## First-success journey

**Actor:** Operator using Google Cloud Console  
...
The motion is an excerpt of an owner-published real-product recording, not a synthesized animation. Source: [How to use the Google Cloud Console](https://www.youtube.com/watch?v=27Pb5g7bEAA), published by **Google Cloud Tech**. Local state files are direct frame extractions from the local MP4 and can be inspected offline. All byte counts and SHA-256 values are recorded in [`reference.json`](reference.json).
