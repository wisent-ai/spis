# Harness Continuous Delivery — observed product reference

- **Evidence status:** complete
- **Product:** [https://developer.harness.io/docs/continuous-delivery/](https://developer.harness.io/docs/continuous-delivery/)
- **Official motion source:** [Harness Continuous Delivery demo](https://www.youtube.com/watch?v=akM9df69XmI)
- **Upstream owner/channel:** Harness
- **Captured:** 2026-08-16
- **Local motion:** [play `media/product-motion.mp4`](media/product-motion.mp4) (542×360, 15.000s, 450 frames, 43154 bytes, SHA-256 `592a6feb81dd8e903769d8feffe86e99d98a3bd4e65eacf953889ffdef0a8f1f`)
- **Observed source interval:** 23.70–38.70s
...
|---|---|---|---:|---:|---|
| entry context | [`media/state-1.png`](media/state-1.png) | frame from `media/product-motion.mp4` | 542×360 | 79400 | `13e3b22da270f3fbdbda466ae78e0278f3da470b7c0f3d49d61610c0bf73e6cd` |
| focused working state | [`media/state-2.png`](media/state-2.png) | frame from `media/product-motion.mp4` | 542×360 | 78827 | `ccdc555140dd38aa06efb9a439002138db38ebfc2b5e982f26879d2ca168c3a5` |
| first-success result | [`media/state-3.png`](media/state-3.png) | frame from `media/product-motion.mp4` | 542×360 | 94975 | `79a78cd2c1bb2421d44cd93e3d1d026137ad2eeb2ff8ac527638be85a69ed561` |

## First-success journey

**Actor:** Operator using Harness Continuous Delivery  
...
The motion is an excerpt of an owner-published real-product recording, not a synthesized animation. Source: [Harness Continuous Delivery demo](https://www.youtube.com/watch?v=akM9df69XmI), published by **Harness**. Local state files are direct frame extractions from the local MP4 and can be inspected offline. All byte counts and SHA-256 values are recorded in [`reference.json`](reference.json).
