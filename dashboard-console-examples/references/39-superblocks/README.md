# Superblocks — observed product reference

- **Evidence status:** complete
- **Product:** [https://www.superblocks.com/](https://www.superblocks.com/)
- **Official motion source:** [Live Superblocks Demo](https://www.youtube.com/watch?v=qnAtWBT1W7A)
- **Upstream owner/channel:** Superblocks
- **Captured:** 2026-08-16
- **Local motion:** [play `media/product-motion.mp4`](media/product-motion.mp4) (640×360, 14.982s, 449 frames, 51991 bytes, SHA-256 `fc31a0593b8010f64f407a508f4f4158a801d8facbe9797e10107c8daaf15e77`)
- **Observed source interval:** 51.60–66.58s
...
|---|---|---|---:|---:|---|
| entry context | [`media/state-1.png`](media/state-1.png) | frame from `media/product-motion.mp4` | 640×360 | 40996 | `e1a7c49c45f88e2688ce65b06f62f330f3b447561c68ec2b84c985a2df6eebc3` |
| focused working state | [`media/state-2.png`](media/state-2.png) | frame from `media/product-motion.mp4` | 640×360 | 41430 | `7f5abef0ee6c3c581f82fd3df0209e9a9e20ddc8c0848972b2930d92643a89be` |
| first-success result | [`media/state-3.png`](media/state-3.png) | frame from `media/product-motion.mp4` | 640×360 | 80450 | `5cc09413eccc57e1ae43821013e7949ec40af7b1dc72561822d3e3f1abef4852` |

## First-success journey

**Actor:** Operator using Superblocks  
...
The motion is an excerpt of an owner-published real-product recording, not a synthesized animation. Source: [Live Superblocks Demo](https://www.youtube.com/watch?v=qnAtWBT1W7A), published by **Superblocks**. Local state files are direct frame extractions from the local MP4 and can be inspected offline. All byte counts and SHA-256 values are recorded in [`reference.json`](reference.json).
