# Buildkite Pipelines — observed product reference

- **Evidence status:** complete
- **Product:** [https://buildkite.com/docs/pipelines](https://buildkite.com/docs/pipelines)
- **Official motion source:** [Bootstrapping a New Pipeline](https://www.youtube.com/watch?v=GUIK4AdcKM0)
- **Upstream owner/channel:** Buildkite
- **Captured:** 2026-08-16
- **Local motion:** [play `media/product-motion.mp4`](media/product-motion.mp4) (640×360, 15.000s, 450 frames, 256615 bytes, SHA-256 `b0784661687f5c6e1132c285e6f88d37d718ea82e222383ff17431060d17ede5`)
- **Observed source interval:** 300.00–315.00s
...
|---|---|---|---:|---:|---|
| entry context | [`media/state-1.png`](media/state-1.png) | frame from `media/product-motion.mp4` | 640×360 | 62480 | `470cdab894895aa7ad4da15720e65d7543311c897c8127acc2c2534ca5d5f0a0` |
| focused working state | [`media/state-2.png`](media/state-2.png) | frame from `media/product-motion.mp4` | 640×360 | 142097 | `16ab4859e43749738ea577ca8be0032ad2ca085b2097630c66b32a1353e63c82` |
| first-success result | [`media/state-3.png`](media/state-3.png) | frame from `media/product-motion.mp4` | 640×360 | 151296 | `476fe6bea4898939606c31fa82133c62bb79d93aa924da2c14d398ea71415d91` |

## First-success journey

**Actor:** Operator using Buildkite Pipelines  
...
The motion is an excerpt of an owner-published real-product recording, not a synthesized animation. Source: [Bootstrapping a New Pipeline](https://www.youtube.com/watch?v=GUIK4AdcKM0), published by **Buildkite**. Local state files are direct frame extractions from the local MP4 and can be inspected offline. All byte counts and SHA-256 values are recorded in [`reference.json`](reference.json).
