# Metabase Dashboards — observed product reference

- **Evidence status:** complete
- **Product:** [https://www.metabase.com/docs/latest/dashboards/introduction](https://www.metabase.com/docs/latest/dashboards/introduction)
- **Official motion source:** [See what Metabase can do](https://www.youtube.com/watch?v=j_4vI2bm6-8)
- **Upstream owner/channel:** Metabase
- **Captured:** 2026-08-16
- **Local motion:** [play `media/product-motion.mp4`](media/product-motion.mp4) (640×360, 15.000s, 450 frames, 154042 bytes, SHA-256 `a513ca451d17b456844ed72c078dfcd82beff779c44c6106c58c1b1f9ff6e778`)
- **Observed source interval:** 18.00–33.00s
...
|---|---|---|---:|---:|---|
| entry context | [`media/state-1.png`](media/state-1.png) | frame from `media/product-motion.mp4` | 640×360 | 93078 | `8735032c8412ed18ade41fde318f8974f875b03e0830293ff6b8dc9cdea8817a` |
| focused working state | [`media/state-2.png`](media/state-2.png) | frame from `media/product-motion.mp4` | 640×360 | 61453 | `405ffd1b697efa47247ddbb04494078162c5c703b9af8c775d50eaacb431c406` |
| first-success result | [`media/state-3.png`](media/state-3.png) | frame from `media/product-motion.mp4` | 640×360 | 67413 | `a68670561c7780670948a8659f143f19e51341a351d9b80e992d613bab127cba` |

## First-success journey

**Actor:** Operator using Metabase Dashboards  
...
The motion is an excerpt of an owner-published real-product recording, not a synthesized animation. Source: [See what Metabase can do](https://www.youtube.com/watch?v=j_4vI2bm6-8), published by **Metabase**. Local state files are direct frame extractions from the local MP4 and can be inspected offline. All byte counts and SHA-256 values are recorded in [`reference.json`](reference.json).
