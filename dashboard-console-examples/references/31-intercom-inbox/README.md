# Intercom Inbox — observed product reference

- **Evidence status:** complete
- **Product:** [https://www.intercom.com/help/en/articles/6258745-the-inbox-explained](https://www.intercom.com/help/en/articles/6258745-the-inbox-explained)
- **Official motion source:** [Intercom inbox overview](https://www.youtube.com/watch?v=7dFQzkeTe2g)
- **Upstream owner/channel:** Intercom / Fin
- **Captured:** 2026-08-16
- **Local motion:** [play `media/product-motion.mp4`](media/product-motion.mp4) (640×360, 14.967s, 449 frames, 104972 bytes, SHA-256 `de06dae420d750519bf91cf3229810f10cf68cc198fa5b614e8ab03c0eee5457`)
- **Observed source interval:** 17.85–32.82s
...
|---|---|---|---:|---:|---|
| entry context | [`media/state-1.png`](media/state-1.png) | frame from `media/product-motion.mp4` | 640×360 | 92446 | `d7653d3afed0c0b3868c6b4e53670b9dd5620a43fed057b6483f46c2370e3599` |
| focused working state | [`media/state-2.png`](media/state-2.png) | frame from `media/product-motion.mp4` | 640×360 | 87753 | `ff7a4fe8c5013e1ada3da581ffd7da0413369825167249199a966d04bb1f85fa` |
| first-success result | [`media/state-3.png`](media/state-3.png) | frame from `media/product-motion.mp4` | 640×360 | 74183 | `75bce3a8c454d51b8027eaf72c1246cb4968e3971fdc9b4a1090633b6cfdf782` |

## First-success journey

**Actor:** Operator using Intercom Inbox  
...
The motion is an excerpt of an owner-published real-product recording, not a synthesized animation. Source: [Intercom inbox overview](https://www.youtube.com/watch?v=7dFQzkeTe2g), published by **Intercom / Fin**. Local state files are direct frame extractions from the local MP4 and can be inspected offline. All byte counts and SHA-256 values are recorded in [`reference.json`](reference.json).
