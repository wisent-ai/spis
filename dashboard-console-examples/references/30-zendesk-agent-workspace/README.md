# Zendesk Agent Workspace — observed product reference

- **Evidence status:** complete
- **Product:** [https://support.zendesk.com/hc/en-us/articles/4408821259930-About-the-Zendesk-Agent-Workspace](https://support.zendesk.com/hc/en-us/articles/4408821259930-About-the-Zendesk-Agent-Workspace)
- **Official motion source:** [Zendesk Agent Workspace](https://www.youtube.com/watch?v=6MlLcWapLF0)
- **Upstream owner/channel:** Zendesk
- **Captured:** 2026-08-16
- **Local motion:** [play `media/product-motion.mp4`](media/product-motion.mp4) (640×360, 14.982s, 449 frames, 68690 bytes, SHA-256 `250057594f8242ee305e9af1bcbde236cf8b1789f727e71049b0b7fb454ec08c`)
- **Observed source interval:** 400.00–414.98s
...
|---|---|---|---:|---:|---|
| entry context | [`media/state-1.png`](media/state-1.png) | frame from `media/product-motion.mp4` | 640×360 | 109641 | `734d7281651b0479bf96fd6b19a1edaec94e5e8d37e2ebb2d510650ea6466272` |
| focused working state | [`media/state-2.png`](media/state-2.png) | frame from `media/product-motion.mp4` | 640×360 | 111328 | `9ad333c585c63c737377a3c227b8eb1766dc7f34aba1147d68bde624545e2f8d` |
| first-success result | [`media/state-3.png`](media/state-3.png) | frame from `media/product-motion.mp4` | 640×360 | 121319 | `c3608a6bd496e74638889460e0056238619ece21baea3740e321e6dde6975f51` |

## First-success journey

**Actor:** Operator using Zendesk Agent Workspace  
**Goal:** open a queue or conversation and reach an actionable request state
...
The motion is an excerpt of an owner-published real-product recording, not a synthesized animation. Source: [Zendesk Agent Workspace](https://www.youtube.com/watch?v=6MlLcWapLF0), published by **Zendesk**. Local state files are direct frame extractions from the local MP4 and can be inspected offline. All byte counts and SHA-256 values are recorded in [`reference.json`](reference.json).
