# Stripe Dashboard — observed product reference

- **Evidence status:** complete
- **Product:** [https://docs.stripe.com/dashboard/basics](https://docs.stripe.com/dashboard/basics)
- **Official motion source:** [Stripe Dashboard for platforms demo](https://www.youtube.com/watch?v=UB_hdbpFNwk)
- **Upstream owner/channel:** Stripe
- **Captured:** 2026-08-16
- **Local motion:** [play `media/product-motion.mp4`](media/product-motion.mp4) (640×360, 14.982s, 449 frames, 330448 bytes, SHA-256 `a109e0cd964e169a42b1766a4263835df5053ccab01e87cf14fc951c4dfd0135`)
- **Observed source interval:** 15.15–30.13s
...
|---|---|---|---:|---:|---|
| entry context | [`media/state-1.png`](media/state-1.png) | frame from `media/product-motion.mp4` | 640×360 | 127251 | `196205cb62bd1a9ba57ed45ef013462c26e470c4f58969b2a53ae0b3726860f7` |
| focused working state | [`media/state-2.png`](media/state-2.png) | frame from `media/product-motion.mp4` | 640×360 | 105308 | `38f7ab4901bf440a491b5e2cef7ee217e2cf09ab16174ccc94b8906561f8e25a` |
| first-success result | [`media/state-3.png`](media/state-3.png) | frame from `media/product-motion.mp4` | 640×360 | 99394 | `a5936f2d8c34a8e8b1ddb06342c4aace0b58f218986145a0fe228cc63109b3f8` |

## First-success journey

**Actor:** Operator using Stripe Dashboard  
...
The motion is an excerpt of an owner-published real-product recording, not a synthesized animation. Source: [Stripe Dashboard for platforms demo](https://www.youtube.com/watch?v=UB_hdbpFNwk), published by **Stripe**. Local state files are direct frame extractions from the local MP4 and can be inspected offline. All byte counts and SHA-256 values are recorded in [`reference.json`](reference.json).
