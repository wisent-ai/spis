# Jenkins Blue Ocean Dashboard — observed product reference

- **Evidence status:** complete
- **Product:** [https://www.jenkins.io/doc/book/blueocean/dashboard/](https://www.jenkins.io/doc/book/blueocean/dashboard/)
- **Official motion source:** [Getting Started with the Blue Ocean Dashboard](https://www.youtube.com/watch?v=sm1jLj5lbwk)
- **Upstream owner/channel:** CloudBeesTV
- **Captured:** 2026-08-16
- **Local motion:** [play `media/product-motion.mp4`](media/product-motion.mp4) (652×360, 15.000s, 450 frames, 25752 bytes, SHA-256 `b21004fd5d4f3cd8f89c2c635287e2758d429ddc089d41c3abec1f81faed1524`)
- **Observed source interval:** 54.00–69.00s
...
|---|---|---|---:|---:|---|
| entry context | [`media/state-1.png`](media/state-1.png) | frame from `media/product-motion.mp4` | 652×360 | 31680 | `42ecef6c3e7f21ef9f8958ad0522c5f54c4bcfef97cbcfebc64fa058cceeacb6` |
| focused working state | [`media/state-2.png`](media/state-2.png) | frame from `media/product-motion.mp4` | 652×360 | 31686 | `8dd51c11c3d203dd9e59d9e8ce4f40566cef99f5fbbb6e498bd1b9a576889cc8` |
| first-success result | [`media/state-3.png`](media/state-3.png) | frame from `media/product-motion.mp4` | 652×360 | 31844 | `b821f789dd3b0cccc022d05d3311c536d68e4bba089bda285cd8a1faa2d4f2ca` |

## First-success journey

**Actor:** Operator using Jenkins Blue Ocean Dashboard  
...
The motion is an excerpt of an owner-published real-product recording, not a synthesized animation. Source: [Getting Started with the Blue Ocean Dashboard](https://www.youtube.com/watch?v=sm1jLj5lbwk), published by **CloudBeesTV**. Local state files are direct frame extractions from the local MP4 and can be inspected offline. All byte counts and SHA-256 values are recorded in [`reference.json`](reference.json).
