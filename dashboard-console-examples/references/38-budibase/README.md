# Budibase — observed product reference

- **Evidence status:** complete
- **Product:** [https://budibase.com/](https://budibase.com/)
- **Official motion source:** [Budibase digital maps release demo](https://www.youtube.com/watch?v=uigkFflJboc)
- **Upstream owner/channel:** Budibase
- **Captured:** 2026-08-16
- **Local motion:** [play `media/product-motion.mp4`](media/product-motion.mp4) (640×360, 14.967s, 449 frames, 55044 bytes, SHA-256 `8e2b12ffdd6b1d908b528c8feac9b9d5669112ea03e94b15fbe8ecc5ca9b7cbf`)
- **Observed source interval:** 21.75–36.72s
...
|---|---|---|---:|---:|---|
| entry context | [`media/state-1.png`](media/state-1.png) | frame from `media/product-motion.mp4` | 640×360 | 128914 | `a9867b1335bd682f720a4bcc04f0a583aa0197430e38e24dbdf4b35ab8c7010f` |
| focused working state | [`media/state-2.png`](media/state-2.png) | frame from `media/product-motion.mp4` | 640×360 | 129034 | `4c0e30ae0e237daff23f73285c901e69c7875ff04977198c4a807509b080b3dc` |
| first-success result | [`media/state-3.png`](media/state-3.png) | frame from `media/product-motion.mp4` | 640×360 | 128297 | `15ae7df5a0ead647c35bf43098a9873db3690d4b2415b7250f5430e8bac3c4dc` |

## First-success journey

**Actor:** Operator using Budibase  
...
The motion is an excerpt of an owner-published real-product recording, not a synthesized animation. Source: [Budibase digital maps release demo](https://www.youtube.com/watch?v=uigkFflJboc), published by **Budibase**. Local state files are direct frame extractions from the local MP4 and can be inspected offline. All byte counts and SHA-256 values are recorded in [`reference.json`](reference.json).
