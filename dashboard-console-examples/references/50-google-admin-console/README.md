# Google Admin Console — observed product reference

- **Evidence status:** complete
- **Product:** [https://support.google.com/a/answer/182076?hl=en](https://support.google.com/a/answer/182076?hl=en)
- **Official motion source:** [Chrome OS Demo: Google Admin Console](https://www.youtube.com/watch?v=jhHOfPL-DT0)
- **Upstream owner/channel:** Google Chrome
- **Captured:** 2026-08-16
- **Local motion:** [play `media/product-motion.mp4`](media/product-motion.mp4) (640×360, 14.967s, 449 frames, 67686 bytes, SHA-256 `e492cba947fa4b1a680df639bc43e3414c79cd90e8e48730bede9a8e419c31db`)
- **Observed source interval:** 26.55–41.52s
...
|---|---|---|---:|---:|---|
| entry context | [`media/state-1.png`](media/state-1.png) | frame from `media/product-motion.mp4` | 640×360 | 46893 | `846d1e8e2a5eb7e0ef9a6cc87e8d1fe9bb454a790ec509a070ee8f336169cd68` |
| focused working state | [`media/state-2.png`](media/state-2.png) | frame from `media/product-motion.mp4` | 640×360 | 49185 | `dc40d47a38c4e9bef7aba28c2d0c66d40fbe2d5c6b8fc5b02f7f1b9b177151c1` |
| first-success result | [`media/state-3.png`](media/state-3.png) | frame from `media/product-motion.mp4` | 640×360 | 45660 | `86a1dad2d24eeb6c3e0100e5aca169231ab03b70dd8bd0d1c2b1f5550e871c3b` |

## First-success journey

**Actor:** Operator using Google Admin Console  
**Goal:** open administration and reach a scoped, actionable settings view
...
The motion is an excerpt of an owner-published real-product recording, not a synthesized animation. Source: [Chrome OS Demo: Google Admin Console](https://www.youtube.com/watch?v=jhHOfPL-DT0), published by **Google Chrome**. Local state files are direct frame extractions from the local MP4 and can be inspected offline. All byte counts and SHA-256 values are recorded in [`reference.json`](reference.json).
