# Kibana Dashboards — observed product reference

- **Evidence status:** complete
- **Product:** [https://www.elastic.co/guide/en/kibana/current/dashboard.html](https://www.elastic.co/guide/en/kibana/current/dashboard.html)
- **Official motion source:** [Creating your first visualization with Kibana Lens](https://www.youtube.com/watch?v=DzGwmr8nKPg)
- **Upstream owner/channel:** Elastic
- **Captured:** 2026-08-16
- **Local motion:** [play `media/product-motion.mp4`](media/product-motion.mp4) (640×360, 15.000s, 450 frames, 46219 bytes, SHA-256 `ad10b950e996ebef64d681a04ca86b999e7e7f91a9992af03cdc8c69e6f814eb`)
- **Observed source interval:** 27.90–42.90s
...
|---|---|---|---:|---:|---|
| entry context | [`media/state-1.png`](media/state-1.png) | frame from `media/product-motion.mp4` | 640×360 | 66997 | `6af1354add1bc6031320a18b998fb10acd4fd37f7ef103527780af17ed77c894` |
| focused working state | [`media/state-2.png`](media/state-2.png) | frame from `media/product-motion.mp4` | 640×360 | 30562 | `99b46322bea95717a82759d552f2dd0f38ef3938250e6f97bed29c4e88a867aa` |
| first-success result | [`media/state-3.png`](media/state-3.png) | frame from `media/product-motion.mp4` | 640×360 | 68904 | `17acf0113b4f032441d4ccb6d9e516354146a70f7e24bd30f75ddd9fbb7e3e80` |

## First-success journey

**Actor:** Operator using Kibana Dashboards  
...
The motion is an excerpt of an owner-published real-product recording, not a synthesized animation. Source: [Creating your first visualization with Kibana Lens](https://www.youtube.com/watch?v=DzGwmr8nKPg), published by **Elastic**. Local state files are direct frame extractions from the local MP4 and can be inspected offline. All byte counts and SHA-256 values are recorded in [`reference.json`](reference.json).
