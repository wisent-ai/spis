# Vercel Dashboard — observed product reference

- **Evidence status:** complete
- **Product:** [https://vercel.com/dashboard](https://vercel.com/dashboard)
- **Official motion source:** [Vercel Product Walkthrough](https://www.youtube.com/watch?v=sPmat30SE4k)
- **Upstream owner/channel:** Vercel
- **Captured:** 2026-08-16
- **Local motion:** [play `media/product-motion.mp4`](media/product-motion.mp4) (640×360, 15.000s, 450 frames, 97219 bytes, SHA-256 `dae203ba13e124070edaa14a68358906a488f904c3caefdc122df21bfa6dd5fb`)
- **Observed source interval:** 890.00–905.00s
...
|---|---|---|---:|---:|---|
| entry context | [`media/state-1.png`](media/state-1.png) | frame from `media/product-motion.mp4` | 640×360 | 71132 | `ad1e4e02ec2c40f076a857448b4eaaa1fdb472a116a22f3f8599a5037ffb7b99` |
| focused working state | [`media/state-2.png`](media/state-2.png) | frame from `media/product-motion.mp4` | 640×360 | 71674 | `46f44c8a43440707606bb04ed6506f996d742867663f40ce85c8467b1e6e98d9` |
| first-success result | [`media/state-3.png`](media/state-3.png) | frame from `media/product-motion.mp4` | 640×360 | 78276 | `29bcb1452c0a2dc93859fbdb803d577091048b34b7f46d5a72c19ee38a9b4c7d` |

## First-success journey

**Actor:** Operator using Vercel Dashboard  
**Goal:** reach a deployment view whose current status and next action are visible
...
The motion is an excerpt of an owner-published real-product recording, not a synthesized animation. Source: [Vercel Product Walkthrough](https://www.youtube.com/watch?v=sPmat30SE4k), published by **Vercel**. Local state files are direct frame extractions from the local MP4 and can be inspected offline. All byte counts and SHA-256 values are recorded in [`reference.json`](reference.json).
