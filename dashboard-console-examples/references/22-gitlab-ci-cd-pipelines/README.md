# GitLab CI/CD Pipelines — observed product reference

- **Evidence status:** complete
- **Product:** [https://docs.gitlab.com/ci/pipelines/](https://docs.gitlab.com/ci/pipelines/)
- **Official motion source:** [Your First GitLab CI/CD Pipeline Explained](https://www.youtube.com/watch?v=IV5MQUEUx44)
- **Upstream owner/channel:** GitLab
- **Captured:** 2026-08-16
- **Local motion:** [play `media/product-motion.mp4`](media/product-motion.mp4) (640×360, 15.000s, 360 frames, 25940 bytes, SHA-256 `2c2170a358a3d9671a351eb93e2f359b904d12d91cb872aadfb8a9eaed19a5db`)
- **Observed source interval:** 180.00–195.00s
...
|---|---|---|---:|---:|---|
| entry context | [`media/state-1.png`](media/state-1.png) | frame from `media/product-motion.mp4` | 640×360 | 24787 | `03437531df00e7a5cccbb702fe6c971ec5d66b32fec32a1d7c6c0753ff4de826` |
| focused working state | [`media/state-2.png`](media/state-2.png) | frame from `media/product-motion.mp4` | 640×360 | 25045 | `631b0695a4a52fa7ff1510d6afe66106fc2fbd91d015051f12c309e89e92728e` |
| first-success result | [`media/state-3.png`](media/state-3.png) | frame from `media/product-motion.mp4` | 640×360 | 40028 | `bde3ee847fe701361e4f8df54284d39a53fdb88aeae53638f363c603d7df8d3d` |

## First-success journey

**Actor:** Operator using GitLab CI/CD Pipelines  
...
The motion is an excerpt of an owner-published real-product recording, not a synthesized animation. Source: [Your First GitLab CI/CD Pipeline Explained](https://www.youtube.com/watch?v=IV5MQUEUx44), published by **GitLab**. Local state files are direct frame extractions from the local MP4 and can be inspected offline. All byte counts and SHA-256 values are recorded in [`reference.json`](reference.json).
