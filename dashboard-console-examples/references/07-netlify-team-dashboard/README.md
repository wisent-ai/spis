# Netlify Team Dashboard — observed product reference

- **Evidence status:** complete
- **Product:** [https://app.netlify.com/](https://app.netlify.com/)
- **Official motion source:** [Add forms to your project with AI + Netlify](https://www.youtube.com/watch?v=B4PfKu-e3Uk)
- **Upstream owner/channel:** Netlify
- **Captured:** 2026-08-16
- **Local motion:** [play `media/product-motion.mp4`](media/product-motion.mp4) (640×360, 15.015s, 450 frames, 198203 bytes, SHA-256 `f666f524bcaeaa2ba999c8603e38f4bf7a7d68f112640610250309af8c52b68c`)
- **Observed source interval:** 16.50–31.52s
...
|---|---|---|---:|---:|---|
| entry context | [`media/state-1.png`](media/state-1.png) | frame from `media/product-motion.mp4` | 640×360 | 106374 | `3a883eff71861b20f12e93fe3a678ba976e601c6bd2ac6d8c68ffe2e86391908` |
| focused working state | [`media/state-2.png`](media/state-2.png) | frame from `media/product-motion.mp4` | 640×360 | 97919 | `355fe4d803c0964a59f4a65609e0cd674cda8c35a3db566e4af436d0be195aed` |
| first-success result | [`media/state-3.png`](media/state-3.png) | frame from `media/product-motion.mp4` | 640×360 | 65053 | `fc242adf20f8e3e8dbe3a4c0af1848b6131d8c16133350c42b066972aedd0f5d` |

## First-success journey

**Actor:** Operator using Netlify Team Dashboard  
...
The motion is an excerpt of an owner-published real-product recording, not a synthesized animation. Source: [Add forms to your project with AI + Netlify](https://www.youtube.com/watch?v=B4PfKu-e3Uk), published by **Netlify**. Local state files are direct frame extractions from the local MP4 and can be inspected offline. All byte counts and SHA-256 values are recorded in [`reference.json`](reference.json).
