# CircleCI Pipelines — observed product reference

- **Evidence status:** complete
- **Product:** [https://circleci.com/docs/pipelines/](https://circleci.com/docs/pipelines/)
- **Official motion source:** [CircleCI Demo](https://www.youtube.com/watch?v=J1l-icYGyd0)
- **Upstream owner/channel:** CircleCI
- **Captured:** 2026-08-16
- **Local motion:** [play `media/product-motion.mp4`](media/product-motion.mp4) (640×360, 15.000s, 450 frames, 43638 bytes, SHA-256 `22419ee8c2e07eb31941b7b4e784238ff479167ac1c9fd3aeddbd55bc1f2690a`)
...
|---|---|---|---:|---:|---|
| entry context | [`media/state-1.png`](media/state-1.png) | frame from `media/product-motion.mp4` | 640×360 | 49944 | `4bfddfe26e2842b5bccfc7be37fa72f10711f445eee06eb88f4752a64797bae5` |
| focused working state | [`media/state-2.png`](media/state-2.png) | frame from `media/product-motion.mp4` | 640×360 | 53527 | `c0ca3fa3a399f3b1d2efda074eb7fb288b22498a4040ad9bcae65a0778272619` |
| first-success result | [`media/state-3.png`](media/state-3.png) | frame from `media/product-motion.mp4` | 640×360 | 64612 | `d40072a1397fcde3647d2aefcd954b27a7650f7250ee0f36f2704892bb87a55f` |

## First-success journey

**Actor:** Operator using CircleCI Pipelines  
...
The motion is an excerpt of an owner-published real-product recording, not a synthesized animation. Source: [CircleCI Demo](https://www.youtube.com/watch?v=J1l-icYGyd0), published by **CircleCI**. Local state files are direct frame extractions from the local MP4 and can be inspected offline. All byte counts and SHA-256 values are recorded in [`reference.json`](reference.json).
