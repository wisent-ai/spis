# Jira Service Management Queues — observed product reference

- **Evidence status:** complete
- **Product:** [https://www.atlassian.com/software/jira/service-management](https://www.atlassian.com/software/jira/service-management)
- **Official motion source:** [Customer Service Management Highlights](https://www.youtube.com/watch?v=qs3-hpXuAfM)
- **Upstream owner/channel:** Atlassian
- **Captured:** 2026-08-16
- **Local motion:** [play `media/product-motion.mp4`](media/product-motion.mp4) (640×360, 15.000s, 375 frames, 182415 bytes, SHA-256 `37dcdf7d2d05b48a030d593f0375ed9ca38ba58819b03ddf33cfaba973a158c4`)
- **Observed source interval:** 60.00–75.00s
...
|---|---|---|---:|---:|---|
| entry context | [`media/state-1.png`](media/state-1.png) | frame from `media/product-motion.mp4` | 640×360 | 66027 | `697572858b906d8c034d5e0f58c70a4e01627b6127c96a1288e1e73c9e98f4a6` |
| focused working state | [`media/state-2.png`](media/state-2.png) | frame from `media/product-motion.mp4` | 640×360 | 87356 | `26b500000ec93a590497d3b1c633921a618e287154168dc5c35739a5d1260997` |
| first-success result | [`media/state-3.png`](media/state-3.png) | frame from `media/product-motion.mp4` | 640×360 | 62684 | `5734dba22fb421326945a0ffeee9f34d06e9fa3aa75c6cdc1f05985e0bc603e4` |

## First-success journey

**Actor:** Operator using Jira Service Management Queues  
...
The motion is an excerpt of an owner-published real-product recording, not a synthesized animation. Source: [Customer Service Management Highlights](https://www.youtube.com/watch?v=qs3-hpXuAfM), published by **Atlassian**. Local state files are direct frame extractions from the local MP4 and can be inspected offline. All byte counts and SHA-256 values are recorded in [`reference.json`](reference.json).
