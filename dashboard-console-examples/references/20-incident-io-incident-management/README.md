# incident.io Incident Management — observed product reference

- **Evidence status:** complete
- **Product:** [https://incident.io/](https://incident.io/)
- **Official motion source:** [How incident.io works](https://www.youtube.com/watch?v=uoSKbDsV-EY)
- **Upstream owner/channel:** incident.io
- **Captured:** 2026-08-16
- **Local motion:** [play `media/product-motion.mp4`](media/product-motion.mp4) (640×360, 14.982s, 449 frames, 83756 bytes, SHA-256 `42e2e7ca486db0d8f14356cfd6dbc9c3a28cd76695076b2d5d04cc4b7d55845c`)
- **Observed source interval:** 72.75–87.73s
...
|---|---|---|---:|---:|---|
| entry context | [`media/state-1.png`](media/state-1.png) | frame from `media/product-motion.mp4` | 640×360 | 64052 | `d1a66297bba29d9f5cbc7f662fa2dcfee605704775c6d36091d6a15706f2997a` |
| focused working state | [`media/state-2.png`](media/state-2.png) | frame from `media/product-motion.mp4` | 640×360 | 92066 | `4678b903da40df8c351bf57b876fa9da1f91b82d6a2efd4afe11e7b3c7da509b` |
| first-success result | [`media/state-3.png`](media/state-3.png) | frame from `media/product-motion.mp4` | 640×360 | 96035 | `a58c503130057db86fe1fd7ebac932511c36c9f2fdfb511dbeb9f600efc01615` |

## First-success journey

**Actor:** Operator using incident.io Incident Management  
...
The motion is an excerpt of an owner-published real-product recording, not a synthesized animation. Source: [How incident.io works](https://www.youtube.com/watch?v=uoSKbDsV-EY), published by **incident.io**. Local state files are direct frame extractions from the local MP4 and can be inspected offline. All byte counts and SHA-256 values are recorded in [`reference.json`](reference.json).
