# Appsmith Internal Tools — observed product reference

- **Evidence status:** complete
- **Product:** [https://www.appsmith.com/](https://www.appsmith.com/)
- **Official motion source:** [Building an Internal Tool in 5 Minutes on Appsmith](https://www.youtube.com/watch?v=mzqK0QIZRLs)
- **Upstream owner/channel:** Appsmith
- **Captured:** 2026-08-16
- **Local motion:** [play `media/product-motion.mp4`](media/product-motion.mp4) (640×360, 14.982s, 449 frames, 84304 bytes, SHA-256 `16afddfef41b595f669ef4eac19932d019860c57715f3ae7c0f3f6a040a53a5e`)
- **Observed source interval:** 38.85–53.83s
...
|---|---|---|---:|---:|---|
| entry context | [`media/state-1.png`](media/state-1.png) | frame from `media/product-motion.mp4` | 640×360 | 34943 | `0c962bbf540308b920bedc3413130a2ae5bcff0ddc67d23a77109aa9d32fb30e` |
| focused working state | [`media/state-2.png`](media/state-2.png) | frame from `media/product-motion.mp4` | 640×360 | 68986 | `179408f175d368f0deed4df25d80a0bf9a7d3ec13b934bf21570b6daacca287b` |
| first-success result | [`media/state-3.png`](media/state-3.png) | frame from `media/product-motion.mp4` | 640×360 | 73385 | `7821ae89a33025b5bc3cee0778d809ae0963db0dea70c808c5fe2e85b2effcab` |

## First-success journey

**Actor:** Operator using Appsmith Internal Tools  
**Goal:** open the builder or application and reach a populated first working result
...
The motion is an excerpt of an owner-published real-product recording, not a synthesized animation. Source: [Building an Internal Tool in 5 Minutes on Appsmith](https://www.youtube.com/watch?v=mzqK0QIZRLs), published by **Appsmith**. Local state files are direct frame extractions from the local MP4 and can be inspected offline. All byte counts and SHA-256 values are recorded in [`reference.json`](reference.json).
