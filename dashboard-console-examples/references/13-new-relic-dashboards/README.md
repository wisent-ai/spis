# New Relic Dashboards — observed product reference

- **Evidence status:** complete
- **Product:** [https://docs.newrelic.com/docs/query-your-data/explore-query-data/dashboards/introduction-dashboards/](https://docs.newrelic.com/docs/query-your-data/explore-query-data/dashboards/introduction-dashboards/)
- **Official motion source:** [Enhance your New Relic dashboards with Markdown](https://www.youtube.com/watch?v=_dLwy7xskBk)
- **Upstream owner/channel:** New Relic
- **Captured:** 2026-08-16
- **Local motion:** [play `media/product-motion.mp4`](media/product-motion.mp4) (640×360, 15.015s, 450 frames, 54431 bytes, SHA-256 `ffb08730735fca684a68fa8866bbe2fb80bbbedc67486997fb12c33721237ce7`)
- **Observed source interval:** 28.65–43.66s
...
|---|---|---|---:|---:|---|
| entry context | [`media/state-1.png`](media/state-1.png) | frame from `media/product-motion.mp4` | 640×360 | 77104 | `ecab6a9410abd7ab12128096cae05c4c4aa5e347bc14316c9546bc0fd0fd14dc` |
| focused working state | [`media/state-2.png`](media/state-2.png) | frame from `media/product-motion.mp4` | 640×360 | 77775 | `9841467a9bf03d3e9f16e62d3b4fb1e37ae0e99332eb246b03ed1407d27c2cff` |
| first-success result | [`media/state-3.png`](media/state-3.png) | frame from `media/product-motion.mp4` | 640×360 | 65058 | `f1666b0b1110806dfb83b1d7637c6e3df863a048d365bf2a8d1c689c6a0d9854` |

## First-success journey

**Actor:** Operator using New Relic Dashboards  
**Goal:** reach a populated telemetry or issue view and obtain the first actionable signal
...
The motion is an excerpt of an owner-published real-product recording, not a synthesized animation. Source: [Enhance your New Relic dashboards with Markdown](https://www.youtube.com/watch?v=_dLwy7xskBk), published by **New Relic**. Local state files are direct frame extractions from the local MP4 and can be inspected offline. All byte counts and SHA-256 values are recorded in [`reference.json`](reference.json).
