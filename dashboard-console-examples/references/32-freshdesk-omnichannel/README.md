# Freshdesk Omnichannel — observed product reference

- **Evidence status:** complete
- **Product:** [https://www.freshworks.com/freshdesk/](https://www.freshworks.com/freshdesk/)
- **Official motion source:** [Manage Customer Inquiries in Freshdesk](https://www.youtube.com/watch?v=q_EjfEKijP4)
- **Upstream owner/channel:** Freshworks
- **Captured:** 2026-08-16
- **Local motion:** [play `media/product-motion.mp4`](media/product-motion.mp4) (640×360, 14.998s, 449 frames, 261304 bytes, SHA-256 `c180b05c1daf105513d1512a97ba94cf7e30181dc1ec5875063624c22fe4011c`)
- **Observed source interval:** 5.58–20.58s
...
|---|---|---|---:|---:|---|
| entry context | [`media/state-1.png`](media/state-1.png) | frame from `media/product-motion.mp4` | 640×360 | 97540 | `05b7f2d6c27d374ac618162196776873637881c83fde205373cc768a3b66be5d` |
| focused working state | [`media/state-2.png`](media/state-2.png) | frame from `media/product-motion.mp4` | 640×360 | 103604 | `6573482c674e4346ac49219731b17961fad2bab816ecaf3c8df61f92fd0498bc` |
| first-success result | [`media/state-3.png`](media/state-3.png) | frame from `media/product-motion.mp4` | 640×360 | 69341 | `409365acc78b78ba071a80e51947bbdda447cfcc43463ebc946a578b9c219144` |

## First-success journey

**Actor:** Operator using Freshdesk Omnichannel  
...
The motion is an excerpt of an owner-published real-product recording, not a synthesized animation. Source: [Manage Customer Inquiries in Freshdesk](https://www.youtube.com/watch?v=q_EjfEKijP4), published by **Freshworks**. Local state files are direct frame extractions from the local MP4 and can be inspected offline. All byte counts and SHA-256 values are recorded in [`reference.json`](reference.json).
