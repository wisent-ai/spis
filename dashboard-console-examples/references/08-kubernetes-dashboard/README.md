# Kubernetes Dashboard — observed product reference

- **Evidence status:** complete
- **Product:** [https://github.com/kubernetes/dashboard](https://github.com/kubernetes/dashboard)
- **Official motion source:** [State of the UI: Leveraging Kubernetes Dashboard](https://www.youtube.com/watch?v=_AIL1QENv04)
- **Upstream owner/channel:** CNCF
- **Captured:** 2026-08-16
- **Local motion:** [play `media/product-motion.mp4`](media/product-motion.mp4) (640×360, 15.000s, 450 frames, 67976 bytes, SHA-256 `0d47ea41b60b6d0c6b4eba2b6dc73fa89e7c2e75f31e897bd6e8ea41935fc270`)
- **Observed source interval:** 900.00–915.00s
...
|---|---|---|---:|---:|---|
| entry context | [`media/state-1.png`](media/state-1.png) | frame from `media/product-motion.mp4` | 640×360 | 93427 | `9557d9409c3f0449d6eedfda51f47b497feb15c244886680835c78d481a65e2a` |
| focused working state | [`media/state-2.png`](media/state-2.png) | frame from `media/product-motion.mp4` | 640×360 | 81997 | `4af4fbc86e412a14b782b30e8138b89a40439fca9a1c5a109064786798074f91` |
| first-success result | [`media/state-3.png`](media/state-3.png) | frame from `media/product-motion.mp4` | 640×360 | 81098 | `b763bff3e9c9c16d06c2601042bf23128e104727de26bf578de9c53ae3fc0da2` |

## First-success journey

**Actor:** Operator using Kubernetes Dashboard  
...
The motion is an excerpt of an owner-published real-product recording, not a synthesized animation. Source: [State of the UI: Leveraging Kubernetes Dashboard](https://www.youtube.com/watch?v=_AIL1QENv04), published by **CNCF**. Local state files are direct frame extractions from the local MP4 and can be inspected offline. All byte counts and SHA-256 values are recorded in [`reference.json`](reference.json).
