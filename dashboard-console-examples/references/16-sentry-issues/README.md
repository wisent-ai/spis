# Sentry Issues — observed product reference

- **Evidence status:** complete
- **Product:** [https://docs.sentry.io/product/issues/](https://docs.sentry.io/product/issues/)
- **Official motion source:** [Sentry in Six Minutes](https://www.youtube.com/watch?v=4djseRVSan8)
- **Upstream owner/channel:** Sentry
- **Captured:** 2026-08-16
- **Local motion:** [play `media/product-motion.mp4`](media/product-motion.mp4) (640×360, 15.000s, 450 frames, 84699 bytes, SHA-256 `1cf1d06ce103e1f8ad4be462ba0e0f22da9b1407028c01d47f0c02223e4e91c2`)
- **Observed source interval:** 56.10–71.10s
...
|---|---|---|---:|---:|---|
| entry context | [`media/state-1.png`](media/state-1.png) | frame from `media/product-motion.mp4` | 640×360 | 122115 | `f3ea59413fccf047eb2564300b70f8774085badefc72890ddab481d71b4d9866` |
| focused working state | [`media/state-2.png`](media/state-2.png) | frame from `media/product-motion.mp4` | 640×360 | 59670 | `8532079636fea3e5b9a6c91227330412dc08aeebeccef138b4885afd70313dcf` |
| first-success result | [`media/state-3.png`](media/state-3.png) | frame from `media/product-motion.mp4` | 640×360 | 118143 | `800aff0f50a1b2a2b1728a8badf6ea77eb23c7f66b2a035580edc4ee2aea3521` |

## First-success journey

**Actor:** Operator using Sentry Issues  
...
The motion is an excerpt of an owner-published real-product recording, not a synthesized animation. Source: [Sentry in Six Minutes](https://www.youtube.com/watch?v=4djseRVSan8), published by **Sentry**. Local state files are direct frame extractions from the local MP4 and can be inspected offline. All byte counts and SHA-256 values are recorded in [`reference.json`](reference.json).
