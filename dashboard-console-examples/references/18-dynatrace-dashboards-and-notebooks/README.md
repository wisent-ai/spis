# Dynatrace Dashboards and Notebooks — observed product reference

- **Evidence status:** complete
- **Product:** [https://docs.dynatrace.com/docs/analyze-explore-automate/dashboards-and-notebooks](https://docs.dynatrace.com/docs/analyze-explore-automate/dashboards-and-notebooks)
- **Official motion source:** [What is Dynatrace in 15 minutes](https://www.youtube.com/watch?v=qo6vjyE-Ak0)
- **Upstream owner/channel:** Dynatrace
- **Captured:** 2026-08-16
- **Local motion:** [play `media/product-motion.mp4`](media/product-motion.mp4) (640×360, 15.000s, 360 frames, 52160 bytes, SHA-256 `5e805bd8dfb8cc4d7831bea28af3e29c8946a647537f7deba5cdee04f99a095a`)
- **Observed source interval:** 450.00–465.00s
...
|---|---|---|---:|---:|---|
| entry context | [`media/state-1.png`](media/state-1.png) | frame from `media/product-motion.mp4` | 640×360 | 107919 | `7e7c0f2e6678c1354ee20cef260d09d54caf001496386af0711df23972f09757` |
| focused working state | [`media/state-2.png`](media/state-2.png) | frame from `media/product-motion.mp4` | 640×360 | 111933 | `c2cd556d550b69dd21320c4747571ff9b149402f4d69c57be33e3235ea27e48e` |
| first-success result | [`media/state-3.png`](media/state-3.png) | frame from `media/product-motion.mp4` | 640×360 | 90516 | `5002490366573075b6978df2be0fe49e205f02f635df8c6c81075488de3b3474` |

## First-success journey

**Actor:** Operator using Dynatrace Dashboards and Notebooks  
...
The motion is an excerpt of an owner-published real-product recording, not a synthesized animation. Source: [What is Dynatrace in 15 minutes](https://www.youtube.com/watch?v=qo6vjyE-Ak0), published by **Dynatrace**. Local state files are direct frame extractions from the local MP4 and can be inspected offline. All byte counts and SHA-256 values are recorded in [`reference.json`](reference.json).
