# JetBrains TeamCity — observed product reference

- **Evidence status:** complete
- **Product:** [https://www.jetbrains.com/teamcity/](https://www.jetbrains.com/teamcity/)
- **Official motion source:** [Getting Started with TeamCity](https://www.youtube.com/watch?v=s68u2shSo6o)
- **Upstream owner/channel:** JetBrains
- **Captured:** 2026-08-16
- **Local motion:** [play `media/product-motion.mp4`](media/product-motion.mp4) (640×360, 15.000s, 360 frames, 110767 bytes, SHA-256 `d0bfd15997f525274f3f95af49000ee524eceb12326b554ceb9f1066a353fa97`)
- **Observed source interval:** 26.25–41.25s
...
|---|---|---|---:|---:|---|
| entry context | [`media/state-1.png`](media/state-1.png) | frame from `media/product-motion.mp4` | 640×360 | 14789 | `d581c30869cb03d07776a5395f5270d7ba7b59c20f7bac3bd8a17e245414c1b5` |
| focused working state | [`media/state-2.png`](media/state-2.png) | frame from `media/product-motion.mp4` | 640×360 | 98244 | `283a86f056edaa8f21370a54bc4a074dee4754a34849ae5c379fe66fa732f1ec` |
| first-success result | [`media/state-3.png`](media/state-3.png) | frame from `media/product-motion.mp4` | 640×360 | 121466 | `03a38d03e26b79d9073fae9b42317f96d68616f84d00019104236261b1955278` |

## First-success journey

**Actor:** Operator using JetBrains TeamCity  
...
The motion is an excerpt of an owner-published real-product recording, not a synthesized animation. Source: [Getting Started with TeamCity](https://www.youtube.com/watch?v=s68u2shSo6o), published by **JetBrains**. Local state files are direct frame extractions from the local MP4 and can be inspected offline. All byte counts and SHA-256 values are recorded in [`reference.json`](reference.json).
