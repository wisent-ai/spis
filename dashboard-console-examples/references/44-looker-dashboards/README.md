# Looker Dashboards — observed product reference

- **Evidence status:** complete
- **Product:** [https://cloud.google.com/looker/docs/dashboards](https://cloud.google.com/looker/docs/dashboards)
- **Official motion source:** [Creating a Looker dashboard from an Explore](https://www.youtube.com/watch?v=o3MYjg31rbM)
- **Upstream owner/channel:** Looker
- **Captured:** 2026-08-16
- **Local motion:** [play `media/product-motion.mp4`](media/product-motion.mp4) (576×360, 14.967s, 449 frames, 93565 bytes, SHA-256 `569e1c7d88cefdcba834085e7cb47d67fdf098e88094a469a8b01209f4fdae78`)
- **Observed source interval:** 22.35–37.32s
...
|---|---|---|---:|---:|---|
| entry context | [`media/state-1.png`](media/state-1.png) | frame from `media/product-motion.mp4` | 576×360 | 40766 | `492752ab4ec5467988a0fd1860dd566d676f33de57aaa58c68dfe69a1a03b3fc` |
| focused working state | [`media/state-2.png`](media/state-2.png) | frame from `media/product-motion.mp4` | 576×360 | 39111 | `61133032e638953926ec1f741e2e5a6e0649403d50db3ced7899697930021fc7` |
| first-success result | [`media/state-3.png`](media/state-3.png) | frame from `media/product-motion.mp4` | 576×360 | 35252 | `e3de4a9824a394919f2eaee64005248e129c14a31e1718912255f3d0e5d212f6` |

## First-success journey

**Actor:** Operator using Looker Dashboards  
...
The motion is an excerpt of an owner-published real-product recording, not a synthesized animation. Source: [Creating a Looker dashboard from an Explore](https://www.youtube.com/watch?v=o3MYjg31rbM), published by **Looker**. Local state files are direct frame extractions from the local MP4 and can be inspected offline. All byte counts and SHA-256 values are recorded in [`reference.json`](reference.json).
