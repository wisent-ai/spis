# Salesforce Service Cloud — observed product reference

- **Evidence status:** complete
- **Product:** [https://www.salesforce.com/service/cloud/](https://www.salesforce.com/service/cloud/)
- **Official motion source:** [What Is Service Cloud?](https://www.youtube.com/watch?v=4iFHgOXmMQo)
- **Upstream owner/channel:** Salesforce
- **Captured:** 2026-08-16
- **Local motion:** [play `media/product-motion.mp4`](media/product-motion.mp4) (640×360, 14.982s, 449 frames, 132866 bytes, SHA-256 `a21e61d52d9862826441d20d423a5f179ccfb444f7461d295a54d8ce9aff7b32`)
- **Observed source interval:** 420.00–434.98s
...
|---|---|---|---:|---:|---|
| entry context | [`media/state-1.png`](media/state-1.png) | frame from `media/product-motion.mp4` | 640×360 | 167824 | `2a3fbacf520f750abb4332953069527f45457cb5e5af5500664f0a90297091b4` |
| focused working state | [`media/state-2.png`](media/state-2.png) | frame from `media/product-motion.mp4` | 640×360 | 92813 | `7a13dfe009c9de61c9002516cb3bee6390b694f224c50740d07a2324970e57e3` |
| first-success result | [`media/state-3.png`](media/state-3.png) | frame from `media/product-motion.mp4` | 640×360 | 132296 | `c8ece7b9314feca911705919551f26cae5c6fea2ef01e2c20cde990e83dd1b2d` |

## First-success journey

**Actor:** Operator using Salesforce Service Cloud  
...
The motion is an excerpt of an owner-published real-product recording, not a synthesized animation. Source: [What Is Service Cloud?](https://www.youtube.com/watch?v=4iFHgOXmMQo), published by **Salesforce**. Local state files are direct frame extractions from the local MP4 and can be inspected offline. All byte counts and SHA-256 values are recorded in [`reference.json`](reference.json).
