# DigitalOcean Cloud Control Panel — observed product reference

- **Evidence status:** complete
- **Product:** [https://cloud.digitalocean.com/](https://cloud.digitalocean.com/)
- **Official motion source:** [How To Create a Cloud Server on DigitalOcean](https://www.youtube.com/watch?v=vqZ7eKM0WS8)
- **Upstream owner/channel:** DigitalOcean
- **Captured:** 2026-08-16
- **Local motion:** [play `media/product-motion.mp4`](media/product-motion.mp4) (640×360, 14.967s, 449 frames, 107868 bytes, SHA-256 `8089b43851d9c75fd31a840415ce76d411cb8df32f74d6d6ccc1efb34fc9940d`)
...
|---|---|---|---:|---:|---|
| entry context | [`media/state-1.png`](media/state-1.png) | frame from `media/product-motion.mp4` | 640×360 | 78149 | `2f724e4edb8dd76cb466cc221d2c1d9547ea752a7ce9af74e9f7bbaece17e921` |
| focused working state | [`media/state-2.png`](media/state-2.png) | frame from `media/product-motion.mp4` | 640×360 | 67987 | `e4bc8cca8facfa4ee7a037bdbd0da005093f67c2f62bd190877218af9ce7c25a` |
| first-success result | [`media/state-3.png`](media/state-3.png) | frame from `media/product-motion.mp4` | 640×360 | 70167 | `a2d7ff558094d600b575d315451988978532dfd1364b34b9293abd6cf45d32c9` |

## First-success journey

**Actor:** Operator using DigitalOcean Cloud Control Panel  
...
The motion is an excerpt of an owner-published real-product recording, not a synthesized animation. Source: [How To Create a Cloud Server on DigitalOcean](https://www.youtube.com/watch?v=vqZ7eKM0WS8), published by **DigitalOcean**. Local state files are direct frame extractions from the local MP4 and can be inspected offline. All byte counts and SHA-256 values are recorded in [`reference.json`](reference.json).
