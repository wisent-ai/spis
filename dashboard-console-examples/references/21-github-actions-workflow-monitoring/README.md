# GitHub Actions Workflow Monitoring — observed product reference

- **Evidence status:** complete
- **Product:** [https://docs.github.com/en/actions/monitoring-and-troubleshooting-workflows/monitoring-workflows](https://docs.github.com/en/actions/monitoring-and-troubleshooting-workflows/monitoring-workflows)
- **Official motion source:** [How to use GitHub Actions](https://www.youtube.com/watch?v=BQrohJ3PT7I)
- **Upstream owner/channel:** GitHub
- **Captured:** 2026-08-16
- **Local motion:** [play `media/product-motion.mp4`](media/product-motion.mp4) (640×360, 15.015s, 450 frames, 95109 bytes, SHA-256 `babe08046ce60c17752673b09b9e3f9a4221e25cf20b27e63eaf6779a23bf9cc`)
- **Observed source interval:** 250.00–265.01s
...
|---|---|---|---:|---:|---|
| entry context | [`media/state-1.png`](media/state-1.png) | frame from `media/product-motion.mp4` | 640×360 | 105835 | `83a9645962375672b6f6b3d14fe48253f3a1fbf7754a241265233fa22a4c52f4` |
| focused working state | [`media/state-2.png`](media/state-2.png) | frame from `media/product-motion.mp4` | 640×360 | 123727 | `defe410973975b58b22781236a83f5a3f9a6602b602b676589799680641bd570` |
| first-success result | [`media/state-3.png`](media/state-3.png) | frame from `media/product-motion.mp4` | 640×360 | 114274 | `1b5bd3abfeee097391e678c3d682552f99c26854348c5e4ff54c8ff4078a92eb` |

## First-success journey

**Actor:** Operator using GitHub Actions Workflow Monitoring  
...
The motion is an excerpt of an owner-published real-product recording, not a synthesized animation. Source: [How to use GitHub Actions](https://www.youtube.com/watch?v=BQrohJ3PT7I), published by **GitHub**. Local state files are direct frame extractions from the local MP4 and can be inspected offline. All byte counts and SHA-256 values are recorded in [`reference.json`](reference.json).
