# Tableau Dashboards — observed product reference

- **Evidence status:** complete
- **Product:** [https://help.tableau.com/current/pro/desktop/en-us/dashboards.htm](https://help.tableau.com/current/pro/desktop/en-us/dashboards.htm)
- **Official motion source:** [Tableau Online Product Tour](https://www.youtube.com/watch?v=yJI3dV2FWwU)
- **Upstream owner/channel:** Tableau
- **Captured:** 2026-08-16
- **Local motion:** [play `media/product-motion.mp4`](media/product-motion.mp4) (640×360, 14.973s, 359 frames, 285419 bytes, SHA-256 `f31b92b4a961e6705f87ca787a5605a1acc76fc2e62f1c81c10f4a4913f80b5e`)
- **Observed source interval:** 19.20–34.17s
...
|---|---|---|---:|---:|---|
| entry context | [`media/state-1.png`](media/state-1.png) | frame from `media/product-motion.mp4` | 640×360 | 157325 | `717590e2d736bf182c1a3747f2aba0f1f6274ce5379aefcfee8daa4db223a69b` |
| focused working state | [`media/state-2.png`](media/state-2.png) | frame from `media/product-motion.mp4` | 640×360 | 141348 | `f5e00fed4a92cde90018c869da851b8462e95fe23325615c982d32959acc08f1` |
| first-success result | [`media/state-3.png`](media/state-3.png) | frame from `media/product-motion.mp4` | 640×360 | 119076 | `0df6461a395584d0ac00ea8255e6c11d509bbbced66c4dc55de84cf5c2e614b9` |

## First-success journey

**Actor:** Operator using Tableau Dashboards  
...
The motion is an excerpt of an owner-published real-product recording, not a synthesized animation. Source: [Tableau Online Product Tour](https://www.youtube.com/watch?v=yJI3dV2FWwU), published by **Tableau**. Local state files are direct frame extractions from the local MP4 and can be inspected offline. All byte counts and SHA-256 values are recorded in [`reference.json`](reference.json).
