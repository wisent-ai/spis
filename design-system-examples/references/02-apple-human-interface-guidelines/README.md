# Apple Human Interface Guidelines — observed reference

**Evidence status:** complete  
**Product:** [Apple Human Interface Guidelines](https://developer.apple.com/design/human-interface-guidelines/)  
**Upstream owner:** Apple Developer  
**Captured:** 2026-08-16

## Authentic evidence

- Motion: [`media/motion.mp4`](media/motion.mp4) — 256×144, 30.00s, 899 decoded frames, SHA-256 `356d820184e9a47070e5ad34f1794bf7a1ac384eadd56e64dd5fa6fb2b26a76e`.
- Source: [https://www.youtube.com/watch?v=DS2ildqCrB0](https://www.youtube.com/watch?v=DS2ildqCrB0)
- Capture: Downloaded from Apple Developer’s official product or documentation publication through a Cobalt transport endpoint; a 30-second source-frame excerpt was transcoded to H.264 with no generated or interpolated frames.
