# Scottish Government Design System — observed reference

**Evidence status:** complete  
**Product:** [Scottish Government Design System](https://designsystem.gov.scot/)  
**Upstream owner:** Scottish Government Design System  
**Captured:** 2026-08-16

## Authentic evidence

- Motion: [`media/motion.mp4`](media/motion.mp4) — 256×144, 24.33s, 584 decoded frames, SHA-256 `17e8eac40bc1bce7a8a4259cb0d0fdebe732a4bf8736d8907045f0dbed92e1ef`.
- Source: [https://www.youtube.com/watch?v=IdjDcagqguw](https://www.youtube.com/watch?v=IdjDcagqguw)
...
Actor: a developer or designer finding an implementable pattern. Prerequisites are an offline media player and the linked source for follow-through. Completion is the distinct settled frame at 20.68s.
