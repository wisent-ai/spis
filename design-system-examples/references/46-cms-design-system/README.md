# CMS Design System — observed reference

**Evidence status:** complete  
**Product:** [CMS Design System](https://design.cms.gov/)  
**Upstream owner:** CMS Design System  
**Captured:** 2026-08-16

## Authentic evidence

- Motion: [`media/motion.mp4`](media/motion.mp4) — 1920×1080, 146.45s, 4389 decoded frames, SHA-256 `34023a12cab4e7f34f17350942534dcafe0e21a9fa4fb7935e91720bc8dd7f89`.
- Source: [https://raw.githubusercontent.com/CMSgov/design-system/HEAD/packages/docs/static/videos/component-maturity-demo.mp4](https://raw.githubusercontent.com/CMSgov/design-system/HEAD/packages/docs/static/videos/component-maturity-demo.mp4)
...
Actor: a developer or designer finding an implementable pattern. Prerequisites are an offline media player and the linked source for follow-through. Completion is the distinct settled frame at 124.48s.
