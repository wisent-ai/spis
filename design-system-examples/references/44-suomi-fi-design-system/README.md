# Suomi.fi Design System — observed reference

**Evidence status:** complete  
**Product:** [Suomi.fi Design System](https://designsystem.suomi.fi/)  
**Upstream owner:** Suomi.fi  
**Captured:** 2026-08-16

## Authentic evidence

- Motion: [`media/motion.webm`](media/motion.webm) — 1280×720, 18.88s, 472 decoded frames, SHA-256 `9fdc85c0b8bb3822ec0ad12b5afb6fa4e5cfd9e3eb56da2befe121854a0cd558`.
- Source: [https://designsystem.suomi.fi/](https://designsystem.suomi.fi/)
- Capture: Real Suomi.fi Design System documentation interaction recorded by Weles on the Stado-selected charless-mac-mini dedicated host (job e076b66c), using verified Weles Chromium 147.0.7727.108-weles.1. Observed path: open documentation, scroll 560px, attempt Components navigation, scroll 760px, backtrack 520px.
...
Actor: a developer or designer finding an implementable pattern. Prerequisites are an offline media player and the linked source for follow-through. Completion is the distinct settled frame at 16.05s.
