# WAI-ARIA Authoring Practices Guide — observed reference

**Evidence status:** complete  
**Product:** [WAI-ARIA Authoring Practices Guide](https://www.w3.org/WAI/ARIA/apg/)  
**Upstream owner:** W3C WAI-ARIA APG  
**Captured:** 2026-08-16

## Authentic evidence

- Motion: [`media/motion.mp4`](media/motion.mp4) — 960×540, 9.92s, 248 decoded frames, SHA-256 `ef72def9eb606a2002c5c1dc1665d779a5bbcacd149efcc6251c747b25782523`.
- Source: [https://www.w3.org/cms-uploads/animation.mp4](https://www.w3.org/cms-uploads/animation.mp4)
...
Actor: a developer or designer finding an implementable pattern. Prerequisites are an offline media player and the linked source for follow-through. Completion is the distinct settled frame at 8.43s.
