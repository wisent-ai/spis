# Radix Primitives — observed reference

**Evidence status:** complete  
**Product:** [Radix Primitives](https://www.radix-ui.com/primitives)  
**Upstream owner:** Radix UI  
**Captured:** 2026-08-16

## Authentic evidence

- Motion: [`media/motion.mp4`](media/motion.mp4) — 256×144, 30.00s, 899 decoded frames, SHA-256 `b00339d8b191c8a177111cc6b39b7f8764191aebcbce246824b14b41646d440d`.
- Source: [https://www.youtube.com/watch?v=6d8z0P7jXuA](https://www.youtube.com/watch?v=6d8z0P7jXuA)
