# PatternFly — observed reference

**Evidence status:** complete  
**Product:** [PatternFly](https://www.patternfly.org/)  
**Upstream owner:** PatternFly  
**Captured:** 2026-08-16

## Authentic evidence

- Motion: [`media/motion.mp4`](media/motion.mp4) — 256×144, 30.00s, 900 decoded frames, SHA-256 `5687df44fd385d38c8d335ffd2d85ccf36a80bef04ea6793b6401ece70333e88`.
- Source: [https://www.youtube.com/watch?v=ImZEG-wAUJA](https://www.youtube.com/watch?v=ImZEG-wAUJA)
- Capture: Downloaded from PatternFly’s official product or documentation publication through a Cobalt transport endpoint; a 30-second source-frame excerpt was transcoded to H.264 with no generated or interpolated frames.
