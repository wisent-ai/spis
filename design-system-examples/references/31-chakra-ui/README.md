# Chakra UI — observed reference

**Evidence status:** complete  
**Product:** [Chakra UI](https://chakra-ui.com/)  
**Upstream owner:** Chakra UI  
**Captured:** 2026-08-16

## Authentic evidence

- Motion: [`media/motion.mp4`](media/motion.mp4) — 3500×2160, 13.32s, 799 decoded frames, SHA-256 `f2c9cae51eeeae4b0486200adcb16ebab4431def361afd69c7e84a02f60c0c08`.
- Source: [https://raw.githubusercontent.com/chakra-ui/chakra-ui/HEAD/apps/www/public/videos/codeblock.mp4](https://raw.githubusercontent.com/chakra-ui/chakra-ui/HEAD/apps/www/public/videos/codeblock.mp4)
...
Actor: a developer or designer finding an implementable pattern. Prerequisites are an offline media player and the linked source for follow-through. Completion is the distinct settled frame at 11.32s.
