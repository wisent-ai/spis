# Gestalt — observed reference

**Evidence status:** complete  
**Product:** [Gestalt](https://gestalt.pinterest.systems/)  
**Upstream owner:** Pinterest Gestalt  
**Captured:** 2026-08-16

## Authentic evidence

- Motion: [`media/motion.mp4`](media/motion.mp4) — 256×144, 29.99s, 719 decoded frames, SHA-256 `5ab89a54984658da695f6dffddfc9b2409e42c7561fc0a55084ad5d828dfaee2`.
- Source: [https://www.youtube.com/watch?v=qr8bNBuptpU](https://www.youtube.com/watch?v=qr8bNBuptpU)
- Capture: Downloaded from Pinterest’s official product publication through a Cobalt transport endpoint; the demonstrated product surface uses Gestalt. A 30-second source-frame excerpt was transcoded to H.264 with no generated or interpolated frames.
...
Actor: a developer or designer finding an implementable pattern. Prerequisites are an offline media player and the linked source for follow-through. Completion is the distinct settled frame at 25.49s.
