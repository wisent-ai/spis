# GitLab Pajamas — observed reference

**Evidence status:** complete  
**Product:** [GitLab Pajamas](https://design.gitlab.com/)  
**Upstream owner:** GitLab  
**Captured:** 2026-08-16

## Authentic evidence

- Motion: [`media/motion.mp4`](media/motion.mp4) — 276×170, 2.42s, 121 decoded frames, SHA-256 `7eb3f3dfdfd8501f1fc5df8493a63e5b655ee80cd0dc97d7eb3503a157032bde`.
- Source: [https://design.gitlab.com//video/feedback-hover.mp4](https://design.gitlab.com//video/feedback-hover.mp4)
...
Actor: a developer or designer finding an implementable pattern. Prerequisites are an offline media player and the linked source for follow-through. Completion is the distinct settled frame at 2.06s.
