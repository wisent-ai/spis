# U.S. Web Design System — observed reference

**Evidence status:** complete  
**Product:** [U.S. Web Design System](https://designsystem.digital.gov/)  
**Upstream owner:** U.S. Web Design System  
**Captured:** 2026-08-16

## Authentic evidence

- Motion: [`media/motion.gif`](media/motion.gif) — 80×80, 0.72s, 8 decoded frames, SHA-256 `7f4d6ca17552c16309ed30712ec9e94db543e9c6ea832b6434e32e8db6742b64`.
- Source: [https://raw.githubusercontent.com/uswds/uswds/HEAD/packages/usa-file-input/src/img/loader.gif](https://raw.githubusercontent.com/uswds/uswds/HEAD/packages/usa-file-input/src/img/loader.gif)
...
Actor: a developer or designer finding an implementable pattern. Prerequisites are an offline media player and the linked source for follow-through. Completion is the distinct settled frame at 0.61s.
