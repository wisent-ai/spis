# Blueprint — observed reference

**Evidence status:** complete  
**Product:** [Blueprint](https://blueprintjs.com/)  
**Upstream owner:** Palantir Blueprint  
**Captured:** 2026-08-16

## Authentic evidence

- Motion: [`media/motion.mp4`](media/motion.mp4) — 256×144, 30.00s, 899 decoded frames, SHA-256 `b6c2b19a33d7aadcb66f8d11ce8431c596d3cd61efdbbedd8a5a5d6f6e42b98d`.
- Source: [https://www.youtube.com/watch?v=uF-GSj-Exms](https://www.youtube.com/watch?v=uF-GSj-Exms)
- Capture: Downloaded from Palantir (Blueprint owner)’s official product or documentation publication through a Cobalt transport endpoint; a 30-second source-frame excerpt was transcoded to H.264 with no generated or interpolated frames.
