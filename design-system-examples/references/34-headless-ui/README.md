# Headless UI — observed reference

**Evidence status:** complete  
**Product:** [Headless UI](https://headlessui.com/)  
**Upstream owner:** Tailwind Labs Headless UI  
**Captured:** 2026-08-16

## Authentic evidence

- Motion: [`media/motion.mp4`](media/motion.mp4) — 256×144, 30.00s, 900 decoded frames, SHA-256 `40256c4e3aacc754d3a1935c4d3d4b5f681422803cb7f80153a6ae9d7899242a`.
- Source: [https://www.youtube.com/watch?v=qJnIJa-cF2M](https://www.youtube.com/watch?v=qJnIJa-cF2M)
- Capture: Downloaded from Tailwind Labs’s official product or documentation publication through a Cobalt transport endpoint; a 30-second source-frame excerpt was transcoded to H.264 with no generated or interpolated frames.
