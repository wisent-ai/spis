# Ant Design — observed reference

**Evidence status:** complete  
**Product:** [Ant Design](https://ant.design/)  
**Upstream owner:** Ant Design  
**Captured:** 2026-08-16

## Authentic evidence

- Motion: [`media/motion.webm`](media/motion.webm) — 1280×720, 21.00s, 525 decoded frames, SHA-256 `c7d2f0bcfe34e4329f94ca5772353f674791b35c454fefd8e7ec6e190f49fb5a`.
- Source: [https://ant.design/](https://ant.design/)
- Capture: Real Ant Design documentation interaction recorded by Weles on the Stado-selected charless-mac-mini dedicated host (job e076b66c), using verified Weles Chromium 147.0.7727.108-weles.1. Observed path: open documentation, scroll 560px, activate Components, scroll 760px, backtrack 520px.
...
Actor: a developer or designer finding an implementable pattern. Prerequisites are an offline media player and the linked source for follow-through. Completion is the distinct settled frame at 17.85s.
