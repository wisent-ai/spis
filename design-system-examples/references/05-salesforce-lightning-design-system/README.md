# Salesforce Lightning Design System — observed reference

**Evidence status:** complete  
**Product:** [Salesforce Lightning Design System](https://www.lightningdesignsystem.com/)  
**Upstream owner:** Salesforce Lightning Design System  
**Captured:** 2026-08-16

## Authentic evidence

- Motion: [`media/motion.gif`](media/motion.gif) — 184×184, 0.98s, 49 decoded frames, SHA-256 `518f99075b2ced02fe265658f6c93eae2aa2ebec278ed6a7a56b3ca7a343816a`.
- Source: [https://raw.githubusercontent.com/salesforce-ux/design-system/HEAD/assets/images/spinners/slds_spinner_brand.gif](https://raw.githubusercontent.com/salesforce-ux/design-system/HEAD/assets/images/spinners/slds_spinner_brand.gif)
...
Actor: a developer or designer finding an implementable pattern. Prerequisites are an offline media player and the linked source for follow-through. Completion is the distinct settled frame at 0.83s.
