# GNOME Human Interface Guidelines — observed reference

**Evidence status:** complete  
**Product:** [GNOME Human Interface Guidelines](https://developer.gnome.org/hig/)  
**Upstream owner:** GNOME  
**Captured:** 2026-08-16

## Authentic evidence

- Motion: [`media/motion.mp4`](media/motion.mp4) — 256×144, 30.00s, 750 decoded frames, SHA-256 `e7f4c5f57b40f973860dfcc9657049fc3b0c9f0aeaf17f6197b1a93a3a73f6c9`.
- Source: [https://www.youtube.com/watch?v=F-kcc9-5cOQ](https://www.youtube.com/watch?v=F-kcc9-5cOQ)
