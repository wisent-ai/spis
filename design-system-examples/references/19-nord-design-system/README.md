# Nord Design System — observed reference

**Evidence status:** complete  
**Product:** [Nord Design System](https://nordhealth.design/)  
**Upstream owner:** Nordhealth  
**Captured:** 2026-08-16

## Authentic evidence

- Motion: [`media/motion.mp4`](media/motion.mp4) — 256×144, 20.73s, 622 decoded frames, SHA-256 `6a56da589cf94c8f1021fd1086345425909e4de9dd142139e5ad39b2a9abd848`.
- Source: [https://www.youtube.com/watch?v=RMYT776zSh4](https://www.youtube.com/watch?v=RMYT776zSh4)
- Capture: Downloaded from Provet’s official product publication (a Nordhealth product using the Nord design system) through a Cobalt transport endpoint; a 30-second source-frame excerpt was transcoded to H.264 with no generated or interpolated frames.
...
Actor: a developer or designer finding an implementable pattern. Prerequisites are an offline media player and the linked source for follow-through. Completion is the distinct settled frame at 17.62s.
