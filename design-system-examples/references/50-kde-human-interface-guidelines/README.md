# KDE Human Interface Guidelines — observed reference

**Evidence status:** complete  
**Product:** [KDE Human Interface Guidelines](https://develop.kde.org/hig/)  
**Upstream owner:** KDE Community  
**Captured:** 2026-08-16

## Authentic evidence

- Motion: [`media/motion.mp4`](media/motion.mp4) — 256×144, 30.00s, 899 decoded frames, SHA-256 `065b563a8c397acf7b1a49c0f76769b06627d6e954ee3eb06d0bf285a1fdf86b`.
- Source: [https://www.youtube.com/watch?v=kWLHUMVWs4A](https://www.youtube.com/watch?v=kWLHUMVWs4A)
- Capture: Downloaded from KDE Community’s official product or documentation publication through a Cobalt transport endpoint; a 30-second source-frame excerpt was transcoded to H.264 with no generated or interpolated frames.
