# Atlassian Design System — observed reference

**Evidence status:** complete  
**Product:** [Atlassian Design System](https://atlassian.design/)  
**Upstream owner:** Atlassian  
**Captured:** 2026-08-16

## Authentic evidence

- Motion: [`media/motion.mp4`](media/motion.mp4) — 256×144, 30.00s, 899 decoded frames, SHA-256 `d7542eef7403b410a249f4175bf1967779ce7ae40abea644763d95ee077a736f`.
- Source: [https://www.youtube.com/watch?v=Ina4Ycq-3Eg](https://www.youtube.com/watch?v=Ina4Ycq-3Eg)
- Capture: Downloaded from Atlassian’s official product or documentation publication through a Cobalt transport endpoint; a 30-second source-frame excerpt was transcoded to H.264 with no generated or interpolated frames.
