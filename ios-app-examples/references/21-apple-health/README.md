# Apple Health — observed iOS product reference

**Evidence status:** complete  
**Product:** [https://www.apple.com/ios/health/](https://www.apple.com/ios/health/)  
**Captured:** 2026-08-16  
**Upstream owner / publisher:** Apple Health product owner; recording published by Apple Support

## Authentic motion evidence

Play [`media/motion.mp4`](media/motion.mp4). This is retained product motion, not animation synthesized from stills.

- Source: [How to use mental health features on iPhone | Apple Support](https://www.youtube.com/watch?v=E6Ij5msWaTM)
...
- Media: 640×360, 120.000 s, 1800 frames, 416343 bytes
- SHA-256: `cd8d1cebcd9bb9000b72a48d1ceb10c82b2a09c8f980668045ebe6285eae62c7`

## Key states tied to the motion

| State | Local evidence | SHA-256 |
|---|---|---|
| entry / orientation | [media/state-01.png](media/state-01.png) | `4fa2886175575d8056e68b291f12e4bb06934db5d996f39f03a28b6e43c32845` |
| action in progress | [media/state-02.png](media/state-02.png) | `e8e8e6d146d68c17832852814488bb755b2996eabe86684d2572cff0b067873a` |
| result / established state | [media/state-03.png](media/state-03.png) | `0f2ed6a1b0bfd176fa5097c36bc32baf32eb7aa324dde47c023d18dacd7386ab` |

## First-success journey

**Actor:** A first-time or returning iPhone user with the minimum product account/device prerequisites  
**Goal:** Log a mental-health state in Apple Health
...
1. **Open Health** — The product exposes its initial context and available next action. Evidence: `media/motion.mp4 at 00:06.0`
2. **navigate to mental wellbeing** — The selected destination or task surface replaces or overlays the prior state. Evidence: `media/motion.mp4 at 00:30.0`
3. **choose a state-of-mind log** — The product reflects the entered choice or manipulation and exposes the next control. Evidence: `media/motion.mp4 at 00:54.0`
4. **record and confirm the state** — The product acknowledges the commit and transitions toward the result. Evidence: `media/motion.mp4 at 01:18.0`
5. **see the completed log and insight** — The completed result remains visible as durable evidence of first success. Evidence: `media/motion.mp4 at 01:42.0`
...
- Recovery route: Continue from the retained incomplete state and record and confirm the state. The confirmation transition resumes from the same observed flow. Then see the completed log and insight; The product shows the documented first-success result: see the completed log and insight. Evidence: `media/motion.mp4 01:21.6–01:52.8`

## Interaction map

| Interaction | Trigger | Response | Feedback | Evidence |
|---|---|---|---|---|
| primary input | navigate to mental wellbeing | The primary task surface opens. | Selection highlight and surface transition make the response visible. | `media/motion.mp4 00:14.4–00:33.6` |
| focus / selection | choose a state-of-mind log | The chosen field, row, item, or canvas becomes the active target. | The target changes emphasis or reveals contextual controls. | `media/motion.mp4 00:31.2–00:52.8` |
| navigation | Open Health | The app moves from entry context to the task destination. | Header, content, or navigation state changes. | `media/motion.mp4 00:04.8–00:28.8` |
| confirmation | record and confirm the state | The pending action commits and the result transition begins. | A changed state, progress response, or completed item acknowledges the commit. | `media/motion.mp4 01:09.6–01:31.2` |
...
| recovery | Continue from the incomplete state and record and confirm the state. | The product resumes the path and produces the visible result. | The final state replaces the incomplete state. | `media/motion.mp4 01:02.4–01:50.4` |

Cancellation, failure, and recovery details for every interaction are retained verbatim in [`reference.json`](reference.json).

## Motion behavior

- **Trigger:** navigate to mental wellbeing
