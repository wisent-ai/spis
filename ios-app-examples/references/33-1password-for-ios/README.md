# 1Password for iOS — observed iOS product reference

**Evidence status:** complete  
**Product:** [https://1password.com/downloads/ios/](https://1password.com/downloads/ios/)  
**Captured:** 2026-08-16  
**Upstream owner / publisher:** 1Password for iOS product owner; recording published by 1Password

## Authentic motion evidence

Play [`media/motion.mp4`](media/motion.mp4). This is retained product motion, not animation synthesized from stills.

- Source: [How to get started with 1Password](https://www.youtube.com/watch?v=seMl5imFNCQ)
...
- Media: 640×360, 120.000 s, 1800 frames, 399570 bytes
- SHA-256: `5a1308b43cbc29ca668e1e4bbdb2394e24af899c5513658e451122b2c8ba82bc`

## Key states tied to the motion

| State | Local evidence | SHA-256 |
|---|---|---|
| entry / orientation | [media/state-01.png](media/state-01.png) | `ef7ce1424bc77c69f3608f394ab167b10308c20def01736f1740ba7ccb58c24f` |
| action in progress | [media/state-02.png](media/state-02.png) | `e2a0e3efcf6f5599a197298f378d7b94a67ddc7e06248d68451b2208aac88a00` |
| result / established state | [media/state-03.png](media/state-03.png) | `ac3f3c2271846fde45018806b989367c2ed2835783e45c352a2d018e485697cd` |

## First-success journey

**Actor:** A first-time or returning iPhone user with the minimum product account/device prerequisites  
**Goal:** Get started with 1Password
...
1. **Open 1Password onboarding** — The product exposes its initial context and available next action. Evidence: `media/motion.mp4 at 00:06.0`
2. **create or join an account** — The selected destination or task surface replaces or overlays the prior state. Evidence: `media/motion.mp4 at 00:30.0`
3. **add account and vault credentials** — The product reflects the entered choice or manipulation and exposes the next control. Evidence: `media/motion.mp4 at 00:54.0`
4. **confirm sign-in/setup** — The product acknowledges the commit and transitions toward the result. Evidence: `media/motion.mp4 at 01:18.0`
5. **reach the usable vault** — The completed result remains visible as durable evidence of first success. Evidence: `media/motion.mp4 at 01:42.0`
...
- Recovery route: Continue from the retained incomplete state and confirm sign-in/setup. The confirmation transition resumes from the same observed flow. Then reach the usable vault; The product shows the documented first-success result: reach the usable vault. Evidence: `media/motion.mp4 01:21.6–01:52.8`

## Interaction map

| Interaction | Trigger | Response | Feedback | Evidence |
|---|---|---|---|---|
| primary input | create or join an account | The primary task surface opens. | Selection highlight and surface transition make the response visible. | `media/motion.mp4 00:14.4–00:33.6` |
| focus / selection | add account and vault credentials | The chosen field, row, item, or canvas becomes the active target. | The target changes emphasis or reveals contextual controls. | `media/motion.mp4 00:31.2–00:52.8` |
| navigation | Open 1Password onboarding | The app moves from entry context to the task destination. | Header, content, or navigation state changes. | `media/motion.mp4 00:04.8–00:28.8` |
| confirmation | confirm sign-in/setup | The pending action commits and the result transition begins. | A changed state, progress response, or completed item acknowledges the commit. | `media/motion.mp4 01:09.6–01:31.2` |
...
| recovery | Continue from the incomplete state and confirm sign-in/setup. | The product resumes the path and produces the visible result. | The final state replaces the incomplete state. | `media/motion.mp4 01:02.4–01:50.4` |

Cancellation, failure, and recovery details for every interaction are retained verbatim in [`reference.json`](reference.json).

## Motion behavior

- **Trigger:** create or join an account
