# TestFlight — observed iOS product reference

**Evidence status:** complete  
**Product:** [https://apps.apple.com/us/app/testflight/id899247664](https://apps.apple.com/us/app/testflight/id899247664)  
**Captured:** 2026-08-16  
**Upstream owner / publisher:** TestFlight product owner; recording published by Apple Developer

## Authentic motion evidence

Play [`media/motion.mp4`](media/motion.mp4). This is retained product motion, not animation synthesized from stills.

- Source: [Get started with TestFlight | 2023 | Apple](https://www.youtube.com/watch?v=ZUeLAMzi-oY)
...
- Media: 640×360, 120.000 s, 1800 frames, 166259 bytes
- SHA-256: `35fe03de2d6a58e03a230fe59ae15c5be2a7fc49f1d12fbc2f81f06c6a2e16b9`

## Key states tied to the motion

| State | Local evidence | SHA-256 |
|---|---|---|
| entry / orientation | [media/state-01.png](media/state-01.png) | `7c68c41f15be247ac94feae0dc5708e1962922cc722a8b2e0df3a0189ee9881b` |
| action in progress | [media/state-02.png](media/state-02.png) | `31a0a47d190e117bf19a0017801d66550d26367e15009e68e96a6a6a115d3573` |
| result / established state | [media/state-03.png](media/state-03.png) | `f661fbf8dec0c4133d1f1ff265bd7986401b4835aef828efcd5010e7b34672ef` |

## First-success journey

**Actor:** A first-time or returning iPhone user with the minimum product account/device prerequisites  
**Goal:** Deliver a first TestFlight beta
...
1. **Open the TestFlight workflow** — The product exposes its initial context and available next action. Evidence: `media/motion.mp4 at 00:06.0`
2. **configure a build and tester group** — The selected destination or task surface replaces or overlays the prior state. Evidence: `media/motion.mp4 at 00:30.0`
3. **invite or accept a tester** — The product reflects the entered choice or manipulation and exposes the next control. Evidence: `media/motion.mp4 at 00:54.0`
4. **install/open the build** — The product acknowledges the commit and transitions toward the result. Evidence: `media/motion.mp4 at 01:18.0`
5. **see the beta available for testing** — The completed result remains visible as durable evidence of first success. Evidence: `media/motion.mp4 at 01:42.0`
...
- Recovery route: Continue from the retained incomplete state and install/open the build. The confirmation transition resumes from the same observed flow. Then see the beta available for testing; The product shows the documented first-success result: see the beta available for testing. Evidence: `media/motion.mp4 01:21.6–01:52.8`

## Interaction map

| Interaction | Trigger | Response | Feedback | Evidence |
|---|---|---|---|---|
| primary input | configure a build and tester group | The primary task surface opens. | Selection highlight and surface transition make the response visible. | `media/motion.mp4 00:14.4–00:33.6` |
| focus / selection | invite or accept a tester | The chosen field, row, item, or canvas becomes the active target. | The target changes emphasis or reveals contextual controls. | `media/motion.mp4 00:31.2–00:52.8` |
| navigation | Open the TestFlight workflow | The app moves from entry context to the task destination. | Header, content, or navigation state changes. | `media/motion.mp4 00:04.8–00:28.8` |
| confirmation | install/open the build | The pending action commits and the result transition begins. | A changed state, progress response, or completed item acknowledges the commit. | `media/motion.mp4 01:09.6–01:31.2` |
...
| recovery | Continue from the incomplete state and install/open the build. | The product resumes the path and produces the visible result. | The final state replaces the incomplete state. | `media/motion.mp4 01:02.4–01:50.4` |

Cancellation, failure, and recovery details for every interaction are retained verbatim in [`reference.json`](reference.json).

## Motion behavior

- **Trigger:** configure a build and tester group
