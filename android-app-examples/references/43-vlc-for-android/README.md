# 43. VLC for Android — observed Android product reference

**Product:** [VLC for Android](https://play.google.com/store/apps/details?id=org.videolan.vlc)  
**Motion source:** [How to Play Video in VLC on Android](https://www.youtube.com/watch?v=z-RZ9LFKTug)  
**Upstream owner/publisher:** Ftopreview.com  
**Evidence status:** complete  
**Captured:** 2026-08-16T23:00:00Z  

<video src="media/motion.mp4" controls width="640"></video>

The local MP4 is authentic recorded product motion, not an animation synthesized from catalog stills. Real Android product screen recording published by Ftopreview.com, archived from its YouTube source with the Pytubefix MWEB/TV client; publisher device/account environment is not disclosed; no synthesized or interpolated motion.

## Three retained states

| State | Local evidence | Relationship |
|---|---|---|
| Entry | ![Entry state](media/state-01-entry.jpg) | Frame from `media/motion.mp4` at 00:20.4 |
| Decision | ![Decision state](media/state-02-decision.jpg) | Frame from `media/motion.mp4` at 01:04.9 |
| Success | ![Success state](media/state-03-success.jpg) | Frame from `media/motion.mp4` at 01:49.5 |
...
|---:|---|---|---|---|
| 1 | Open the product surface shown in the retained recording. | The interface presents the media home. | media home | `media/motion.mp4 @ 00:02.5` |
| 2 | Choose the visible primary item, destination, or creation action. | The interface advances to the title or library item selected. | title or library item selected | `media/motion.mp4 @ 00:22.9` |
| 3 | Move into the focused task surface and select the demonstrated control. | The focused control reveals the playback started. | playback started | `media/motion.mp4 @ 00:45.8` |
| 4 | Enter or adjust the demonstrated value, content, route, or media option. | The product updates to the playback controls. | playback controls | `media/motion.mp4 @ 01:11.3` |
| 5 | Review the intermediate state and invoke the visible confirmation or start control. | The product shows the secondary option changed. | secondary option changed | `media/motion.mp4 @ 01:34.2` |
| 6 | Inspect the resulting saved, active, or completed product state. | The recording ends with the stable media result. | stable media result | `media/motion.mp4 @ 01:57.1` |
...
- **Timing class:** short product demonstration, 127.300 seconds and 3819 decoded video frames.
...
| Item | Value |
|---|---|
| Source page | https://www.youtube.com/watch?v=z-RZ9LFKTug |
| Product page | https://play.google.com/store/apps/details?id=org.videolan.vlc |
| Publisher | Ftopreview.com |
| Capture method | Real Android product screen recording published by Ftopreview.com, archived from its YouTube source with the Pytubefix MWEB/TV client; publisher device/account environment is not disclosed; no synthesized or interpolated motion. |
| Captured at | 2026-08-16T23:00:00Z |
| Motion metadata | 640×360; 127.300s; 3819 frames; 3251556 bytes |
| Motion SHA-256 | `90291097e3c9a9ce72f81d9853b023af64c0a984da7ef94b141efa7bad938619` |
