# 46. Waze Navigation & Live Traffic — observed Android product reference

**Product:** [Waze Navigation & Live Traffic](https://play.google.com/store/apps/details?id=com.waze)  
**Motion source:** [How To Actually Use Waze — 2025 Guide](https://www.youtube.com/watch?v=sqO79ZuLCOM)  
**Upstream owner/publisher:** Printers With Pat  
**Evidence status:** complete  
**Captured:** 2026-08-16T23:00:00Z  

<video src="media/motion.mp4" controls width="640"></video>

The local MP4 is authentic recorded product motion, not an animation synthesized from catalog stills. Real Android product screen recording published by Printers With Pat, archived from its YouTube source with the Pytubefix MWEB/TV client; publisher device/account environment is not disclosed; no synthesized or interpolated motion.

## Three retained states

| State | Local evidence | Relationship |
|---|---|---|
| Entry | ![Entry state](media/state-01-entry.jpg) | Frame from `media/motion.mp4` at 00:22.8 |
| Decision | ![Decision state](media/state-02-decision.jpg) | Frame from `media/motion.mp4` at 01:12.7 |
| Success | ![Success state](media/state-03-success.jpg) | Frame from `media/motion.mp4` at 02:02.6 |
...
|---:|---|---|---|---|
| 1 | Open the product surface shown in the retained recording. | The interface presents the map entry. | map entry | `media/motion.mp4 @ 00:02.9` |
| 2 | Choose the visible primary item, destination, or creation action. | The interface advances to the destination selected. | destination selected | `media/motion.mp4 @ 00:25.7` |
| 3 | Move into the focused task surface and select the demonstrated control. | The focused control reveals the route alternatives. | route alternatives | `media/motion.mp4 @ 00:51.3` |
| 4 | Enter or adjust the demonstrated value, content, route, or media option. | The product updates to the route option chosen. | route option chosen | `media/motion.mp4 @ 01:19.8` |
| 5 | Review the intermediate state and invoke the visible confirmation or start control. | The product shows the navigation confirmation. | navigation confirmation | `media/motion.mp4 @ 01:45.5` |
| 6 | Inspect the resulting saved, active, or completed product state. | The recording ends with the active route result. | active route result | `media/motion.mp4 @ 02:11.1` |
...
- **Timing class:** short product demonstration, 142.542 seconds and 3421 decoded video frames.
...
| Item | Value |
|---|---|
| Source page | https://www.youtube.com/watch?v=sqO79ZuLCOM |
| Product page | https://play.google.com/store/apps/details?id=com.waze |
| Publisher | Printers With Pat |
| Capture method | Real Android product screen recording published by Printers With Pat, archived from its YouTube source with the Pytubefix MWEB/TV client; publisher device/account environment is not disclosed; no synthesized or interpolated motion. |
| Captured at | 2026-08-16T23:00:00Z |
| Motion metadata | 640×360; 142.542s; 3421 frames; 1379914 bytes |
| Motion SHA-256 | `5e960af545a1f8d45e67213260e5cfbe6deb05f62b30e1017cf491785cb497bd` |
