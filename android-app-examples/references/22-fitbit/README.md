# 22. Fitbit — observed Android product reference

**Product:** [Fitbit](https://play.google.com/store/apps/details?id=com.fitbit.FitbitMobile)  
**Motion source:** [How To Use Fitbit App — Step By Step](https://www.youtube.com/watch?v=lGZyVe_ZUFc)  
**Upstream owner/publisher:** IN APP  
**Evidence status:** complete  
**Captured:** 2026-08-16T23:00:00Z  

<video src="media/motion.mp4" controls width="640"></video>

The local MP4 is authentic recorded product motion, not an animation synthesized from catalog stills. Real Android product screen recording published by IN APP, archived from its YouTube source with the Pytubefix MWEB/TV client; publisher device/account environment is not disclosed; no synthesized or interpolated motion.

## Three retained states

| State | Local evidence | Relationship |
|---|---|---|
| Entry | ![Entry state](media/state-01-entry.jpg) | Frame from `media/motion.mp4` at 00:18.8 |
| Decision | ![Decision state](media/state-02-decision.jpg) | Frame from `media/motion.mp4` at 01:00.1 |
| Success | ![Success state](media/state-03-success.jpg) | Frame from `media/motion.mp4` at 01:41.3 |
...
|---:|---|---|---|---|
| 1 | Open the product surface shown in the retained recording. | The interface presents the health overview. | health overview | `media/motion.mp4 @ 00:02.4` |
| 2 | Choose the visible primary item, destination, or creation action. | The interface advances to the metric or activity selected. | metric or activity selected | `media/motion.mp4 @ 00:21.2` |
| 3 | Move into the focused task surface and select the demonstrated control. | The focused control reveals the entry controls. | entry controls | `media/motion.mp4 @ 00:42.4` |
| 4 | Enter or adjust the demonstrated value, content, route, or media option. | The product updates to the value or goal configured. | value or goal configured | `media/motion.mp4 @ 01:05.9` |
| 5 | Review the intermediate state and invoke the visible confirmation or start control. | The product shows the save boundary. | save boundary | `media/motion.mp4 @ 01:27.1` |
| 6 | Inspect the resulting saved, active, or completed product state. | The recording ends with the updated health result. | updated health result | `media/motion.mp4 @ 01:48.3` |
...
- **Timing class:** short product demonstration, 117.750 seconds and 1413 decoded video frames.
...
| Item | Value |
|---|---|
| Source page | https://www.youtube.com/watch?v=lGZyVe_ZUFc |
| Product page | https://play.google.com/store/apps/details?id=com.fitbit.FitbitMobile |
| Publisher | IN APP |
| Capture method | Real Android product screen recording published by IN APP, archived from its YouTube source with the Pytubefix MWEB/TV client; publisher device/account environment is not disclosed; no synthesized or interpolated motion. |
| Captured at | 2026-08-16T23:00:00Z |
| Motion metadata | 640×360; 117.750s; 1413 frames; 626275 bytes |
| Motion SHA-256 | `7bf0b239d0b9e8d0e400c769330919f2bac725703622176d7b70a1eda453d8e7` |
