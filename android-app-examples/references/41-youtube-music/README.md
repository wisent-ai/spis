# 41. YouTube Music — observed Android product reference

**Product:** [YouTube Music](https://play.google.com/store/apps/details?id=com.google.android.apps.youtube.music)  
**Motion source:** [YouTube Music: Discover the world of music](https://www.youtube.com/watch?v=TxIsrqykLjQ)  
**Upstream owner/publisher:** YouTube Music  
**Evidence status:** complete  
**Captured:** 2026-08-16T23:00:00Z  

<video src="media/motion.mp4" controls width="640"></video>

The local MP4 is authentic recorded product motion, not an animation synthesized from catalog stills. Product-owner or official documentation recording published by YouTube Music, archived through a self-hosted Cobalt transport; no synthesized or interpolated motion.

## Three retained states

| State | Local evidence | Relationship |
|---|---|---|
| Entry | ![Entry state](media/state-01-entry.jpg) | Frame from `media/motion.mp4` at 00:04.8 |
| Decision | ![Decision state](media/state-02-decision.jpg) | Frame from `media/motion.mp4` at 00:15.3 |
| Success | ![Success state](media/state-03-success.jpg) | Frame from `media/motion.mp4` at 00:25.8 |
...
|---:|---|---|---|---|
| 1 | Open the product surface shown in the retained recording. | The interface presents the media home. | media home | `media/motion.mp4 @ 00:00.6` |
| 2 | Choose the visible primary item, destination, or creation action. | The interface advances to the title or library item selected. | title or library item selected | `media/motion.mp4 @ 00:05.4` |
| 3 | Move into the focused task surface and select the demonstrated control. | The focused control reveals the playback started. | playback started | `media/motion.mp4 @ 00:10.8` |
| 4 | Enter or adjust the demonstrated value, content, route, or media option. | The product updates to the playback controls. | playback controls | `media/motion.mp4 @ 00:16.8` |
| 5 | Review the intermediate state and invoke the visible confirmation or start control. | The product shows the secondary option changed. | secondary option changed | `media/motion.mp4 @ 00:22.2` |
| 6 | Inspect the resulting saved, active, or completed product state. | The recording ends with the stable media result. | stable media result | `media/motion.mp4 @ 00:27.6` |
...
- **Timing class:** short product demonstration, 30.030 seconds and 720 decoded video frames.
...
| Item | Value |
|---|---|
| Source page | https://www.youtube.com/watch?v=TxIsrqykLjQ |
| Product page | https://play.google.com/store/apps/details?id=com.google.android.apps.youtube.music |
| Publisher | YouTube Music |
| Capture method | Product-owner or official documentation recording published by YouTube Music, archived through a self-hosted Cobalt transport; no synthesized or interpolated motion. |
| Captured at | 2026-08-16T23:00:00Z |
| Motion metadata | 640×360; 30.030s; 720 frames; 1572170 bytes |
| Motion SHA-256 | `d647b976a2fa910762dc0a775ea1ca53367c87d724328cb5229ef5018da97a06` |
