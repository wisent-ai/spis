# 45. Google Maps — observed Android product reference

**Product:** [Google Maps](https://play.google.com/store/apps/details?id=com.google.android.apps.maps)  
**Motion source:** [How to use Google Maps on Android phone to navigate](https://www.youtube.com/watch?v=Xo7yywC9iPk)  
**Upstream owner/publisher:** iZem  
**Evidence status:** complete  
**Captured:** 2026-08-16T23:00:00Z  

<video src="media/motion.mp4" controls width="640"></video>

The local MP4 is authentic recorded product motion, not an animation synthesized from catalog stills. Real Android product screen recording published by iZem, archived from its YouTube source with the Pytubefix MWEB/TV client; publisher device/account environment is not disclosed; no synthesized or interpolated motion.

## Three retained states

| State | Local evidence | Relationship |
|---|---|---|
| Entry | ![Entry state](media/state-01-entry.jpg) | Frame from `media/motion.mp4` at 00:23.7 |
| Decision | ![Decision state](media/state-02-decision.jpg) | Frame from `media/motion.mp4` at 01:15.6 |
| Success | ![Success state](media/state-03-success.jpg) | Frame from `media/motion.mp4` at 02:07.5 |
...
|---:|---|---|---|---|
| 1 | Open the product surface shown in the retained recording. | The interface presents the map entry. | map entry | `media/motion.mp4 @ 00:03.0` |
| 2 | Choose the visible primary item, destination, or creation action. | The interface advances to the destination selected. | destination selected | `media/motion.mp4 @ 00:26.7` |
| 3 | Move into the focused task surface and select the demonstrated control. | The focused control reveals the route alternatives. | route alternatives | `media/motion.mp4 @ 00:53.4` |
| 4 | Enter or adjust the demonstrated value, content, route, or media option. | The product updates to the route option chosen. | route option chosen | `media/motion.mp4 @ 01:23.0` |
| 5 | Review the intermediate state and invoke the visible confirmation or start control. | The product shows the navigation confirmation. | navigation confirmation | `media/motion.mp4 @ 01:49.7` |
| 6 | Inspect the resulting saved, active, or completed product state. | The recording ends with the active route result. | active route result | `media/motion.mp4 @ 02:16.4` |
...
- **Timing class:** short product demonstration, 148.300 seconds and 4449 decoded video frames.
...
| Item | Value |
|---|---|
| Source page | https://www.youtube.com/watch?v=Xo7yywC9iPk |
| Product page | https://play.google.com/store/apps/details?id=com.google.android.apps.maps |
| Publisher | iZem |
| Capture method | Real Android product screen recording published by iZem, archived from its YouTube source with the Pytubefix MWEB/TV client; publisher device/account environment is not disclosed; no synthesized or interpolated motion. |
| Captured at | 2026-08-16T23:00:00Z |
| Motion metadata | 640×360; 148.300s; 4449 frames; 2301835 bytes |
| Motion SHA-256 | `5f1bab13516fac134d9798bf735a23d4e66f5bc38c02632866c544c6994198b6` |
