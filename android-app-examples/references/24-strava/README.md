# 24. Strava — observed Android product reference

**Product:** [Strava](https://play.google.com/store/apps/details?id=com.strava)  
**Motion source:** [How To Use Strava App For Running](https://www.youtube.com/watch?v=gsZYZwparz8)  
**Upstream owner/publisher:** One2Step  
**Evidence status:** complete  
**Captured:** 2026-08-16T23:00:00Z  

<video src="media/motion.mp4" controls width="640"></video>

The local MP4 is authentic recorded product motion, not an animation synthesized from catalog stills. Real Android product screen recording published by One2Step, archived through a self-hosted Cobalt transport; publisher environment is not disclosed; no synthesized or interpolated motion.

## Three retained states

| State | Local evidence | Relationship |
|---|---|---|
| Entry | ![Entry state](media/state-01-entry.jpg) | Frame from `media/motion.mp4` at 00:05.2 |
| Decision | ![Decision state](media/state-02-decision.jpg) | Frame from `media/motion.mp4` at 00:16.5 |
| Success | ![Success state](media/state-03-success.jpg) | Frame from `media/motion.mp4` at 00:27.8 |
...
| 2 | Choose the visible primary item, destination, or creation action. | The interface advances to the metric or activity selected. | metric or activity selected | `media/motion.mp4 @ 00:05.8` |
| 3 | Move into the focused task surface and select the demonstrated control. | The focused control reveals the entry controls. | entry controls | `media/motion.mp4 @ 00:11.6` |
| 4 | Enter or adjust the demonstrated value, content, route, or media option. | The product updates to the value or goal configured. | value or goal configured | `media/motion.mp4 @ 00:18.1` |
| 5 | Review the intermediate state and invoke the visible confirmation or start control. | The product shows the save boundary. | save boundary | `media/motion.mp4 @ 00:23.9` |
| 6 | Inspect the resulting saved, active, or completed product state. | The recording ends with the updated health result. | updated health result | `media/motion.mp4 @ 00:29.7` |
...
- **Timing class:** short product demonstration, 32.333 seconds and 970 decoded video frames.
...
| Item | Value |
|---|---|
| Source page | https://www.youtube.com/watch?v=gsZYZwparz8 |
| Product page | https://play.google.com/store/apps/details?id=com.strava |
| Publisher | One2Step |
| Capture method | Real Android product screen recording published by One2Step, archived through a self-hosted Cobalt transport; publisher environment is not disclosed; no synthesized or interpolated motion. |
| Captured at | 2026-08-16T23:00:00Z |
| Motion metadata | 640×360; 32.333s; 970 frames; 858818 bytes |
| Motion SHA-256 | `7d4c1a63e9d876291301c585fa4fc850317fdff3cb99dfcade589024b354f4a9` |
