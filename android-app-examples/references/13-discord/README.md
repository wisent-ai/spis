# 13. Discord — observed Android product reference

**Product:** [Discord](https://play.google.com/store/apps/details?id=com.discord)  
**Motion source:** [How to Create a Discord Channel on Mobile](https://www.youtube.com/watch?v=_9hK8Wj42Cs)  
**Upstream owner/publisher:** MyTechGuy  
**Evidence status:** complete  
**Captured:** 2026-08-16T23:00:00Z  

<video src="media/motion.mp4" controls width="640"></video>

The local MP4 is authentic recorded product motion, not an animation synthesized from catalog stills. Real Android product screen recording published by MyTechGuy, archived through a self-hosted Cobalt transport; publisher environment is not disclosed; no synthesized or interpolated motion.

## Three retained states

| State | Local evidence | Relationship |
|---|---|---|
| Entry | ![Entry state](media/state-01-entry.jpg) | Frame from `media/motion.mp4` at 00:07.1 |
| Decision | ![Decision state](media/state-02-decision.jpg) | Frame from `media/motion.mp4` at 00:22.5 |
| Success | ![Success state](media/state-03-success.jpg) | Frame from `media/motion.mp4` at 00:38.0 |
...
|---:|---|---|---|---|
| 1 | Open the product surface shown in the retained recording. | The interface presents the app entry. | app entry | `media/motion.mp4 @ 00:00.9` |
| 2 | Choose the visible primary item, destination, or creation action. | The interface advances to the recipient or channel selected. | recipient or channel selected | `media/motion.mp4 @ 00:08.0` |
| 3 | Move into the focused task surface and select the demonstrated control. | The focused control reveals the communication controls. | communication controls | `media/motion.mp4 @ 00:15.9` |
| 4 | Enter or adjust the demonstrated value, content, route, or media option. | The product updates to the content or call configured. | content or call configured | `media/motion.mp4 @ 00:24.7` |
| 5 | Review the intermediate state and invoke the visible confirmation or start control. | The product shows the confirmation or active state. | confirmation or active state | `media/motion.mp4 @ 00:32.7` |
| 6 | Inspect the resulting saved, active, or completed product state. | The recording ends with the visible communication result. | visible communication result | `media/motion.mp4 @ 00:40.6` |
...
- **Timing class:** short product demonstration, 44.167 seconds and 1325 decoded video frames.
...
| Item | Value |
|---|---|
| Source page | https://www.youtube.com/watch?v=_9hK8Wj42Cs |
| Product page | https://play.google.com/store/apps/details?id=com.discord |
| Publisher | MyTechGuy |
| Capture method | Real Android product screen recording published by MyTechGuy, archived through a self-hosted Cobalt transport; publisher environment is not disclosed; no synthesized or interpolated motion. |
| Captured at | 2026-08-16T23:00:00Z |
| Motion metadata | 640×360; 44.167s; 1325 frames; 139775 bytes |
| Motion SHA-256 | `6eab6e655b39dce6e68502d3aa9019db0448d8bbb78844d27c4034933201833d` |
