# 18. Wise — observed Android product reference

**Product:** [Wise](https://play.google.com/store/apps/details?id=com.transferwise.android)  
**Motion source:** [How To Pay With a Digital Card | Wise](https://www.youtube.com/watch?v=cBwX6AIze8Y)  
**Upstream owner/publisher:** OneClickLater  
**Evidence status:** complete  
**Captured:** 2026-08-16T23:00:00Z  

<video src="media/motion.mp4" controls width="640"></video>

The local MP4 is authentic recorded product motion, not an animation synthesized from catalog stills. Real Android product screen recording published by OneClickLater, archived through a self-hosted Cobalt transport; publisher environment is not disclosed; no synthesized or interpolated motion.

## Three retained states

| State | Local evidence | Relationship |
|---|---|---|
| Entry | ![Entry state](media/state-01-entry.jpg) | Frame from `media/motion.mp4` at 00:08.1 |
| Decision | ![Decision state](media/state-02-decision.jpg) | Frame from `media/motion.mp4` at 00:25.8 |
| Success | ![Success state](media/state-03-success.jpg) | Frame from `media/motion.mp4` at 00:43.5 |
...
|---:|---|---|---|---|
| 1 | Open the product surface shown in the retained recording. | The interface presents the account overview. | account overview | `media/motion.mp4 @ 00:01.0` |
| 2 | Choose the visible primary item, destination, or creation action. | The interface advances to the financial action selected. | financial action selected | `media/motion.mp4 @ 00:09.1` |
| 3 | Move into the focused task surface and select the demonstrated control. | The focused control reveals the destination or instrument selected. | destination or instrument selected | `media/motion.mp4 @ 00:18.2` |
| 4 | Enter or adjust the demonstrated value, content, route, or media option. | The product updates to the amount or option entered. | amount or option entered | `media/motion.mp4 @ 00:28.3` |
| 5 | Review the intermediate state and invoke the visible confirmation or start control. | The product shows the review boundary. | review boundary | `media/motion.mp4 @ 00:37.4` |
| 6 | Inspect the resulting saved, active, or completed product state. | The recording ends with the confirmed result. | confirmed result | `media/motion.mp4 @ 00:46.5` |
...
- **Timing class:** short product demonstration, 50.542 seconds and 1213 decoded video frames.
...
| Item | Value |
|---|---|
| Source page | https://www.youtube.com/watch?v=cBwX6AIze8Y |
| Product page | https://play.google.com/store/apps/details?id=com.transferwise.android |
| Publisher | OneClickLater |
| Capture method | Real Android product screen recording published by OneClickLater, archived through a self-hosted Cobalt transport; publisher environment is not disclosed; no synthesized or interpolated motion. |
| Captured at | 2026-08-16T23:00:00Z |
| Motion metadata | 640×360; 50.542s; 1213 frames; 694927 bytes |
| Motion SHA-256 | `6ac5affb10a200544bccf80901772e881c8e1a8d5b39fa1c278e9aeaf2ecafca` |
