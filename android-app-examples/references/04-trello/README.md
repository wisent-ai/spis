# 04. Trello — observed Android product reference

**Product:** [Trello](https://play.google.com/store/apps/details?id=com.trello)  
**Motion source:** [How to set up the Trello widget on Android](https://www.youtube.com/watch?v=MKvh0bhrWwg)  
**Upstream owner/publisher:** Trello  
**Evidence status:** complete  
**Captured:** 2026-08-16T23:00:00Z  

<video src="media/motion.mp4" controls width="640"></video>

The local MP4 is authentic recorded product motion, not an animation synthesized from catalog stills. Product-owner or official documentation recording published by Trello, archived through a self-hosted Cobalt transport; no synthesized or interpolated motion.
...
|---:|---|---|---|---|
| 1 | Open the product surface shown in the retained recording. | The interface presents the landing surface. | landing surface | `media/motion.mp4 @ 00:00.6` |
| 2 | Choose the visible primary item, destination, or creation action. | The interface advances to the item or tool selected. | item or tool selected | `media/motion.mp4 @ 00:05.4` |
| 3 | Move into the focused task surface and select the demonstrated control. | The focused control reveals the creation or editing surface. | creation or editing surface | `media/motion.mp4 @ 00:10.8` |
| 4 | Enter or adjust the demonstrated value, content, route, or media option. | The product updates to the configured content. | configured content | `media/motion.mp4 @ 00:16.8` |
| 5 | Review the intermediate state and invoke the visible confirmation or start control. | The product shows the review or confirmation. | review or confirmation | `media/motion.mp4 @ 00:22.2` |
| 6 | Inspect the resulting saved, active, or completed product state. | The recording ends with the saved result. | saved result | `media/motion.mp4 @ 00:27.6` |
...
- **Timing class:** short product demonstration, 30.000 seconds and 300 decoded video frames.
...
| Item | Value |
|---|---|
| Source page | https://www.youtube.com/watch?v=MKvh0bhrWwg |
| Product page | https://play.google.com/store/apps/details?id=com.trello |
| Publisher | Trello |
| Capture method | Product-owner or official documentation recording published by Trello, archived through a self-hosted Cobalt transport; no synthesized or interpolated motion. |
| Captured at | 2026-08-16T23:00:00Z |
| Motion metadata | 640×360; 30.000s; 300 frames; 490345 bytes |
| Motion SHA-256 | `63a41e702353f882e44d7db0553eab7324ec188e62b7f79dd0e8ddcd086f36c8` |
