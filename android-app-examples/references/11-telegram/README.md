# 11. Telegram — observed Android product reference

**Product:** [Telegram](https://play.google.com/store/apps/details?id=org.telegram.messenger)  
**Motion source:** [Massive Redesign — Telegram for Android](https://telegram.org/file/400780400904/4/DWawl_4TMA4.10093975.mp4/37c041443749d21609)  
**Upstream owner/publisher:** Telegram  
**Evidence status:** complete  
**Captured:** 2026-08-16T23:00:00Z  

<video src="media/motion.mp4" controls width="640"></video>

The local MP4 is authentic recorded product motion, not an animation synthesized from catalog stills. Official Telegram documentation MP4 downloaded byte-for-byte; no synthesized or interpolated motion.

## Three retained states

| State | Local evidence | Relationship |
|---|---|---|
| Entry | ![Entry state](media/state-01-entry.jpg) | Frame from `media/motion.mp4` at 00:02.6 |
| Decision | ![Decision state](media/state-02-decision.jpg) | Frame from `media/motion.mp4` at 00:08.2 |
| Success | ![Success state](media/state-03-success.jpg) | Frame from `media/motion.mp4` at 00:13.8 |
...
|---:|---|---|---|---|
| 1 | Open the product surface shown in the retained recording. | The interface presents the app entry. | app entry | `media/motion.mp4 @ 00:00.3` |
| 2 | Choose the visible primary item, destination, or creation action. | The interface advances to the recipient or channel selected. | recipient or channel selected | `media/motion.mp4 @ 00:02.9` |
| 3 | Move into the focused task surface and select the demonstrated control. | The focused control reveals the communication controls. | communication controls | `media/motion.mp4 @ 00:05.8` |
| 4 | Enter or adjust the demonstrated value, content, route, or media option. | The product updates to the content or call configured. | content or call configured | `media/motion.mp4 @ 00:09.0` |
| 5 | Review the intermediate state and invoke the visible confirmation or start control. | The product shows the confirmation or active state. | confirmation or active state | `media/motion.mp4 @ 00:11.8` |
| 6 | Inspect the resulting saved, active, or completed product state. | The recording ends with the visible communication result. | visible communication result | `media/motion.mp4 @ 00:14.7` |
...
- **Timing class:** short product demonstration, 16.000 seconds and 960 decoded video frames.
...
| Item | Value |
|---|---|
| Source page | https://telegram.org/file/400780400904/4/DWawl_4TMA4.10093975.mp4/37c041443749d21609 |
| Product page | https://play.google.com/store/apps/details?id=org.telegram.messenger |
| Publisher | Telegram |
| Capture method | Official Telegram documentation MP4 downloaded byte-for-byte; no synthesized or interpolated motion. |
| Captured at | 2026-08-16T23:00:00Z |
| Motion metadata | 1920×1920; 16.000s; 960 frames; 10093975 bytes |
| Motion SHA-256 | `352a84812c37d21aeff6b584f0c21235749d46deeedf60a1844238fdf12737f8` |
