# 12. Slack — observed Android product reference

**Product:** [Slack](https://play.google.com/store/apps/details?id=com.Slack)  
**Motion source:** [How to use Slack: Your quick start guide](https://www.youtube.com/watch?v=FTuOS8E1LZk)  
**Upstream owner/publisher:** Slack  
**Evidence status:** complete  
**Captured:** 2026-08-16T23:00:00Z  

<video src="media/motion.mp4" controls width="640"></video>

The local MP4 is authentic recorded product motion, not an animation synthesized from catalog stills. Product-owner or official documentation recording published by Slack, archived through a self-hosted Cobalt transport; no synthesized or interpolated motion.
...
| Decision | ![Decision state](media/state-02-decision.jpg) | Frame from `media/motion.mp4` at 00:23.0 |
| Success | ![Success state](media/state-03-success.jpg) | Frame from `media/motion.mp4` at 00:38.7 |
...
| 2 | Choose the visible primary item, destination, or creation action. | The interface advances to the recipient or channel selected. | recipient or channel selected | `media/motion.mp4 @ 00:08.1` |
| 3 | Move into the focused task surface and select the demonstrated control. | The focused control reveals the communication controls. | communication controls | `media/motion.mp4 @ 00:16.2` |
| 4 | Enter or adjust the demonstrated value, content, route, or media option. | The product updates to the content or call configured. | content or call configured | `media/motion.mp4 @ 00:25.2` |
| 5 | Review the intermediate state and invoke the visible confirmation or start control. | The product shows the confirmation or active state. | confirmation or active state | `media/motion.mp4 @ 00:33.3` |
| 6 | Inspect the resulting saved, active, or completed product state. | The recording ends with the visible communication result. | visible communication result | `media/motion.mp4 @ 00:41.4` |
...
- **Timing class:** short product demonstration, 45.033 seconds and 1351 decoded video frames.
...
| Item | Value |
|---|---|
| Source page | https://www.youtube.com/watch?v=FTuOS8E1LZk |
| Product page | https://play.google.com/store/apps/details?id=com.Slack |
| Publisher | Slack |
| Capture method | Product-owner or official documentation recording published by Slack, archived through a self-hosted Cobalt transport; no synthesized or interpolated motion. |
| Captured at | 2026-08-16T23:00:00Z |
| Motion metadata | 640×360; 45.033s; 1351 frames; 1069318 bytes |
| Motion SHA-256 | `4a730b1d9f2e3aa0e2842b06e1d88bd7fc20faecbb363e1ebd39342d62349092` |
