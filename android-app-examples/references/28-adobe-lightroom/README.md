# 28. Adobe Lightroom — observed Android product reference

**Product:** [Adobe Lightroom](https://play.google.com/store/apps/details?id=com.adobe.lrmobile)  
**Motion source:** [How to Edit RAW Images using Adobe Lightroom Mobile on Android](https://www.youtube.com/watch?v=9vdI_mFP4n8)  
**Upstream owner/publisher:** Frozen In Frame  
**Evidence status:** complete  
**Captured:** 2026-08-16T23:00:00Z  

<video src="media/motion.mp4" controls width="640"></video>

The local MP4 is authentic recorded product motion, not an animation synthesized from catalog stills. Real Android product screen recording published by Frozen In Frame, archived from its YouTube source with the Pytubefix MWEB/TV client; publisher device/account environment is not disclosed; no synthesized or interpolated motion.
...
| Success | ![Success state](media/state-03-success.jpg) | Frame from `media/motion.mp4` at 02:34.9 |
...
|---:|---|---|---|---|
| 1 | Open the product surface shown in the retained recording. | The interface presents the project entry. | project entry | `media/motion.mp4 @ 00:03.6` |
| 2 | Choose the visible primary item, destination, or creation action. | The interface advances to the source selected. | source selected | `media/motion.mp4 @ 00:32.4` |
| 3 | Move into the focused task surface and select the demonstrated control. | The focused control reveals the editing surface. | editing surface | `media/motion.mp4 @ 01:04.8` |
| 4 | Enter or adjust the demonstrated value, content, route, or media option. | The product updates to the parameter or tool adjustment. | parameter or tool adjustment | `media/motion.mp4 @ 01:40.8` |
| 5 | Review the intermediate state and invoke the visible confirmation or start control. | The product shows the preview or review. | preview or review | `media/motion.mp4 @ 02:13.3` |
| 6 | Inspect the resulting saved, active, or completed product state. | The recording ends with the saved creative result. | saved creative result | `media/motion.mp4 @ 02:45.7` |
...
- **Timing class:** short product demonstration, 180.075 seconds and 3944 decoded video frames.
...
| Item | Value |
|---|---|
| Source page | https://www.youtube.com/watch?v=9vdI_mFP4n8 |
| Product page | https://play.google.com/store/apps/details?id=com.adobe.lrmobile |
| Publisher | Frozen In Frame |
| Capture method | Real Android product screen recording published by Frozen In Frame, archived from its YouTube source with the Pytubefix MWEB/TV client; publisher device/account environment is not disclosed; no synthesized or interpolated motion. |
| Captured at | 2026-08-16T23:00:00Z |
| Motion metadata | 636×360; 180.075s; 3944 frames; 2701894 bytes |
| Motion SHA-256 | `3c821d2261e3845bc19ef297349527c22e55d5d4b6d714f3d07e0472cf890c4c` |
