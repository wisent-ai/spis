# 27. Calm — observed Android product reference

**Product:** [Calm](https://play.google.com/store/apps/details?id=com.calm.android)  
**Motion source:** [Calm App Store Trailer](https://www.youtube.com/watch?v=ldKhvNv-pDk)  
**Upstream owner/publisher:** Calm  
**Evidence status:** complete  
**Captured:** 2026-08-16T23:00:00Z  

<video src="media/motion.mp4" controls width="640"></video>

The local MP4 is authentic recorded product motion, not an animation synthesized from catalog stills. Product-owner or official documentation recording published by Calm, archived through a self-hosted Cobalt transport; no synthesized or interpolated motion.
...
**Actor:** a person seeking a guided wellness session  
**Goal:** reach a playable or completed wellness state  
**Prerequisites:** Android device; audio available

| # | Observed action | System response | State | Evidence |
|---:|---|---|---|---|
| 1 | Open the product surface shown in the retained recording. | The interface presents the content discovery. | content discovery | `media/motion.mp4 @ 00:00.6` |
| 2 | Choose the visible primary item, destination, or creation action. | The interface advances to the intent selected. | intent selected | `media/motion.mp4 @ 00:05.4` |
| 3 | Move into the focused task surface and select the demonstrated control. | The focused control reveals the session selected. | session selected | `media/motion.mp4 @ 00:10.8` |
| 4 | Enter or adjust the demonstrated value, content, route, or media option. | The product updates to the playback configured. | playback configured | `media/motion.mp4 @ 00:16.8` |
| 5 | Review the intermediate state and invoke the visible confirmation or start control. | The product shows the active session. | active session | `media/motion.mp4 @ 00:22.2` |
| 6 | Inspect the resulting saved, active, or completed product state. | The recording ends with the session result. | session result | `media/motion.mp4 @ 00:27.6` |
...
- **Start/end:** `content discovery` → `session result`.
...
- **Timing class:** short product demonstration, 30.000 seconds and 900 decoded video frames.
...
| Item | Value |
|---|---|
| Source page | https://www.youtube.com/watch?v=ldKhvNv-pDk |
| Product page | https://play.google.com/store/apps/details?id=com.calm.android |
| Publisher | Calm |
| Capture method | Product-owner or official documentation recording published by Calm, archived through a self-hosted Cobalt transport; no synthesized or interpolated motion. |
| Captured at | 2026-08-16T23:00:00Z |
| Motion metadata | 640×360; 30.000s; 900 frames; 583747 bytes |
| Motion SHA-256 | `ced24f8b7ff583ac2c16b8f1c3cfc2b81473200d19dd409c5e6b2e98ef5c9356` |
