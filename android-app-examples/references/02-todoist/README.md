# 02. Todoist — observed Android product reference

**Product:** [Todoist](https://play.google.com/store/apps/details?id=com.todoist)  
**Motion source:** [How to Add Task in Todoist — App Tutorial for Beginners](https://www.youtube.com/watch?v=PvzwWq2bdhA)  
**Upstream owner/publisher:** TutorialStream  
**Evidence status:** complete  
**Captured:** 2026-08-16T23:00:00Z  

<video src="media/motion.mp4" controls width="640"></video>

The local MP4 is authentic recorded product motion, not an animation synthesized from catalog stills. Real Android product screen recording published by TutorialStream, archived from its YouTube source with the Pytubefix MWEB/TV client; publisher device/account environment is not disclosed; no synthesized or interpolated motion.

## Three retained states

| State | Local evidence | Relationship |
|---|---|---|
| Entry | ![Entry state](media/state-01-entry.jpg) | Frame from `media/motion.mp4` at 00:22.3 |
| Decision | ![Decision state](media/state-02-decision.jpg) | Frame from `media/motion.mp4` at 01:11.1 |
| Success | ![Success state](media/state-03-success.jpg) | Frame from `media/motion.mp4` at 01:59.9 |
...
|---:|---|---|---|---|
| 1 | Open the product surface shown in the retained recording. | The interface presents the landing surface. | landing surface | `media/motion.mp4 @ 00:02.8` |
| 2 | Choose the visible primary item, destination, or creation action. | The interface advances to the item or tool selected. | item or tool selected | `media/motion.mp4 @ 00:25.1` |
| 3 | Move into the focused task surface and select the demonstrated control. | The focused control reveals the creation or editing surface. | creation or editing surface | `media/motion.mp4 @ 00:50.2` |
| 4 | Enter or adjust the demonstrated value, content, route, or media option. | The product updates to the configured content. | configured content | `media/motion.mp4 @ 01:18.0` |
| 5 | Review the intermediate state and invoke the visible confirmation or start control. | The product shows the review or confirmation. | review or confirmation | `media/motion.mp4 @ 01:43.1` |
| 6 | Inspect the resulting saved, active, or completed product state. | The recording ends with the saved result. | saved result | `media/motion.mp4 @ 02:08.2` |
...
- **Timing class:** short product demonstration, 139.367 seconds and 4181 decoded video frames.
...
| Item | Value |
|---|---|
| Source page | https://www.youtube.com/watch?v=PvzwWq2bdhA |
| Product page | https://play.google.com/store/apps/details?id=com.todoist |
| Publisher | TutorialStream |
| Capture method | Real Android product screen recording published by TutorialStream, archived from its YouTube source with the Pytubefix MWEB/TV client; publisher device/account environment is not disclosed; no synthesized or interpolated motion. |
| Captured at | 2026-08-16T23:00:00Z |
| Motion metadata | 640×360; 139.367s; 4181 frames; 1594385 bytes |
| Motion SHA-256 | `d96a11adf675724f21632ced633ebda1e610e4c3d707d35a8b75e21c136f5463` |
