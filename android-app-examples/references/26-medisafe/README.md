# 26. Medisafe — observed Android product reference

**Product:** [Medisafe](https://play.google.com/store/apps/details?id=com.medisafe.android.client)  
**Motion source:** [Getting Started with Medisafe — Android Help](https://www.youtube.com/watch?v=PA3E3l6bQj8)  
**Upstream owner/publisher:** Medisafe  
**Evidence status:** complete  
**Captured:** 2026-08-16T23:00:00Z  

<video src="media/motion.mp4" controls width="640"></video>

The local MP4 is authentic recorded product motion, not an animation synthesized from catalog stills. Product-owner or official documentation recording published by Medisafe, archived through a self-hosted Cobalt transport; no synthesized or interpolated motion.

## Three retained states

| State | Local evidence | Relationship |
|---|---|---|
| Entry | ![Entry state](media/state-01-entry.jpg) | Frame from `media/motion.mp4` at 00:07.0 |
| Decision | ![Decision state](media/state-02-decision.jpg) | Frame from `media/motion.mp4` at 00:22.4 |
| Success | ![Success state](media/state-03-success.jpg) | Frame from `media/motion.mp4` at 00:37.8 |
...
| 2 | Choose the visible primary item, destination, or creation action. | The interface advances to the metric or activity selected. | metric or activity selected | `media/motion.mp4 @ 00:07.9` |
| 3 | Move into the focused task surface and select the demonstrated control. | The focused control reveals the entry controls. | entry controls | `media/motion.mp4 @ 00:15.8` |
| 4 | Enter or adjust the demonstrated value, content, route, or media option. | The product updates to the value or goal configured. | value or goal configured | `media/motion.mp4 @ 00:24.6` |
| 5 | Review the intermediate state and invoke the visible confirmation or start control. | The product shows the save boundary. | save boundary | `media/motion.mp4 @ 00:32.6` |
| 6 | Inspect the resulting saved, active, or completed product state. | The recording ends with the updated health result. | updated health result | `media/motion.mp4 @ 00:40.5` |
...
- **Timing class:** short product demonstration, 44.000 seconds and 1056 decoded video frames.
...
| Item | Value |
|---|---|
| Source page | https://www.youtube.com/watch?v=PA3E3l6bQj8 |
| Product page | https://play.google.com/store/apps/details?id=com.medisafe.android.client |
| Publisher | Medisafe |
| Capture method | Product-owner or official documentation recording published by Medisafe, archived through a self-hosted Cobalt transport; no synthesized or interpolated motion. |
| Captured at | 2026-08-16T23:00:00Z |
| Motion metadata | 640×360; 44.000s; 1056 frames; 676158 bytes |
| Motion SHA-256 | `5c4846d28630463bc4c5f0910b271d4f05e6867706fde432926c80f455e14992` |
