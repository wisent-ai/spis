# 05. Microsoft 365 Copilot — observed Android product reference

**Product:** [Microsoft 365 Copilot](https://play.google.com/store/apps/details?id=com.microsoft.office.officehubrow)  
**Motion source:** [How to Download & Install Microsoft 365 App on Android](https://www.youtube.com/watch?v=Vr-LA3lhelo)  
**Upstream owner/publisher:** ClickFix  
**Evidence status:** complete  
**Captured:** 2026-08-16T23:00:00Z  

<video src="media/motion.mp4" controls width="640"></video>

The local MP4 is authentic recorded product motion, not an animation synthesized from catalog stills. Real Android product screen recording published by ClickFix, archived from its YouTube source with the Pytubefix MWEB/TV client; publisher device/account environment is not disclosed; no synthesized or interpolated motion.

## Three retained states

| State | Local evidence | Relationship |
|---|---|---|
| Entry | ![Entry state](media/state-01-entry.jpg) | Frame from `media/motion.mp4` at 00:12.9 |
| Decision | ![Decision state](media/state-02-decision.jpg) | Frame from `media/motion.mp4` at 00:41.2 |
| Success | ![Success state](media/state-03-success.jpg) | Frame from `media/motion.mp4` at 01:09.4 |
...
|---:|---|---|---|---|
| 1 | Open the product surface shown in the retained recording. | The interface presents the landing surface. | landing surface | `media/motion.mp4 @ 00:01.6` |
| 2 | Choose the visible primary item, destination, or creation action. | The interface advances to the item or tool selected. | item or tool selected | `media/motion.mp4 @ 00:14.5` |
| 3 | Move into the focused task surface and select the demonstrated control. | The focused control reveals the creation or editing surface. | creation or editing surface | `media/motion.mp4 @ 00:29.1` |
| 4 | Enter or adjust the demonstrated value, content, route, or media option. | The product updates to the configured content. | configured content | `media/motion.mp4 @ 00:45.2` |
| 5 | Review the intermediate state and invoke the visible confirmation or start control. | The product shows the review or confirmation. | review or confirmation | `media/motion.mp4 @ 00:59.7` |
| 6 | Inspect the resulting saved, active, or completed product state. | The recording ends with the saved result. | saved result | `media/motion.mp4 @ 01:14.2` |
...
- **Timing class:** short product demonstration, 80.700 seconds and 2421 decoded video frames.
...
| Item | Value |
|---|---|
| Source page | https://www.youtube.com/watch?v=Vr-LA3lhelo |
| Product page | https://play.google.com/store/apps/details?id=com.microsoft.office.officehubrow |
| Publisher | ClickFix |
| Capture method | Real Android product screen recording published by ClickFix, archived from its YouTube source with the Pytubefix MWEB/TV client; publisher device/account environment is not disclosed; no synthesized or interpolated motion. |
| Captured at | 2026-08-16T23:00:00Z |
| Motion metadata | 640×360; 80.700s; 2421 frames; 790038 bytes |
| Motion SHA-256 | `be685cb51e9a868c24c8fe5eb2f396f6f146b490c5b5acf9619de37da4a2a4a2` |
