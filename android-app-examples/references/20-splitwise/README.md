# 20. Splitwise — observed Android product reference

**Product:** [Splitwise](https://play.google.com/store/apps/details?id=com.Splitwise.SplitwiseMobile)  
**Motion source:** [How to Split Travel Costs With Friends using Splitwise](https://www.youtube.com/watch?v=jhwRh2z_mr8)  
**Upstream owner/publisher:** HowTube  
**Evidence status:** complete  
**Captured:** 2026-08-16T23:00:00Z  

<video src="media/motion.mp4" controls width="640"></video>

The local MP4 is authentic recorded product motion, not an animation synthesized from catalog stills. Real Android product screen recording published by HowTube, archived from its YouTube source with the Pytubefix MWEB/TV client; publisher device/account environment is not disclosed; no synthesized or interpolated motion.
...
| 6 | Inspect the resulting saved, active, or completed product state. | The recording ends with the confirmed result. | confirmed result | `media/motion.mp4 @ 02:45.6` |
...
- **Timing class:** short product demonstration, 180.040 seconds and 4501 decoded video frames.
...
| Item | Value |
|---|---|
| Source page | https://www.youtube.com/watch?v=jhwRh2z_mr8 |
| Product page | https://play.google.com/store/apps/details?id=com.Splitwise.SplitwiseMobile |
| Publisher | HowTube |
| Capture method | Real Android product screen recording published by HowTube, archived from its YouTube source with the Pytubefix MWEB/TV client; publisher device/account environment is not disclosed; no synthesized or interpolated motion. |
| Captured at | 2026-08-16T23:00:00Z |
| Motion metadata | 640×360; 180.040s; 4501 frames; 3456632 bytes |
| Motion SHA-256 | `8783418bb8234c27a2296ca66c8d23ff0bc789bf877d89816aa4834236da40ee` |
