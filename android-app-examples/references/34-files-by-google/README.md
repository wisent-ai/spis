# 34. Files by Google — observed Android product reference

**Product:** [Files by Google](https://play.google.com/store/apps/details?id=com.google.android.apps.nbu.files)  
**Motion source:** [Files by Google: Free up space on your phone](https://www.youtube.com/watch?v=T3bGJcJUQkg)  
...
|---|---|---|
| Entry | ![Entry state](media/state-01-entry.jpg) | Frame from `media/motion.mp4` at 00:06.0 |
| Decision | ![Decision state](media/state-02-decision.jpg) | Frame from `media/motion.mp4` at 00:19.1 |
| Success | ![Success state](media/state-03-success.jpg) | Frame from `media/motion.mp4` at 00:32.1 |
...
|---:|---|---|---|---|
| 1 | Open the product surface shown in the retained recording. | The interface presents the utility landing. | utility landing | `media/motion.mp4 @ 00:00.7` |
| 2 | Choose the visible primary item, destination, or creation action. | The interface advances to the item or mode selected. | item or mode selected | `media/motion.mp4 @ 00:06.7` |
| 3 | Move into the focused task surface and select the demonstrated control. | The focused control reveals the action controls. | action controls | `media/motion.mp4 @ 00:13.5` |
| 4 | Enter or adjust the demonstrated value, content, route, or media option. | The product updates to the option configured. | option configured | `media/motion.mp4 @ 00:20.9` |
| 5 | Review the intermediate state and invoke the visible confirmation or start control. | The product shows the confirmation boundary. | confirmation boundary | `media/motion.mp4 @ 00:27.7` |
| 6 | Inspect the resulting saved, active, or completed product state. | The recording ends with the visible utility result. | visible utility result | `media/motion.mp4 @ 00:34.4` |
...
- **Timing class:** short product demonstration, 37.371 seconds and 896 decoded video frames.
...
| Item | Value |
|---|---|
| Source page | https://www.youtube.com/watch?v=T3bGJcJUQkg |
| Product page | https://play.google.com/store/apps/details?id=com.google.android.apps.nbu.files |
| Publisher | Google |
...
| Motion metadata | 640×360; 37.371s; 896 frames; 946173 bytes |
| Motion SHA-256 | `2dc8653cc433e1a71d839ccad17feb2408fca1b16fb3aeccf36c610032672ed3` |
