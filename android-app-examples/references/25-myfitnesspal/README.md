# 25. MyFitnessPal — observed Android product reference

**Product:** [MyFitnessPal](https://play.google.com/store/apps/details?id=com.myfitnesspal.android)  
**Motion source:** [Meal Scan: Log Meals Like Magic With Your Camera](https://www.youtube.com/watch?v=wzVIiOrmZJ4)  
**Upstream owner/publisher:** MyFitnessPal  
**Evidence status:** complete  
**Captured:** 2026-08-16T23:00:00Z  

<video src="media/motion.mp4" controls width="640"></video>

The local MP4 is authentic recorded product motion, not an animation synthesized from catalog stills. Product-owner or official documentation recording published by MyFitnessPal, archived through a self-hosted Cobalt transport; no synthesized or interpolated motion.
...
|---:|---|---|---|---|
| 1 | Open the product surface shown in the retained recording. | The interface presents the health overview. | health overview | `media/motion.mp4 @ 00:00.6` |
| 2 | Choose the visible primary item, destination, or creation action. | The interface advances to the metric or activity selected. | metric or activity selected | `media/motion.mp4 @ 00:05.4` |
| 3 | Move into the focused task surface and select the demonstrated control. | The focused control reveals the entry controls. | entry controls | `media/motion.mp4 @ 00:10.8` |
| 4 | Enter or adjust the demonstrated value, content, route, or media option. | The product updates to the value or goal configured. | value or goal configured | `media/motion.mp4 @ 00:16.8` |
| 5 | Review the intermediate state and invoke the visible confirmation or start control. | The product shows the save boundary. | save boundary | `media/motion.mp4 @ 00:22.2` |
| 6 | Inspect the resulting saved, active, or completed product state. | The recording ends with the updated health result. | updated health result | `media/motion.mp4 @ 00:27.6` |
...
| Item | Value |
|---|---|
| Source page | https://www.youtube.com/watch?v=wzVIiOrmZJ4 |
| Product page | https://play.google.com/store/apps/details?id=com.myfitnesspal.android |
| Publisher | MyFitnessPal |
| Capture method | Product-owner or official documentation recording published by MyFitnessPal, archived through a self-hosted Cobalt transport; no synthesized or interpolated motion. |
| Captured at | 2026-08-16T23:00:00Z |
| Motion metadata | 640×360; 30.030s; 720 frames; 399811 bytes |
| Motion SHA-256 | `4992c8a8a412f86559615219429e8acd07fd51d985b662c9b67cfd1cb6e1d722` |
