# 50. Termux — observed Android product reference

**Product:** [Termux](https://github.com/termux/termux-app)  
**Motion source:** [How to Install Latest Version Termux App on Android](https://www.youtube.com/watch?v=1-tlv7Kn7P8)  
**Upstream owner/publisher:** Tech Fuse  
**Evidence status:** complete  
**Captured:** 2026-08-16T23:00:00Z  

<video src="media/motion.mp4" controls width="640"></video>

The local MP4 is authentic recorded product motion, not an animation synthesized from catalog stills. Real Android product screen recording published by Tech Fuse, archived through a self-hosted Cobalt transport; publisher environment is not disclosed; no synthesized or interpolated motion.
...
| Decision | ![Decision state](media/state-02-decision.jpg) | Frame from `media/motion.mp4` at 00:22.8 |
| Success | ![Success state](media/state-03-success.jpg) | Frame from `media/motion.mp4` at 00:38.4 |
...
|---:|---|---|---|---|
| 1 | Open the product surface shown in the retained recording. | The interface presents the tool entry. | tool entry | `media/motion.mp4 @ 00:00.9` |
| 2 | Choose the visible primary item, destination, or creation action. | The interface advances to the working context selected. | working context selected | `media/motion.mp4 @ 00:08.0` |
| 3 | Move into the focused task surface and select the demonstrated control. | The focused control reveals the command or action entered. | command or action entered | `media/motion.mp4 @ 00:16.1` |
| 4 | Enter or adjust the demonstrated value, content, route, or media option. | The product updates to the processing feedback. | processing feedback | `media/motion.mp4 @ 00:25.0` |
| 5 | Review the intermediate state and invoke the visible confirmation or start control. | The product shows the result inspected. | result inspected | `media/motion.mp4 @ 00:33.0` |
| 6 | Inspect the resulting saved, active, or completed product state. | The recording ends with the successful developer result. | successful developer result | `media/motion.mp4 @ 00:41.1` |
...
- **Timing class:** short product demonstration, 44.633 seconds and 1339 decoded video frames.
...
| Item | Value |
|---|---|
| Source page | https://www.youtube.com/watch?v=1-tlv7Kn7P8 |
| Product page | https://github.com/termux/termux-app |
| Publisher | Tech Fuse |
| Capture method | Real Android product screen recording published by Tech Fuse, archived through a self-hosted Cobalt transport; publisher environment is not disclosed; no synthesized or interpolated motion. |
| Captured at | 2026-08-16T23:00:00Z |
| Motion metadata | 640×360; 44.633s; 1339 frames; 748530 bytes |
| Motion SHA-256 | `6b7f33c0b693d62deeeafe772472b5d6f961a527d79700ab88ade27e54a7c989` |
