# 09. WhatsApp Messenger — observed Android product reference

**Product:** [WhatsApp Messenger](https://play.google.com/store/apps/details?id=com.whatsapp)  
**Motion source:** [How to Make Video Calls | WhatsApp](https://www.youtube.com/watch?v=QkvlYq9TazU)  
**Upstream owner/publisher:** WhatsApp  
**Evidence status:** complete  
**Captured:** 2026-08-16T23:00:00Z  

<video src="media/motion.mp4" controls width="640"></video>

The local MP4 is authentic recorded product motion, not an animation synthesized from catalog stills. Product-owner or official documentation recording published by WhatsApp, archived through a self-hosted Cobalt transport; no synthesized or interpolated motion.

## Three retained states

| State | Local evidence | Relationship |
|---|---|---|
| Entry | ![Entry state](media/state-01-entry.jpg) | Frame from `media/motion.mp4` at 00:02.8 |
| Decision | ![Decision state](media/state-02-decision.jpg) | Frame from `media/motion.mp4` at 00:09.1 |
| Success | ![Success state](media/state-03-success.jpg) | Frame from `media/motion.mp4` at 00:15.3 |
...
|---:|---|---|---|---|
| 1 | Open the product surface shown in the retained recording. | The interface presents the app entry. | app entry | `media/motion.mp4 @ 00:00.4` |
| 2 | Choose the visible primary item, destination, or creation action. | The interface advances to the recipient or channel selected. | recipient or channel selected | `media/motion.mp4 @ 00:03.2` |
| 3 | Move into the focused task surface and select the demonstrated control. | The focused control reveals the communication controls. | communication controls | `media/motion.mp4 @ 00:06.4` |
| 4 | Enter or adjust the demonstrated value, content, route, or media option. | The product updates to the content or call configured. | content or call configured | `media/motion.mp4 @ 00:10.0` |
| 5 | Review the intermediate state and invoke the visible confirmation or start control. | The product shows the confirmation or active state. | confirmation or active state | `media/motion.mp4 @ 00:13.2` |
| 6 | Inspect the resulting saved, active, or completed product state. | The recording ends with the visible communication result. | visible communication result | `media/motion.mp4 @ 00:16.4` |
...
- **Timing class:** short product demonstration, 17.809 seconds and 427 decoded video frames.
...
| Item | Value |
|---|---|
| Source page | https://www.youtube.com/watch?v=QkvlYq9TazU |
| Product page | https://play.google.com/store/apps/details?id=com.whatsapp |
| Publisher | WhatsApp |
| Capture method | Product-owner or official documentation recording published by WhatsApp, archived through a self-hosted Cobalt transport; no synthesized or interpolated motion. |
| Captured at | 2026-08-16T23:00:00Z |
| Motion metadata | 640×360; 17.809s; 427 frames; 261446 bytes |
| Motion SHA-256 | `8a17839020582ac3ec4ba8d7b80aca7a2d033a3cc880474bd0a61e06548604a3` |
