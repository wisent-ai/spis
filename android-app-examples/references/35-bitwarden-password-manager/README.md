# 35. Bitwarden Password Manager — observed Android product reference

**Product:** [Bitwarden Password Manager](https://play.google.com/store/apps/details?id=com.x8bit.bitwarden)  
**Motion source:** [Import your passwords with the mobile app](https://www.youtube.com/watch?v=Vu4PMZk5uys)  
**Upstream owner/publisher:** Bitwarden  
**Evidence status:** complete  
**Captured:** 2026-08-16T23:00:00Z  

<video src="media/motion.mp4" controls width="640"></video>

The local MP4 is authentic recorded product motion, not an animation synthesized from catalog stills. Product-owner or official documentation recording published by Bitwarden, archived through a self-hosted Cobalt transport; no synthesized or interpolated motion.

## Three retained states

| State | Local evidence | Relationship |
|---|---|---|
| Entry | ![Entry state](media/state-01-entry.jpg) | Frame from `media/motion.mp4` at 00:09.7 |
| Decision | ![Decision state](media/state-02-decision.jpg) | Frame from `media/motion.mp4` at 00:31.0 |
| Success | ![Success state](media/state-03-success.jpg) | Frame from `media/motion.mp4` at 00:52.3 |
...
|---:|---|---|---|---|
| 1 | Open the product surface shown in the retained recording. | The interface presents the utility landing. | utility landing | `media/motion.mp4 @ 00:01.2` |
| 2 | Choose the visible primary item, destination, or creation action. | The interface advances to the item or mode selected. | item or mode selected | `media/motion.mp4 @ 00:11.0` |
| 3 | Move into the focused task surface and select the demonstrated control. | The focused control reveals the action controls. | action controls | `media/motion.mp4 @ 00:21.9` |
| 4 | Enter or adjust the demonstrated value, content, route, or media option. | The product updates to the option configured. | option configured | `media/motion.mp4 @ 00:34.1` |
| 5 | Review the intermediate state and invoke the visible confirmation or start control. | The product shows the confirmation boundary. | confirmation boundary | `media/motion.mp4 @ 00:45.0` |
| 6 | Inspect the resulting saved, active, or completed product state. | The recording ends with the visible utility result. | visible utility result | `media/motion.mp4 @ 00:56.0` |
...
- **Timing class:** short product demonstration, 60.840 seconds and 1521 decoded video frames.
...
| Item | Value |
|---|---|
| Source page | https://www.youtube.com/watch?v=Vu4PMZk5uys |
| Product page | https://play.google.com/store/apps/details?id=com.x8bit.bitwarden |
| Publisher | Bitwarden |
| Capture method | Product-owner or official documentation recording published by Bitwarden, archived through a self-hosted Cobalt transport; no synthesized or interpolated motion. |
| Captured at | 2026-08-16T23:00:00Z |
| Motion metadata | 640×360; 60.840s; 1521 frames; 518958 bytes |
| Motion SHA-256 | `3dc80f13d95d4a59488113d43ef526c745fbf42b8b77abfdbcad60480a393922` |
