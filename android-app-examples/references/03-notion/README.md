# 03. Notion — observed Android product reference

**Product:** [Notion](https://play.google.com/store/apps/details?id=notion.id)  
**Motion source:** [How to create a new page on the Notion Mobile app](https://www.youtube.com/watch?v=-kr8br1K3cg)  
**Upstream owner/publisher:** MoneyPro-Tips  
**Evidence status:** complete  
**Captured:** 2026-08-16T23:00:00Z  

<video src="media/motion.mp4" controls width="640"></video>

The local MP4 is authentic recorded product motion, not an animation synthesized from catalog stills. Real Android product screen recording published by MoneyPro-Tips, archived from its YouTube source with the Pytubefix MWEB/TV client; publisher device/account environment is not disclosed; no synthesized or interpolated motion.
...
| Decision | ![Decision state](media/state-02-decision.jpg) | Frame from `media/motion.mp4` at 00:25.9 |
| Success | ![Success state](media/state-03-success.jpg) | Frame from `media/motion.mp4` at 00:43.7 |
...
|---:|---|---|---|---|
| 1 | Open the product surface shown in the retained recording. | The interface presents the landing surface. | landing surface | `media/motion.mp4 @ 00:01.0` |
| 2 | Choose the visible primary item, destination, or creation action. | The interface advances to the item or tool selected. | item or tool selected | `media/motion.mp4 @ 00:09.1` |
| 3 | Move into the focused task surface and select the demonstrated control. | The focused control reveals the creation or editing surface. | creation or editing surface | `media/motion.mp4 @ 00:18.3` |
| 4 | Enter or adjust the demonstrated value, content, route, or media option. | The product updates to the configured content. | configured content | `media/motion.mp4 @ 00:28.4` |
| 5 | Review the intermediate state and invoke the visible confirmation or start control. | The product shows the review or confirmation. | review or confirmation | `media/motion.mp4 @ 00:37.6` |
| 6 | Inspect the resulting saved, active, or completed product state. | The recording ends with the saved result. | saved result | `media/motion.mp4 @ 00:46.7` |
...
- **Timing class:** short product demonstration, 50.800 seconds and 1270 decoded video frames.
...
| Item | Value |
|---|---|
| Source page | https://www.youtube.com/watch?v=-kr8br1K3cg |
| Product page | https://play.google.com/store/apps/details?id=notion.id |
| Publisher | MoneyPro-Tips |
| Capture method | Real Android product screen recording published by MoneyPro-Tips, archived from its YouTube source with the Pytubefix MWEB/TV client; publisher device/account environment is not disclosed; no synthesized or interpolated motion. |
| Captured at | 2026-08-16T23:00:00Z |
| Motion metadata | 640×360; 50.800s; 1270 frames; 110223 bytes |
| Motion SHA-256 | `92efaf9f5af0f47f6d16fb74c9c3cb050508089df00258755825f6599cb30f73` |
