# 10. Signal Private Messenger — observed Android product reference

**Product:** [Signal Private Messenger](https://play.google.com/store/apps/details?id=org.thoughtcrime.securesms)  
**Motion source:** [How to Sign Up on Signal (Account Setup Guide 2026)](https://www.youtube.com/watch?v=ErJLrYozqP8)  
**Upstream owner/publisher:** CardChronicles  
**Evidence status:** complete  
**Captured:** 2026-08-16T23:00:00Z  

<video src="media/motion.mp4" controls width="640"></video>

The local MP4 is authentic recorded product motion, not an animation synthesized from catalog stills. Real Android product screen recording published by CardChronicles, archived through a self-hosted Cobalt transport; publisher environment is not disclosed; no synthesized or interpolated motion.

## Three retained states

| State | Local evidence | Relationship |
|---|---|---|
| Entry | ![Entry state](media/state-01-entry.jpg) | Frame from `media/motion.mp4` at 00:06.7 |
| Decision | ![Decision state](media/state-02-decision.jpg) | Frame from `media/motion.mp4` at 00:21.4 |
| Success | ![Success state](media/state-03-success.jpg) | Frame from `media/motion.mp4` at 00:36.0 |

## First-success journey

**Actor:** a person communicating on Android  
**Goal:** reach a visible conversation or communication result  
**Prerequisites:** Android device; network access; contact, channel, or meeting context

| # | Observed action | System response | State | Evidence |
|---:|---|---|---|---|
| 1 | Open the product surface shown in the retained recording. | The interface presents the app entry. | app entry | `media/motion.mp4 @ 00:00.8` |
| 2 | Choose the visible primary item, destination, or creation action. | The interface advances to the recipient or channel selected. | recipient or channel selected | `media/motion.mp4 @ 00:07.5` |
| 3 | Move into the focused task surface and select the demonstrated control. | The focused control reveals the communication controls. | communication controls | `media/motion.mp4 @ 00:15.1` |
| 4 | Enter or adjust the demonstrated value, content, route, or media option. | The product updates to the content or call configured. | content or call configured | `media/motion.mp4 @ 00:23.5` |
| 5 | Review the intermediate state and invoke the visible confirmation or start control. | The product shows the confirmation or active state. | confirmation or active state | `media/motion.mp4 @ 00:31.0` |
| 6 | Inspect the resulting saved, active, or completed product state. | The recording ends with the visible communication result. | visible communication result | `media/motion.mp4 @ 00:38.5` |
...
- **Start/end:** `app entry` → `visible communication result`.
...
- **Timing class:** short product demonstration, 41.875 seconds and 1004 decoded video frames.
...
| Item | Value |
|---|---|
| Source page | https://www.youtube.com/watch?v=ErJLrYozqP8 |
| Product page | https://play.google.com/store/apps/details?id=org.thoughtcrime.securesms |
| Publisher | CardChronicles |
| Capture method | Real Android product screen recording published by CardChronicles, archived through a self-hosted Cobalt transport; publisher environment is not disclosed; no synthesized or interpolated motion. |
| Captured at | 2026-08-16T23:00:00Z |
| Motion metadata | 640×360; 41.875s; 1004 frames; 748413 bytes |
| Motion SHA-256 | `f2cff731d3bc6d9ae78ddd4940c31c5ebc6ef4cd9bda556d61ecaa70bc893446` |
