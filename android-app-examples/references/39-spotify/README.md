# 39. Spotify — observed Android product reference

**Product:** [Spotify](https://play.google.com/store/apps/details?id=com.spotify.music)  
**Motion source:** [How To Add Music To Spotify On Android](https://www.youtube.com/watch?v=yjKhpNQAX9U)  
**Upstream owner/publisher:** GuideRealm  
**Evidence status:** complete  
**Captured:** 2026-08-16T23:00:00Z  

<video src="media/motion.mp4" controls width="640"></video>

The local MP4 is authentic recorded product motion, not an animation synthesized from catalog stills. Real Android product screen recording published by GuideRealm, archived from its YouTube source with the Pytubefix MWEB/TV client; publisher device/account environment is not disclosed; no synthesized or interpolated motion.

## Three retained states

| State | Local evidence | Relationship |
|---|---|---|
| Entry | ![Entry state](media/state-01-entry.jpg) | Frame from `media/motion.mp4` at 00:13.1 |
| Decision | ![Decision state](media/state-02-decision.jpg) | Frame from `media/motion.mp4` at 00:41.9 |
| Success | ![Success state](media/state-03-success.jpg) | Frame from `media/motion.mp4` at 01:10.6 |
...
|---:|---|---|---|---|
| 1 | Open the product surface shown in the retained recording. | The interface presents the media home. | media home | `media/motion.mp4 @ 00:01.6` |
| 2 | Choose the visible primary item, destination, or creation action. | The interface advances to the title or library item selected. | title or library item selected | `media/motion.mp4 @ 00:14.8` |
| 3 | Move into the focused task surface and select the demonstrated control. | The focused control reveals the playback started. | playback started | `media/motion.mp4 @ 00:29.6` |
| 4 | Enter or adjust the demonstrated value, content, route, or media option. | The product updates to the playback controls. | playback controls | `media/motion.mp4 @ 00:46.0` |
| 5 | Review the intermediate state and invoke the visible confirmation or start control. | The product shows the secondary option changed. | secondary option changed | `media/motion.mp4 @ 01:00.8` |
| 6 | Inspect the resulting saved, active, or completed product state. | The recording ends with the stable media result. | stable media result | `media/motion.mp4 @ 01:15.6` |
...
- **Timing class:** short product demonstration, 82.149 seconds and 2462 decoded video frames.
...
| Item | Value |
|---|---|
| Source page | https://www.youtube.com/watch?v=yjKhpNQAX9U |
| Product page | https://play.google.com/store/apps/details?id=com.spotify.music |
| Publisher | GuideRealm |
| Capture method | Real Android product screen recording published by GuideRealm, archived from its YouTube source with the Pytubefix MWEB/TV client; publisher device/account environment is not disclosed; no synthesized or interpolated motion. |
| Captured at | 2026-08-16T23:00:00Z |
| Motion metadata | 640×360; 82.149s; 2462 frames; 3969160 bytes |
| Motion SHA-256 | `c9711e626c30d1ba78610150221145add683b4dd3ef543131cbb061d9b23c905` |
