# 33. Snapseed — observed Android product reference

**Product:** [Snapseed](https://play.google.com/store/apps/details?id=com.niksoftware.snapseed)  
**Motion source:** [Dramatic Black & White Photos — Snapseed Tutorial](https://www.youtube.com/watch?v=tvyBFC1j-f0)  
**Upstream owner/publisher:** Alessio La Ruffa  
**Evidence status:** complete  
**Captured:** 2026-08-16T23:00:00Z  

<video src="media/motion.mp4" controls width="640"></video>

The local MP4 is authentic recorded product motion, not an animation synthesized from catalog stills. Real Android product screen recording published by Alessio La Ruffa, archived through a self-hosted Cobalt transport; publisher environment is not disclosed; no synthesized or interpolated motion.

## Three retained states

| State | Local evidence | Relationship |
|---|---|---|
| Entry | ![Entry state](media/state-01-entry.jpg) | Frame from `media/motion.mp4` at 00:06.5 |
| Decision | ![Decision state](media/state-02-decision.jpg) | Frame from `media/motion.mp4` at 00:20.9 |
| Success | ![Success state](media/state-03-success.jpg) | Frame from `media/motion.mp4` at 00:35.2 |
...
|---:|---|---|---|---|
| 1 | Open the product surface shown in the retained recording. | The interface presents the project entry. | project entry | `media/motion.mp4 @ 00:00.8` |
| 2 | Choose the visible primary item, destination, or creation action. | The interface advances to the source selected. | source selected | `media/motion.mp4 @ 00:07.4` |
| 3 | Move into the focused task surface and select the demonstrated control. | The focused control reveals the editing surface. | editing surface | `media/motion.mp4 @ 00:14.7` |
| 4 | Enter or adjust the demonstrated value, content, route, or media option. | The product updates to the parameter or tool adjustment. | parameter or tool adjustment | `media/motion.mp4 @ 00:22.9` |
| 5 | Review the intermediate state and invoke the visible confirmation or start control. | The product shows the preview or review. | preview or review | `media/motion.mp4 @ 00:30.3` |
| 6 | Inspect the resulting saved, active, or completed product state. | The recording ends with the saved creative result. | saved creative result | `media/motion.mp4 @ 00:37.6` |
...
- **Timing class:** short product demonstration, 40.908 seconds and 1226 decoded video frames.
...
| Item | Value |
|---|---|
| Source page | https://www.youtube.com/watch?v=tvyBFC1j-f0 |
| Product page | https://play.google.com/store/apps/details?id=com.niksoftware.snapseed |
| Publisher | Alessio La Ruffa |
| Capture method | Real Android product screen recording published by Alessio La Ruffa, archived through a self-hosted Cobalt transport; publisher environment is not disclosed; no synthesized or interpolated motion. |
| Captured at | 2026-08-16T23:00:00Z |
| Motion metadata | 640×360; 40.908s; 1226 frames; 1437215 bytes |
| Motion SHA-256 | `e1be7d10b213bdc7b3d098113cd6fd91a986ab62834272cbf6929c881ac32593` |
