# 06. Google Calendar — observed Android product reference

**Product:** [Google Calendar](https://play.google.com/store/apps/details?id=com.google.android.calendar)  
**Motion source:** [The new Google Calendar app for Android and iPhone](https://www.youtube.com/watch?v=MSTmkvn060E)  
...
| Decision | ![Decision state](media/state-02-decision.jpg) | Frame from `media/motion.mp4` at 00:20.0 |
| Success | ![Success state](media/state-03-success.jpg) | Frame from `media/motion.mp4` at 00:33.7 |
...
| 3 | Move into the focused task surface and select the demonstrated control. | The focused control reveals the creation or editing surface. | creation or editing surface | `media/motion.mp4 @ 00:14.1` |
| 4 | Enter or adjust the demonstrated value, content, route, or media option. | The product updates to the configured content. | configured content | `media/motion.mp4 @ 00:22.0` |
| 5 | Review the intermediate state and invoke the visible confirmation or start control. | The product shows the review or confirmation. | review or confirmation | `media/motion.mp4 @ 00:29.0` |
| 6 | Inspect the resulting saved, active, or completed product state. | The recording ends with the saved result. | saved result | `media/motion.mp4 @ 00:36.1` |
...
- **Timing class:** short product demonstration, 39.206 seconds and 940 decoded video frames.
...
| Item | Value |
|---|---|
| Source page | https://www.youtube.com/watch?v=MSTmkvn060E |
| Product page | https://play.google.com/store/apps/details?id=com.google.android.calendar |
| Publisher | Google |
...
| Motion metadata | 640×360; 39.206s; 940 frames; 1067506 bytes |
| Motion SHA-256 | `76b119c2aeaeec3b54ff77606ca135c3032dbda39f7b3a1ed47b1b5e5d18ebf1` |
