# 36. 1Password — observed Android product reference

**Product:** [1Password](https://play.google.com/store/apps/details?id=com.onepassword.android)  
**Motion source:** [Introducing 1Password 8 for iOS and Android](https://www.youtube.com/watch?v=Qe_BNU7qkOA)  
**Upstream owner/publisher:** 1Password  
**Evidence status:** complete  
**Captured:** 2026-08-16T23:00:00Z  

<video src="media/motion.mp4" controls width="640"></video>

The local MP4 is authentic recorded product motion, not an animation synthesized from catalog stills. Product-owner or official documentation recording published by 1Password, archived through a self-hosted Cobalt transport; no synthesized or interpolated motion.

## Three retained states

| State | Local evidence | Relationship |
|---|---|---|
| Entry | ![Entry state](media/state-01-entry.jpg) | Frame from `media/motion.mp4` at 00:09.3 |
| Decision | ![Decision state](media/state-02-decision.jpg) | Frame from `media/motion.mp4` at 00:29.6 |
| Success | ![Success state](media/state-03-success.jpg) | Frame from `media/motion.mp4` at 00:49.9 |
...
| 2 | Choose the visible primary item, destination, or creation action. | The interface advances to the item or mode selected. | item or mode selected | `media/motion.mp4 @ 00:10.4` |
| 3 | Move into the focused task surface and select the demonstrated control. | The focused control reveals the action controls. | action controls | `media/motion.mp4 @ 00:20.9` |
| 4 | Enter or adjust the demonstrated value, content, route, or media option. | The product updates to the option configured. | option configured | `media/motion.mp4 @ 00:32.5` |
| 5 | Review the intermediate state and invoke the visible confirmation or start control. | The product shows the confirmation boundary. | confirmation boundary | `media/motion.mp4 @ 00:42.9` |
| 6 | Inspect the resulting saved, active, or completed product state. | The recording ends with the visible utility result. | visible utility result | `media/motion.mp4 @ 00:53.4` |
...
- **Timing class:** short product demonstration, 58.033 seconds and 1741 decoded video frames.
...
| Item | Value |
|---|---|
| Source page | https://www.youtube.com/watch?v=Qe_BNU7qkOA |
| Product page | https://play.google.com/store/apps/details?id=com.onepassword.android |
| Publisher | 1Password |
| Capture method | Product-owner or official documentation recording published by 1Password, archived through a self-hosted Cobalt transport; no synthesized or interpolated motion. |
| Captured at | 2026-08-16T23:00:00Z |
| Motion metadata | 640×360; 58.033s; 1741 frames; 2150926 bytes |
| Motion SHA-256 | `2294d63aac10a686230ca274889a70bed66978dd4dfcc8f7e4d9328602ae1e82` |
