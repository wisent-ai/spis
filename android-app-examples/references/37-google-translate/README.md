# 37. Google Translate — observed Android product reference

**Product:** [Google Translate](https://play.google.com/store/apps/details?id=com.google.android.apps.translate)  
**Motion source:** [Google Translate on Motorola Android](https://www.youtube.com/watch?v=OLU1AeE3Vns)  
**Upstream owner/publisher:** pcphobic  
**Evidence status:** complete  
**Captured:** 2026-08-16T23:00:00Z  

<video src="media/motion.mp4" controls width="640"></video>

The local MP4 is authentic recorded product motion, not an animation synthesized from catalog stills. Real Android product screen recording published by pcphobic, archived through a self-hosted Cobalt transport; publisher environment is not disclosed; no synthesized or interpolated motion.
...
| Decision | ![Decision state](media/state-02-decision.jpg) | Frame from `media/motion.mp4` at 00:22.7 |
| Success | ![Success state](media/state-03-success.jpg) | Frame from `media/motion.mp4` at 00:38.3 |

## First-success journey

**Actor:** an Android user completing a device task  
**Goal:** reach the utility result and its feedback  
**Prerequisites:** Android device; required local data or permission

| # | Observed action | System response | State | Evidence |
|---:|---|---|---|---|
| 1 | Open the product surface shown in the retained recording. | The interface presents the utility landing. | utility landing | `media/motion.mp4 @ 00:00.9` |
| 2 | Choose the visible primary item, destination, or creation action. | The interface advances to the item or mode selected. | item or mode selected | `media/motion.mp4 @ 00:08.0` |
| 3 | Move into the focused task surface and select the demonstrated control. | The focused control reveals the action controls. | action controls | `media/motion.mp4 @ 00:16.0` |
| 4 | Enter or adjust the demonstrated value, content, route, or media option. | The product updates to the option configured. | option configured | `media/motion.mp4 @ 00:24.9` |
| 5 | Review the intermediate state and invoke the visible confirmation or start control. | The product shows the confirmation boundary. | confirmation boundary | `media/motion.mp4 @ 00:32.9` |
| 6 | Inspect the resulting saved, active, or completed product state. | The recording ends with the visible utility result. | visible utility result | `media/motion.mp4 @ 00:41.0` |
...
- **Start/end:** `utility landing` → `visible utility result`.
...
- **Timing class:** short product demonstration, 44.511 seconds and 1334 decoded video frames.
...
| Item | Value |
|---|---|
| Source page | https://www.youtube.com/watch?v=OLU1AeE3Vns |
| Product page | https://play.google.com/store/apps/details?id=com.google.android.apps.translate |
| Publisher | pcphobic |
| Capture method | Real Android product screen recording published by pcphobic, archived through a self-hosted Cobalt transport; publisher environment is not disclosed; no synthesized or interpolated motion. |
| Captured at | 2026-08-16T23:00:00Z |
| Motion metadata | 480×272; 44.511s; 1334 frames; 1896267 bytes |
| Motion SHA-256 | `28eb8cc9648da34c8f1ceaf226739a7bfa5ed1523f831269aa27eb99297e0e04` |
