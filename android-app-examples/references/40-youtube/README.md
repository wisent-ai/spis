# 40. YouTube — observed Android product reference

**Product:** [YouTube](https://play.google.com/store/apps/details?id=com.google.android.youtube)  
**Motion source:** [Manage watch and search history on the YouTube Android app](https://www.youtube.com/watch?v=UFYfsRSE10g)  
**Upstream owner/publisher:** YouTube Viewers  
**Evidence status:** complete  
**Captured:** 2026-08-16T23:00:00Z  

<video src="media/motion.mp4" controls width="640"></video>

The local MP4 is authentic recorded product motion, not an animation synthesized from catalog stills. Product-owner or official documentation recording published by YouTube Viewers, archived through a self-hosted Cobalt transport; no synthesized or interpolated motion.

## Three retained states

| State | Local evidence | Relationship |
|---|---|---|
| Entry | ![Entry state](media/state-01-entry.jpg) | Frame from `media/motion.mp4` at 00:07.6 |
| Decision | ![Decision state](media/state-02-decision.jpg) | Frame from `media/motion.mp4` at 00:24.1 |
| Success | ![Success state](media/state-03-success.jpg) | Frame from `media/motion.mp4` at 00:40.7 |
...
|---:|---|---|---|---|
| 1 | Open the product surface shown in the retained recording. | The interface presents the media home. | media home | `media/motion.mp4 @ 00:00.9` |
| 2 | Choose the visible primary item, destination, or creation action. | The interface advances to the title or library item selected. | title or library item selected | `media/motion.mp4 @ 00:08.5` |
| 3 | Move into the focused task surface and select the demonstrated control. | The focused control reveals the playback started. | playback started | `media/motion.mp4 @ 00:17.0` |
| 4 | Enter or adjust the demonstrated value, content, route, or media option. | The product updates to the playback controls. | playback controls | `media/motion.mp4 @ 00:26.5` |
| 5 | Review the intermediate state and invoke the visible confirmation or start control. | The product shows the secondary option changed. | secondary option changed | `media/motion.mp4 @ 00:35.0` |
| 6 | Inspect the resulting saved, active, or completed product state. | The recording ends with the stable media result. | stable media result | `media/motion.mp4 @ 00:43.5` |
...
- **Timing class:** short product demonstration, 47.297 seconds and 1134 decoded video frames.
...
| Item | Value |
|---|---|
| Source page | https://www.youtube.com/watch?v=UFYfsRSE10g |
| Product page | https://play.google.com/store/apps/details?id=com.google.android.youtube |
| Publisher | YouTube Viewers |
| Capture method | Product-owner or official documentation recording published by YouTube Viewers, archived through a self-hosted Cobalt transport; no synthesized or interpolated motion. |
| Captured at | 2026-08-16T23:00:00Z |
| Motion metadata | 640×360; 47.297s; 1134 frames; 679298 bytes |
| Motion SHA-256 | `6889084c285e236006dfd429a81a4aaf5da0130e7fd2bc42d303d6b559c42952` |
