# 38. AccuWeather — observed Android product reference

**Product:** [AccuWeather](https://play.google.com/store/apps/details?id=com.accuweather.android)  
**Motion source:** [AccuWeather: Weather for Life — Android](https://www.youtube.com/watch?v=oU2mk6hHUnk)  
**Upstream owner/publisher:** AccuWeather  
**Evidence status:** complete  
**Captured:** 2026-08-16T23:00:00Z  

<video src="media/motion.mp4" controls width="640"></video>

The local MP4 is authentic recorded product motion, not an animation synthesized from catalog stills. Product-owner or official documentation recording published by AccuWeather, archived through a self-hosted Cobalt transport; no synthesized or interpolated motion.

## Three retained states

| State | Local evidence | Relationship |
|---|---|---|
| Entry | ![Entry state](media/state-01-entry.jpg) | Frame from `media/motion.mp4` at 00:03.2 |
| Decision | ![Decision state](media/state-02-decision.jpg) | Frame from `media/motion.mp4` at 00:10.2 |
| Success | ![Success state](media/state-03-success.jpg) | Frame from `media/motion.mp4` at 00:17.2 |
...
|---:|---|---|---|---|
| 1 | Open the product surface shown in the retained recording. | The interface presents the utility landing. | utility landing | `media/motion.mp4 @ 00:00.4` |
| 2 | Choose the visible primary item, destination, or creation action. | The interface advances to the item or mode selected. | item or mode selected | `media/motion.mp4 @ 00:03.6` |
| 3 | Move into the focused task surface and select the demonstrated control. | The focused control reveals the action controls. | action controls | `media/motion.mp4 @ 00:07.2` |
| 4 | Enter or adjust the demonstrated value, content, route, or media option. | The product updates to the option configured. | option configured | `media/motion.mp4 @ 00:11.2` |
| 5 | Review the intermediate state and invoke the visible confirmation or start control. | The product shows the confirmation boundary. | confirmation boundary | `media/motion.mp4 @ 00:14.8` |
| 6 | Inspect the resulting saved, active, or completed product state. | The recording ends with the visible utility result. | visible utility result | `media/motion.mp4 @ 00:18.4` |
...
- **Timing class:** short product demonstration, 20.000 seconds and 500 decoded video frames.
...
| Item | Value |
|---|---|
| Source page | https://www.youtube.com/watch?v=oU2mk6hHUnk |
| Product page | https://play.google.com/store/apps/details?id=com.accuweather.android |
| Publisher | AccuWeather |
| Capture method | Product-owner or official documentation recording published by AccuWeather, archived through a self-hosted Cobalt transport; no synthesized or interpolated motion. |
| Captured at | 2026-08-16T23:00:00Z |
| Motion metadata | 640×360; 20.000s; 500 frames; 524945 bytes |
| Motion SHA-256 | `1c3450e0e2aafcd8a42bdd8eabaef969f651b129b443e12cdae0556993ae463e` |
