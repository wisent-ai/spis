# 14. Google Messages — observed Android product reference

**Product:** [Google Messages](https://play.google.com/store/apps/details?id=com.google.android.apps.messaging)  
**Motion source:** [Messages by Google | New features and a new look](https://www.youtube.com/watch?v=lV4ZkOYSnM0)  
...
|---|---|---|
| Entry | ![Entry state](media/state-01-entry.jpg) | Frame from `media/motion.mp4` at 00:09.6 |
| Decision | ![Decision state](media/state-02-decision.jpg) | Frame from `media/motion.mp4` at 00:30.7 |
| Success | ![Success state](media/state-03-success.jpg) | Frame from `media/motion.mp4` at 00:51.7 |
...
|---:|---|---|---|---|
| 1 | Open the product surface shown in the retained recording. | The interface presents the app entry. | app entry | `media/motion.mp4 @ 00:01.2` |
| 2 | Choose the visible primary item, destination, or creation action. | The interface advances to the recipient or channel selected. | recipient or channel selected | `media/motion.mp4 @ 00:10.8` |
| 3 | Move into the focused task surface and select the demonstrated control. | The focused control reveals the communication controls. | communication controls | `media/motion.mp4 @ 00:21.6` |
| 4 | Enter or adjust the demonstrated value, content, route, or media option. | The product updates to the content or call configured. | content or call configured | `media/motion.mp4 @ 00:33.7` |
| 5 | Review the intermediate state and invoke the visible confirmation or start control. | The product shows the confirmation or active state. | confirmation or active state | `media/motion.mp4 @ 00:44.5` |
| 6 | Inspect the resulting saved, active, or completed product state. | The recording ends with the visible communication result. | visible communication result | `media/motion.mp4 @ 00:55.3` |
...
- **Timing class:** short product demonstration, 60.102 seconds and 1441 decoded video frames.
...
| Item | Value |
|---|---|
| Source page | https://www.youtube.com/watch?v=lV4ZkOYSnM0 |
| Product page | https://play.google.com/store/apps/details?id=com.google.android.apps.messaging |
| Publisher | Google |
...
| Motion metadata | 640×360; 60.102s; 1441 frames; 2001918 bytes |
| Motion SHA-256 | `1badeeb798b13d85bae380ae46ba812ef5a92930ee63a3103c373d29ff57b6c8` |
