# 29. Canva — observed Android product reference

**Product:** [Canva](https://play.google.com/store/apps/details?id=com.canva.editor)  
**Motion source:** [Canva for Android — Photo Editing](https://www.youtube.com/watch?v=wdFXby-As-o)  
**Upstream owner/publisher:** Canva  
**Evidence status:** complete  
**Captured:** 2026-08-16T23:00:00Z  

<video src="media/motion.mp4" controls width="640"></video>

The local MP4 is authentic recorded product motion, not an animation synthesized from catalog stills. Product-owner Android recording published by Canva, archived from its YouTube source with the Pytubefix MWEB/TV client; retained without synthesized or interpolated motion.

## Three retained states

| State | Local evidence | Relationship |
|---|---|---|
| Entry | ![Entry state](media/state-01-entry.jpg) | Frame from `media/motion.mp4` at 00:03.3 |
| Decision | ![Decision state](media/state-02-decision.jpg) | Frame from `media/motion.mp4` at 00:10.7 |
| Success | ![Success state](media/state-03-success.jpg) | Frame from `media/motion.mp4` at 00:18.0 |
...
|---:|---|---|---|---|
| 1 | Open the product surface shown in the retained recording. | The interface presents the project entry. | project entry | `media/motion.mp4 @ 00:00.4` |
| 2 | Choose the visible primary item, destination, or creation action. | The interface advances to the source selected. | source selected | `media/motion.mp4 @ 00:03.8` |
| 3 | Move into the focused task surface and select the demonstrated control. | The focused control reveals the editing surface. | editing surface | `media/motion.mp4 @ 00:07.5` |
| 4 | Enter or adjust the demonstrated value, content, route, or media option. | The product updates to the parameter or tool adjustment. | parameter or tool adjustment | `media/motion.mp4 @ 00:11.7` |
| 5 | Review the intermediate state and invoke the visible confirmation or start control. | The product shows the preview or review. | preview or review | `media/motion.mp4 @ 00:15.5` |
| 6 | Inspect the resulting saved, active, or completed product state. | The recording ends with the saved creative result. | saved creative result | `media/motion.mp4 @ 00:19.2` |
...
- **Timing class:** short product demonstration, 20.917 seconds and 502 decoded video frames.
...
| Item | Value |
|---|---|
| Source page | https://www.youtube.com/watch?v=wdFXby-As-o |
| Product page | https://play.google.com/store/apps/details?id=com.canva.editor |
| Publisher | Canva |
| Capture method | Product-owner Android recording published by Canva, archived from its YouTube source with the Pytubefix MWEB/TV client; retained without synthesized or interpolated motion. |
| Captured at | 2026-08-16T23:00:00Z |
| Motion metadata | 360×640; 20.917s; 502 frames; 1052713 bytes |
| Motion SHA-256 | `9516d016d1a559721b64aed1f1ec42926503369eb00b77f91be3dbf771e2392a` |
