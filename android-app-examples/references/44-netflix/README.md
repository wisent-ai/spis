# 44. Netflix — observed Android product reference

**Product:** [Netflix](https://play.google.com/store/apps/details?id=com.netflix.mediaclient)  
**Motion source:** [How to Sign in to Netflix App on Android](https://www.youtube.com/watch?v=VVRG6ZILHNE)  
**Upstream owner/publisher:** Login Helps - How to Tutorial  
**Evidence status:** complete  
**Captured:** 2026-08-16T23:00:00Z  

<video src="media/motion.mp4" controls width="640"></video>

The local MP4 is authentic recorded product motion, not an animation synthesized from catalog stills. Real Android product screen recording published by Login Helps - How to Tutorial, archived through a self-hosted Cobalt transport; publisher environment is not disclosed; no synthesized or interpolated motion.

## Three retained states

| State | Local evidence | Relationship |
|---|---|---|
| Entry | ![Entry state](media/state-01-entry.jpg) | Frame from `media/motion.mp4` at 00:08.7 |
| Decision | ![Decision state](media/state-02-decision.jpg) | Frame from `media/motion.mp4` at 00:27.7 |
| Success | ![Success state](media/state-03-success.jpg) | Frame from `media/motion.mp4` at 00:46.8 |

## First-success journey

**Actor:** a media listener or viewer  
**Goal:** reach controlled playback or library state  
**Prerequisites:** Android device; media or network available

| # | Observed action | System response | State | Evidence |
|---:|---|---|---|---|
| 1 | Open the product surface shown in the retained recording. | The interface presents the media home. | media home | `media/motion.mp4 @ 00:01.1` |
| 2 | Choose the visible primary item, destination, or creation action. | The interface advances to the title or library item selected. | title or library item selected | `media/motion.mp4 @ 00:09.8` |
| 3 | Move into the focused task surface and select the demonstrated control. | The focused control reveals the playback started. | playback started | `media/motion.mp4 @ 00:19.6` |
| 4 | Enter or adjust the demonstrated value, content, route, or media option. | The product updates to the playback controls. | playback controls | `media/motion.mp4 @ 00:30.5` |
| 5 | Review the intermediate state and invoke the visible confirmation or start control. | The product shows the secondary option changed. | secondary option changed | `media/motion.mp4 @ 00:40.2` |
| 6 | Inspect the resulting saved, active, or completed product state. | The recording ends with the stable media result. | stable media result | `media/motion.mp4 @ 00:50.0` |
...
- **Start/end:** `media home` → `stable media result`.
...
- **Timing class:** short product demonstration, 54.375 seconds and 1305 decoded video frames.
...
| Item | Value |
|---|---|
| Source page | https://www.youtube.com/watch?v=VVRG6ZILHNE |
| Product page | https://play.google.com/store/apps/details?id=com.netflix.mediaclient |
| Publisher | Login Helps - How to Tutorial |
| Capture method | Real Android product screen recording published by Login Helps - How to Tutorial, archived through a self-hosted Cobalt transport; publisher environment is not disclosed; no synthesized or interpolated motion. |
| Captured at | 2026-08-16T23:00:00Z |
| Motion metadata | 640×360; 54.375s; 1305 frames; 425619 bytes |
| Motion SHA-256 | `2c021d2e3b8a954ce7d60e4e11955ddede4e8054041269b036a6924f8e3e37eb` |
