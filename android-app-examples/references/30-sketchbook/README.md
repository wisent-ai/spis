# 30. Sketchbook — observed Android product reference

**Product:** [Sketchbook](https://play.google.com/store/apps/details?id=com.adsk.sketchbook)  
**Motion source:** [Autodesk Sketchbook Tutorial — Digital Art on Android Phone](https://www.youtube.com/watch?v=V-aLdmmc10s)  
**Upstream owner/publisher:** ArtsySolanki  
**Evidence status:** complete  
**Captured:** 2026-08-16T23:00:00Z  

<video src="media/motion.mp4" controls width="640"></video>

The local MP4 is authentic recorded product motion, not an animation synthesized from catalog stills. Real Android product screen recording published by ArtsySolanki, archived from its YouTube source with the Pytubefix MWEB/TV client; publisher device/account environment is not disclosed; no synthesized or interpolated motion.
...
| 5 | Review the intermediate state and invoke the visible confirmation or start control. | The product shows the preview or review. | preview or review | `media/motion.mp4 @ 02:13.2` |
| 6 | Inspect the resulting saved, active, or completed product state. | The recording ends with the saved creative result. | saved creative result | `media/motion.mp4 @ 02:45.6` |
...
| Item | Value |
|---|---|
| Source page | https://www.youtube.com/watch?v=V-aLdmmc10s |
| Product page | https://play.google.com/store/apps/details?id=com.adsk.sketchbook |
| Publisher | ArtsySolanki |
| Capture method | Real Android product screen recording published by ArtsySolanki, archived from its YouTube source with the Pytubefix MWEB/TV client; publisher device/account environment is not disclosed; no synthesized or interpolated motion. |
| Captured at | 2026-08-16T23:00:00Z |
| Motion metadata | 640×360; 180.033s; 5401 frames; 9961032 bytes |
| Motion SHA-256 | `845ab42c53111dd9f17d9cf0a4d447c9c3e9058573035902cf948daf13005be8` |
