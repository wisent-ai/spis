# Yelp: Food, Delivery & Reviews (Google Play)

**Evidence status:** complete  
**Product URL:** [https://play.google.com/store/apps/details?id=com.yelp.android](https://play.google.com/store/apps/details?id=com.yelp.android)  
**Category:** Google Play — Food & Drink  
**Upstream owner:** Yelp, Inc  
**Captured:** 2026-08-16T23:40:09Z

Study how local photography, star ratings, maps, filters, and business details are sequenced to replicate the discovery-to-decision path inside the app.

## Authentic local motion

| Local asset | Kind | Dimensions | Duration / frames | Bytes | SHA-256 | Provenance |
|---|---|---:|---:|---:|---|---|
| [`media/listing-interaction.webm`](media/listing-interaction.webm) | webm | 1280×720 | 17.56 s / 439 frames | 1859699 | `af7b856f7f82ab5833c7623c537c609179343ef550ab61b5a3408648e37769ca` | [source](https://play.google.com/store/apps/details?id=com.yelp.android) |
...
|---:|---|---|---|---:|---:|---|
| 1 | listing-open | [`media/listing-state-01.png`](media/listing-state-01.png) | `media/listing-interaction.webm` | 1920×1080 | 461735 | `2356abec61a30168c86e51075615299a95444d18f7cf49016bf97274e07b6694` |
| 2 | media-shelf | [`media/listing-state-02.png`](media/listing-state-02.png) | `media/listing-interaction.webm` | 1920×1080 | 419244 | `1e5efbb67264547a094694d288b9da9aa7f8ff798962cfb5817b84e20251ba4b` |
| 3 | media-selected | [`media/listing-state-03.png`](media/listing-state-03.png) | `media/listing-interaction.webm` | 1920×1080 | 492788 | `72347cfd8e0b235a93ac55a061554016c31f29fdec2d786a08f281f11fff6c2d` |
| 4 | details-reached | [`media/listing-state-04.png`](media/listing-state-04.png) | `media/listing-interaction.webm` | 1920×1080 | 129895 | `f6808c1d4ddd8b032cfdd310d42fc15034eec614b00c754282a1a83727e55efd` |
| 5 | target-overshot | [`media/listing-state-05.png`](media/listing-state-05.png) | `media/listing-interaction.webm` | 1920×1080 | 92514 | `c79e8c4294ee05ac13f455d6fdb12ece551cd7f6e04126b85ec456d788dc2aba` |
| 6 | recovered-to-media | [`media/listing-state-06.png`](media/listing-state-06.png) | `media/listing-interaction.webm` | 1920×1080 | 287501 | `ce8b2f1c00c54d8ac1a52406c31a3fac8ee8324207a013665c1431c9052421ba` |
| 7 | returned-to-header | [`media/listing-state-07.png`](media/listing-state-07.png) | `media/listing-interaction.webm` | 1920×1080 | 461735 | `2356abec61a30168c86e51075615299a95444d18f7cf49016bf97274e07b6694` |

## Discovery-to-open journey

**Actor:** Prospective mobile-app user evaluating a store listing before installation.  
**Goal:** Discover Yelp: Food, Delivery & Reviews (Google Play), inspect its product media and listing details, recover from a navigation overshoot, and return to the product header ready for the next store decision.
