# Memrise: Speak a New Language (Google Play)

**Evidence status:** complete  
**Product URL:** [https://play.google.com/store/apps/details?id=com.memrise.android.memrisecompanion](https://play.google.com/store/apps/details?id=com.memrise.android.memrisecompanion)  
**Category:** Google Play — Education  
**Upstream owner:** Memrise  
**Captured:** 2026-08-16T23:41:35Z

Study how speaking outcomes, native-speaker video, practice modes, and progress are staged across screenshots, with user ratings reinforcing the learning proposition.

## Authentic local motion

| Local asset | Kind | Dimensions | Duration / frames | Bytes | SHA-256 | Provenance |
|---|---|---:|---:|---:|---|---|
| [`media/listing-interaction.webm`](media/listing-interaction.webm) | webm | 1280×720 | 21.48 s / 537 frames | 1828160 | `850e59a5a1485be75aaede56aaecc72d3a97433e790d188ccdfc185b1407689f` | [source](https://play.google.com/store/apps/details?id=com.memrise.android.memrisecompanion) |
...
|---:|---|---|---|---:|---:|---|
| 1 | listing-open | [`media/listing-state-01.png`](media/listing-state-01.png) | `media/listing-interaction.webm` | 1366×768 | 286034 | `232adfaaca8ad787e782e14d467ca009a38569d122fea06b7ab6b1578a7c27f8` |
| 2 | media-shelf | [`media/listing-state-02.png`](media/listing-state-02.png) | `media/listing-interaction.webm` | 1366×768 | 259032 | `e75cd5b756f5e86623e0065bbb53995aa93f15658548eaf8663ef6b5b2e5b33c` |
| 3 | media-selected | [`media/listing-state-03.png`](media/listing-state-03.png) | `media/listing-interaction.webm` | 1366×768 | 261459 | `a8b8465c1efce6bb3671eec976649f4c4d66980a23e5b2a3b096cc15060efb06` |
| 4 | details-reached | [`media/listing-state-04.png`](media/listing-state-04.png) | `media/listing-interaction.webm` | 1366×768 | 87033 | `fb0e5c5d4a2000b75c1194136ac50745167039526d7a9cc0ee05fccb6634ea45` |
| 5 | target-overshot | [`media/listing-state-05.png`](media/listing-state-05.png) | `media/listing-interaction.webm` | 1366×768 | 67034 | `4b5f4d4f499d0faa4a1838b5a87ff591deb45e5aa451b6251b8fbe67b1bd0ec6` |
| 6 | recovered-to-media | [`media/listing-state-06.png`](media/listing-state-06.png) | `media/listing-interaction.webm` | 1366×768 | 275260 | `d1216370d80e01f9091888fbce26f63070d032f440fd9c788ccbc60394e96a4a` |
| 7 | returned-to-header | [`media/listing-state-07.png`](media/listing-state-07.png) | `media/listing-interaction.webm` | 1366×768 | 286034 | `232adfaaca8ad787e782e14d467ca009a38569d122fea06b7ab6b1578a7c27f8` |

## Discovery-to-open journey

**Actor:** Prospective mobile-app user evaluating a store listing before installation.  
**Goal:** Discover Memrise: Speak a New Language (Google Play), inspect its product media and listing details, recover from a navigation overshoot, and return to the product header ready for the next store decision.
