# AllTrails: Hike, Bike & Run (Apple App Store)

**Evidence status:** complete  
**Product URL:** [https://apps.apple.com/us/app/id405075943](https://apps.apple.com/us/app/id405075943)  
**Category:** Apple App Store — Navigation  
**Upstream owner:** AllTrails, Inc.  
**Captured:** 2026-08-17T00:33:35Z

Study the sequence from trail discovery to maps, navigation, recording, and community evidence, which mirrors the product journey from intent to completed activity.

## Authentic local motion

| Local asset | Kind | Dimensions | Duration / frames | Bytes | SHA-256 | Provenance |
|---|---|---:|---:|---:|---|---|
| [`media/listing-interaction.webm`](media/listing-interaction.webm) | webm | 1280×720 | 19.2 s / 480 frames | 1344939 | `db054c26bb7d1bab4ef909a5316d3d0421766be514a41e07040e2e08e6ead826` | [source](https://apps.apple.com/us/app/id405075943) |
...
|---:|---|---|---|---:|---:|---|
| 1 | listing-open | [`media/listing-state-01.png`](media/listing-state-01.png) | `media/listing-interaction.webm` | 900×506 | 245366 | `bad5cab67667757de36f243852ad567d3954e9a3bbb858fa7cb45bb18b2375e6` |
| 2 | media-shelf | [`media/listing-state-02.png`](media/listing-state-02.png) | `media/listing-interaction.webm` | 900×506 | 221596 | `c9dbf0e608e8c2ad2d338be57e220b646acbe75e8fdfee2ea3ca57e60629bfcf` |
| 3 | selection-unavailable | [`media/listing-state-03.png`](media/listing-state-03.png) | `media/listing-interaction.webm` | 900×506 | 221596 | `c9dbf0e608e8c2ad2d338be57e220b646acbe75e8fdfee2ea3ca57e60629bfcf` |
| 4 | details-reached | [`media/listing-state-04.png`](media/listing-state-04.png) | `media/listing-interaction.webm` | 900×506 | 114064 | `32d508da2ba96e998e341f09301a58a97b706945b70c02e4a7a2d0e400732025` |
| 5 | target-overshot | [`media/listing-state-05.png`](media/listing-state-05.png) | `media/listing-interaction.webm` | 900×506 | 177245 | `69f72dc3cccff28c7e356da0369d87cff9253ed7b99947c79de0c0430fadeb57` |
| 6 | recovered-to-media | [`media/listing-state-06.png`](media/listing-state-06.png) | `media/listing-interaction.webm` | 900×506 | 246662 | `8d86e0f1242161e9343e10bb88fb591e5283078dd255d418c21edbfc0844ee6b` |
| 7 | returned-to-header | [`media/listing-state-07.png`](media/listing-state-07.png) | `media/listing-interaction.webm` | 900×506 | 247050 | `3b4f48fcb20531bdb62ec0fba2c9a30894ff536a1c835eb602f0d49ecc446cf0` |

## Discovery-to-open journey

**Actor:** Prospective mobile-app user evaluating a store listing before installation.  
**Goal:** Discover AllTrails: Hike, Bike & Run (Apple App Store), inspect its product media and listing details, recover from a navigation overshoot, and return to the product header ready for the next store decision.
