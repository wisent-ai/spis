# Notion: Notes, Tasks, AI (Apple App Store)

**Evidence status:** complete  
**Product URL:** [https://apps.apple.com/us/app/id1232780281](https://apps.apple.com/us/app/id1232780281)  
**Category:** Apple App Store — Productivity  
**Upstream owner:** Notion Labs, Incorporated  
**Captured:** 2026-08-17T00:28:44Z

Study how compact title positioning, interface-led screenshots, and recognizable template use explain a flexible product without requiring a long onboarding story.

## Authentic local motion

| Local asset | Kind | Dimensions | Duration / frames | Bytes | SHA-256 | Provenance |
|---|---|---:|---:|---:|---|---|
| [`media/listing-interaction.webm`](media/listing-interaction.webm) | webm | 1280×720 | 13.16 s / 329 frames | 1151879 | `f1ed6a74ac55e4724064107ac3a18dd4a72a0a322661711d16f8ed687c3fd614` | [source](https://apps.apple.com/us/app/id1232780281) |
...
|---:|---|---|---|---:|---:|---|
| 1 | listing-open | [`media/listing-state-01.png`](media/listing-state-01.png) | `media/listing-interaction.webm` | 900×562 | 191095 | `5c782ca6554b12401617d70f5892862a185180c34bb3c813e999c11242ad6f0e` |
| 2 | media-shelf | [`media/listing-state-02.png`](media/listing-state-02.png) | `media/listing-interaction.webm` | 900×562 | 164418 | `7237006663eff92f05b8e367474e37e3e13c737f495d3a300061e21ab3ce7ac3` |
| 3 | selection-unavailable | [`media/listing-state-03.png`](media/listing-state-03.png) | `media/listing-interaction.webm` | 900×562 | 164418 | `7237006663eff92f05b8e367474e37e3e13c737f495d3a300061e21ab3ce7ac3` |
| 4 | details-reached | [`media/listing-state-04.png`](media/listing-state-04.png) | `media/listing-interaction.webm` | 900×562 | 145967 | `3ca497d13ec5e9fb6d6cda8e4f1522629a2e3cecdfc283301d527b7c6be214ac` |
| 5 | target-overshot | [`media/listing-state-05.png`](media/listing-state-05.png) | `media/listing-interaction.webm` | 900×562 | 228862 | `9b4ea9e429947231b68b32b2df1ce89770ae4481491d28198bd376771baf87bc` |
| 6 | recovered-to-media | [`media/listing-state-06.png`](media/listing-state-06.png) | `media/listing-interaction.webm` | 900×562 | 164993 | `6a9888a2b7aac601fab957447eaa15a4bb99551ceae32514222f539183f1a67e` |
| 7 | returned-to-header | [`media/listing-state-07.png`](media/listing-state-07.png) | `media/listing-interaction.webm` | 900×562 | 191095 | `5c782ca6554b12401617d70f5892862a185180c34bb3c813e999c11242ad6f0e` |

## Discovery-to-open journey

**Actor:** Prospective mobile-app user evaluating a store listing before installation.  
**Goal:** Discover Notion: Notes, Tasks, AI (Apple App Store), inspect its product media and listing details, recover from a navigation overshoot, and return to the product header ready for the next store decision.
