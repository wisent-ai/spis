...
**Product URL:** [https://play.google.com/store/apps/details?id=com.microsoft.teams](https://play.google.com/store/apps/details?id=com.microsoft.teams)  
**Category:** Google Play — Business  
**Upstream owner:** Microsoft Corporation  
**Captured:** 2026-08-16T23:35:41Z

Study how meetings, chat, channels, and collaboration are separated into discrete screenshot claims while remaining visually tied to the actual mobile interface.

## Authentic local motion

| Local asset | Kind | Dimensions | Duration / frames | Bytes | SHA-256 | Provenance |
|---|---|---:|---:|---:|---|---|
| [`media/listing-interaction.webm`](media/listing-interaction.webm) | webm | 1280×720 | 28.2 s / 705 frames | 2050897 | `a770c17a98c5f8f5c2e4456338517cf9225ba8c1ac171b543a4b8520c2d9510e` | [source](https://play.google.com/store/apps/details?id=com.microsoft.teams) |
...
|---:|---|---|---|---:|---:|---|
| 1 | listing-open | [`media/listing-state-01.png`](media/listing-state-01.png) | `media/listing-interaction.webm` | 2880×1800 | 1429665 | `c276477687370ac3dbdb2ce354f96d79361eca5b00869a7e0012409216c74425` |
| 2 | media-shelf | [`media/listing-state-02.png`](media/listing-state-02.png) | `media/listing-interaction.webm` | 2880×1800 | 1136192 | `3cc2f92ff60dc763e8f13c7284b9943f9c7a81162440e34b4e3def38f6c5bb14` |
| 3 | media-selected | [`media/listing-state-03.png`](media/listing-state-03.png) | `media/listing-interaction.webm` | 2880×1800 | 2532487 | `5a10ab00945249c0f57ee35b33e1d46bda40e7106a78690230e791043ef3a2d1` |
| 4 | details-reached | [`media/listing-state-04.png`](media/listing-state-04.png) | `media/listing-interaction.webm` | 2880×1800 | 2098738 | `1baf99052bb3932038b82189e2a5e8d4b5af1ad60ee9a0c1171e05a656c1030f` |
| 5 | target-overshot | [`media/listing-state-05.png`](media/listing-state-05.png) | `media/listing-interaction.webm` | 2880×1800 | 1971770 | `88bcfe8976269e388492059fef70f526dde928979f2fcd431e1e0cfe60a98c0b` |
| 6 | recovered-to-media | [`media/listing-state-06.png`](media/listing-state-06.png) | `media/listing-interaction.webm` | 2880×1800 | 2503120 | `f6c2784d654cc3b2b23cf8304ec827417e3846a86c47ad42cd69037d14ad180e` |
| 7 | returned-to-header | [`media/listing-state-07.png`](media/listing-state-07.png) | `media/listing-interaction.webm` | 2880×1800 | 2503154 | `21009b18486d1a9ea382869404345a755ce1d4592e78dbbbbab76d2da64fb069` |

## Discovery-to-open journey

**Actor:** Prospective mobile-app user evaluating a store listing before installation.  
**Goal:** Discover Microsoft Teams (Google Play), inspect its product media and listing details, recover from a navigation overshoot, and return to the product header ready for the next store decision.
