# Todoist: Planner & Calendar (Google Play)

**Evidence status:** complete  
**Product URL:** [https://play.google.com/store/apps/details?id=com.todoist](https://play.google.com/store/apps/details?id=com.todoist)  
**Category:** Google Play — Productivity  
**Upstream owner:** Todoist Inc.  
**Captured:** 2026-08-16T23:36:05Z

Study how a calm icon and interface-first screenshots explain capture, prioritization, planning, and collaboration, with editorial and user-review signals adding social proof.

## Authentic local motion

| Local asset | Kind | Dimensions | Duration / frames | Bytes | SHA-256 | Provenance |
|---|---|---:|---:|---:|---|---|
| [`media/listing-interaction.webm`](media/listing-interaction.webm) | webm | 1280×720 | 21.2 s / 530 frames | 1448367 | `d7c659752d239bbe9e93894a29fdee1cb6b5197e08543419d88029cd40f87013` | [source](https://play.google.com/store/apps/details?id=com.todoist) |
| [`media/official-store-preview.mp4`](media/official-store-preview.mp4) | mp4 | 360×640 | 38.794 s / 1163 frames | 1144254 | `43267cf9240c90048a62c947ddf284dec7cf7c8c17bb434d0740997c52e551bc` | [source](https://www.youtube.com/watch?v=dEr5h9d3EM8) |
...
|---:|---|---|---|---:|---:|---|
| 1 | listing-open | [`media/listing-state-01.png`](media/listing-state-01.png) | `media/listing-interaction.webm` | 1920×1080 | 648302 | `52ae855922ee665f37fceeb9c5990198565ca399065ac870695d0b7a642e73a3` |
| 2 | media-shelf | [`media/listing-state-02.png`](media/listing-state-02.png) | `media/listing-interaction.webm` | 1920×1080 | 453399 | `b20cbea5c7b9270fd5918fa8202bc5d052113d2a7e521be606213501b3b7f80b` |
| 3 | media-selected | [`media/listing-state-03.png`](media/listing-state-03.png) | `media/listing-interaction.webm` | 1920×1080 | 425255 | `094baba336f2c2e4fee0a81260f723227a51bb46a24bb2f7324f70e92127483c` |
| 4 | details-reached | [`media/listing-state-04.png`](media/listing-state-04.png) | `media/listing-interaction.webm` | 1920×1080 | 326586 | `b363103f8c83af101597d63d744397eb2fe5c323b0e55ed2ea1a8be3201364ab` |
| 5 | target-overshot | [`media/listing-state-05.png`](media/listing-state-05.png) | `media/listing-interaction.webm` | 1920×1080 | 131317 | `410a5c11419a144bd9facbbfeee8dc17dcd2bf0eb4dd962e24cdf54da786da79` |
| 6 | recovered-to-media | [`media/listing-state-06.png`](media/listing-state-06.png) | `media/listing-interaction.webm` | 1920×1080 | 500961 | `eae9a393bb4b6a14169b26d9dc71fdfb50354c45c2f95bf99dbdb3a0b6a6446b` |
| 7 | returned-to-header | [`media/listing-state-07.png`](media/listing-state-07.png) | `media/listing-interaction.webm` | 1920×1080 | 648302 | `52ae855922ee665f37fceeb9c5990198565ca399065ac870695d0b7a642e73a3` |
| 8 | official-preview-key-state-1 | [`media/preview-state-01.png`](media/preview-state-01.png) | `media/official-store-preview.mp4` | 360×640 | 44148 | `b4eead508de57e9ddb43c01b719fec037ecabc57644d12a6dbd1e44824734649` |
| 9 | official-preview-key-state-2 | [`media/preview-state-02.png`](media/preview-state-02.png) | `media/official-store-preview.mp4` | 360×640 | 67373 | `e82e6045b99068ee3586fbb1e955136fd9999b07bb40862783717567a1f3001f` |
| 10 | official-preview-key-state-3 | [`media/preview-state-03.png`](media/preview-state-03.png) | `media/official-store-preview.mp4` | 360×640 | 102510 | `c3bb0284bef10a6667f9c1f86d7fa7bbfa7b25cb4fc9545711745c576ad96914` |

## Discovery-to-open journey

**Actor:** Prospective mobile-app user evaluating a store listing before installation.  
**Goal:** Discover Todoist: Planner & Calendar (Google Play), inspect its product media and listing details, recover from a navigation overshoot, and return to the product header ready for the next store decision.
