# Babbel: Language Learning (Google Play)

**Evidence status:** complete  
**Product URL:** [https://play.google.com/store/apps/details?id=com.babbel.mobile.android.en](https://play.google.com/store/apps/details?id=com.babbel.mobile.android.en)  
**Category:** Google Play — Education  
**Upstream owner:** Babbel  
**Captured:** 2026-08-16T23:41:59Z

Study how lesson brevity, practical dialogue, speech practice, and progress are translated into a linear screenshot narrative tied closely to in-app exercises.

## Authentic local motion

| Local asset | Kind | Dimensions | Duration / frames | Bytes | SHA-256 | Provenance |
|---|---|---:|---:|---:|---|---|
| [`media/listing-interaction.webm`](media/listing-interaction.webm) | webm | 1280×720 | 20.48 s / 512 frames | 1735137 | `dd4ec69d0b92a1a59f90f16fcc6a24d2e855fe44727ca9f17a9187e08156cb2a` | [source](https://play.google.com/store/apps/details?id=com.babbel.mobile.android.en) |
...
|---:|---|---|---|---:|---:|---|
| 1 | listing-open | [`media/listing-state-01.png`](media/listing-state-01.png) | `media/listing-interaction.webm` | 1366×768 | 212147 | `665f9a83b7fbab69fcacc539dd8f588de01f79a8247afcb5d24a6a033581e061` |
| 2 | media-shelf | [`media/listing-state-02.png`](media/listing-state-02.png) | `media/listing-interaction.webm` | 1366×768 | 236224 | `e1b65dfa284363002e503cd8194507b1a7ec506dd47f8f908b3c646b8d272802` |
| 3 | media-selected | [`media/listing-state-03.png`](media/listing-state-03.png) | `media/listing-interaction.webm` | 1366×768 | 403668 | `1c6c6a1c6d37974d45da9e7276652633af76ad3ca5c0f0359b7053a598acc6cf` |
| 4 | details-reached | [`media/listing-state-04.png`](media/listing-state-04.png) | `media/listing-interaction.webm` | 1366×768 | 585128 | `8405c6e44b17c0f7e1d3b2446cca345d37621222aa375a85b926e444f5cfa7e6` |
| 5 | target-overshot | [`media/listing-state-05.png`](media/listing-state-05.png) | `media/listing-interaction.webm` | 1366×768 | 538490 | `8347c6fb9203cca1481deed339e50fd94d9ad2f8696a401e92be5f95f6a12d2d` |
| 6 | recovered-to-media | [`media/listing-state-06.png`](media/listing-state-06.png) | `media/listing-interaction.webm` | 1366×768 | 404315 | `7ab95a5a571834e623570afe5ee32f7ef2cd57101f8baa67280da771973f71d3` |
| 7 | returned-to-header | [`media/listing-state-07.png`](media/listing-state-07.png) | `media/listing-interaction.webm` | 1366×768 | 404315 | `7ab95a5a571834e623570afe5ee32f7ef2cd57101f8baa67280da771973f71d3` |

## Discovery-to-open journey

**Actor:** Prospective mobile-app user evaluating a store listing before installation.  
**Goal:** Discover Babbel: Language Learning (Google Play), inspect its product media and listing details, recover from a navigation overshoot, and return to the product header ready for the next store decision.
