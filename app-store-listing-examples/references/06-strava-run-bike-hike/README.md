# Strava: Run, Bike, Hike (Apple App Store)

**Evidence status:** complete  
**Product URL:** [https://apps.apple.com/us/app/id426826309](https://apps.apple.com/us/app/id426826309)  
**Category:** Apple App Store — Health & Fitness  
**Upstream owner:** Strava, Inc.  
**Captured:** 2026-08-17T00:29:29Z

Study how activity tracking, community, routes, and progress are sequenced across screenshots to connect acquisition claims with the core in-app loop.

## Authentic local motion

| Local asset | Kind | Dimensions | Duration / frames | Bytes | SHA-256 | Provenance |
|---|---|---:|---:|---:|---|---|
| [`media/listing-interaction.webm`](media/listing-interaction.webm) | webm | 1280×720 | 17.28 s / 432 frames | 1691060 | `c1dad28269ee407bf33c6cec2deccb199769f638232e5cf3c22e70288c8e76db` | [source](https://apps.apple.com/us/app/id426826309) |
| [`media/official-store-preview.mp4`](media/official-store-preview.mp4) | mp4 | 520×1128 | 5.991 s / 171 frames | 1509189 | `ee069cf711627d09bdb7a7b0cd573593b7ea8ddee8fc4883bce17127f4895423` | [source](https://apptrailers.itunes.apple.com/itunes-assets/PurpleVideo221/v4/a6/f2/50/a6f250e3-79cf-dcd3-af53-82f6b1b93b35/P1126263724_default.m3u8) |
...
|---:|---|---|---|---:|---:|---|
| 1 | listing-open | [`media/listing-state-01.png`](media/listing-state-01.png) | `media/listing-interaction.webm` | 900×506 | 255128 | `af49afd172c59746b30a58af7cabc6a15941e66e2ce20cf326bdbd33bd272ada` |
| 2 | media-shelf | [`media/listing-state-02.png`](media/listing-state-02.png) | `media/listing-interaction.webm` | 900×506 | 279425 | `965925e47b86e06b1bcc30ab7802eb0613c7039a7ed879a4b3b99d1316d43af2` |
| 3 | selection-unavailable | [`media/listing-state-03.png`](media/listing-state-03.png) | `media/listing-interaction.webm` | 900×506 | 279425 | `965925e47b86e06b1bcc30ab7802eb0613c7039a7ed879a4b3b99d1316d43af2` |
| 4 | details-reached | [`media/listing-state-04.png`](media/listing-state-04.png) | `media/listing-interaction.webm` | 900×506 | 279647 | `e0861639276b70cc9ac4bf09b80e1e362a2e616320e16644745dbc55317e7cb2` |
| 5 | target-overshot | [`media/listing-state-05.png`](media/listing-state-05.png) | `media/listing-interaction.webm` | 900×506 | 255804 | `b016bc38847e9b41824241df5ef938045bfc935a8c356eb1937007007832bc1f` |
| 6 | recovered-to-media | [`media/listing-state-06.png`](media/listing-state-06.png) | `media/listing-interaction.webm` | 900×506 | 318833 | `bc27be1d2faff7ca892458e1edff19fe80d36d1569d9ed7e3d14c3d3a8e00b18` |
| 7 | returned-to-header | [`media/listing-state-07.png`](media/listing-state-07.png) | `media/listing-interaction.webm` | 900×506 | 256599 | `9210fed5d768530715e37958676bf35565301e6b2595ecd46a3282a78aa34c8d` |
| 8 | official-preview-key-state-1 | [`media/preview-state-01.png`](media/preview-state-01.png) | `media/official-store-preview.mp4` | 520×1128 | 208416 | `d60b18ae6beae027f5b3a5f43cfc27eca39849d4e714da1c9b30880d819827e1` |
| 9 | official-preview-key-state-2 | [`media/preview-state-02.png`](media/preview-state-02.png) | `media/official-store-preview.mp4` | 520×1128 | 176287 | `7cd768ec2afd75f93c9dbb5838472e7016c5c1a2a4fd55e64725fc7364dfcae5` |
| 10 | official-preview-key-state-3 | [`media/preview-state-03.png`](media/preview-state-03.png) | `media/official-store-preview.mp4` | 520×1128 | 608459 | `3f0de18146cbc9d22ebd34ab00831b6381e8ae97f7911c057df5d45f37cf3402` |

## Discovery-to-open journey

**Actor:** Prospective mobile-app user evaluating a store listing before installation.  
**Goal:** Discover Strava: Run, Bike, Hike (Apple App Store), inspect its product media and listing details, recover from a navigation overshoot, and return to the product header ready for the next store decision.
