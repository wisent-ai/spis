# Brave Private Web Browser, VPN (Google Play)

**Evidence status:** complete  
**Product URL:** [https://play.google.com/store/apps/details?id=com.brave.browser](https://play.google.com/store/apps/details?id=com.brave.browser)  
**Category:** Google Play — Communication  
**Upstream owner:** Brave Software  
**Captured:** 2026-08-16T23:38:46Z

Study the acquisition stack of privacy-led naming, shield iconography, feature comparison claims, browser interface evidence, data-safety information, and release notes.

## Authentic local motion

| Local asset | Kind | Dimensions | Duration / frames | Bytes | SHA-256 | Provenance |
|---|---|---:|---:|---:|---|---|
| [`media/listing-interaction.webm`](media/listing-interaction.webm) | webm | 1280×720 | 18.08 s / 452 frames | 1026198 | `6e6ee984a63a3db7d42055dca8ac537732c85a7230bceda394f2e1336f9f9b68` | [source](https://play.google.com/store/apps/details?id=com.brave.browser) |
...
|---:|---|---|---|---:|---:|---|
| 1 | listing-open | [`media/listing-state-01.png`](media/listing-state-01.png) | `media/listing-interaction.webm` | 1920×1080 | 295127 | `5e42fd8744dd775bd506c84adac644f62c8ce125901de40594d66d49c3982163` |
| 2 | media-shelf | [`media/listing-state-02.png`](media/listing-state-02.png) | `media/listing-interaction.webm` | 1920×1080 | 336371 | `24ed7b0dee9f5484886befd8282560f565892e54cb68e57ddfe6972c07e56196` |
| 3 | media-selected | [`media/listing-state-03.png`](media/listing-state-03.png) | `media/listing-interaction.webm` | 1920×1080 | 242290 | `01daacebcf5446be0f967f6699e45fb522a3b23501c2e239f79c24c303970657` |
| 4 | details-reached | [`media/listing-state-04.png`](media/listing-state-04.png) | `media/listing-interaction.webm` | 1920×1080 | 178316 | `afef81cf8f480981d50cb89f48c4708b32c8239d4c99a758554ffd202d295811` |
| 5 | target-overshot | [`media/listing-state-05.png`](media/listing-state-05.png) | `media/listing-interaction.webm` | 1920×1080 | 145975 | `9058465f58fcf255569d67e86293e4c37a8a603dcd62a63d4c043bb48d37e6f9` |
| 6 | recovered-to-media | [`media/listing-state-06.png`](media/listing-state-06.png) | `media/listing-interaction.webm` | 1920×1080 | 197598 | `69d4f8d12742e4f1fa2a6db56fa2bf5b2bb7b49956fbbc734a256a01b840f41c` |
| 7 | returned-to-header | [`media/listing-state-07.png`](media/listing-state-07.png) | `media/listing-interaction.webm` | 1920×1080 | 197594 | `743c2365d4da12bc5295a0d6257c343a2bc0f151e5995295591dc9ea634ef89a` |

## Discovery-to-open journey

**Actor:** Prospective mobile-app user evaluating a store listing before installation.  
**Goal:** Discover Brave Private Web Browser, VPN (Google Play), inspect its product media and listing details, recover from a navigation overshoot, and return to the product header ready for the next store decision.
