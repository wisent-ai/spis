...
**Product:** [https://github.com/meli/meli](https://github.com/meli/meli)  
...
`agg media/product-motion.cast /tmp/meli.gif` then play `/tmp/meli.gif`

This is authentic product motion, not an animation synthesized from the catalog still. Source: [https://github.com/meli/meli](https://github.com/meli/meli). Local SHA-256: `aa4bf980982de7bd483fc9369c768bea93cf0ac5416b41490d2ba6840604d400`. Duration: 5.106s; frames/output events: 66; bytes: 68934; dimensions: terminal columns in cast header × terminal rows in cast header.

## Key states

### first stable surface

![meli — first stable surface](media/state-1.png)
...
![meli — selection or detail transition](media/state-2.png)

Derived directly from `media/product-motion.cast`; 983×694, 33801 bytes, SHA-256 `ffec074ffbe6ee9b29804d09584863c905aa659ab9b4786cfab78b34a05b13b4`.

### help, recovery, or completion

![meli — help, recovery, or completion](media/state-3.png)

Derived directly from `media/product-motion.cast`; 983×694, 57260 bytes, SHA-256 `0c18d9d2053b107a62c9d39b859666287200bf106d375ce6f5fe38e3a6d69ff5`.

## First-success journey

**Actor:** Keyboard user evaluating the real terminal application  
**Goal:** Reach the first inspectable mail result in meli, discover controls, and recover from a blocked or transient state  

| State | User action | System response | Evidence |
|---:|---|---|---|
| 1 | Launch meli with the recorded prerequisite/fixture | The application claims the terminal and begins its first render | isolated real-program terminal cast at the opening segment |
...
- Upstream owner: `meli`
- Source/capture URL: https://github.com/meli/meli
