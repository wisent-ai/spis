...
**Product:** [https://github.com/yorukot/superfile](https://github.com/yorukot/superfile)  
...
This is authentic product motion, not an animation synthesized from the catalog still. Source: [https://raw.githubusercontent.com/yorukot/superfile/HEAD/asset/readme/demo.gif](https://raw.githubusercontent.com/yorukot/superfile/HEAD/asset/readme/demo.gif). Local SHA-256: `59b36e8ede8740dc8c10ea1667f693c1c4a87199c94e5c289708103407a4cc1e`. Duration: 27.240s; frames/output events: 681; bytes: 2218447; dimensions: 1920 × 1080.

## Key states

### first stable surface

![Superfile — first stable surface](media/state-1.png)

Derived directly from `media/product-motion.gif`; 1920×1080, 11148 bytes, SHA-256 `14ba3b400cf7fabdab39bf3df6dae41b83cfcc707f526f9bb383dc0bbcd2f3c6`.

### selection or detail transition

![Superfile — selection or detail transition](media/state-2.png)

Derived directly from `media/product-motion.gif`; 1920×1080, 259378 bytes, SHA-256 `0b4be36aa790ac801f55a62896a3ba9d794471080349669d100fabd2d3b7873e`.

### help, recovery, or completion

![Superfile — help, recovery, or completion](media/state-3.png)

Derived directly from `media/product-motion.gif`; 1920×1080, 19724 bytes, SHA-256 `7866ca219c030f5132edf64f43ae6c2d60fd2931f0c6d4bc923789673ce5a73e`.

## First-success journey

**Actor:** Keyboard user evaluating the real terminal application  
**Goal:** Reach the first inspectable file management result in Superfile, discover controls, and recover from a blocked or transient state  

| State | User action | System response | Evidence |
|---:|---|---|---|
| 1 | Launch Superfile with the recorded prerequisite/fixture | The application claims the terminal and begins its first render | official upstream motion at the opening segment |
...
- Upstream owner: `yorukot`
- Source/capture URL: https://raw.githubusercontent.com/yorukot/superfile/HEAD/asset/readme/demo.gif
