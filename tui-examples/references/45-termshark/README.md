...
**Product:** [https://github.com/gcla/termshark](https://github.com/gcla/termshark)  
...
This is authentic product motion, not an animation synthesized from the catalog still. Source: [https://raw.githubusercontent.com/gcla/termshark/gh-pages/images/demo4.gif](https://raw.githubusercontent.com/gcla/termshark/gh-pages/images/demo4.gif). Local SHA-256: `73be1d6aee05bd72f116991f4c33c2c100a1d3c637a45be83115fde1821c9bc6`. Duration: 43.330s; frames/output events: 99; bytes: 4337769; dimensions: 724 × 590.

## Key states

### first stable surface

![Termshark — first stable surface](media/state-1.png)

Derived directly from `media/product-motion.gif`; 724×590, 44785 bytes, SHA-256 `dc61099d60112bb27995a2ed5c304d648061573acb22a99be1c06a1ac54e2f43`.

### selection or detail transition

![Termshark — selection or detail transition](media/state-2.png)

Derived directly from `media/product-motion.gif`; 724×590, 61252 bytes, SHA-256 `a25c43e3829a53e90ae0fcdce0a56365752837256afc9229d711ae9afc852408`.

### help, recovery, or completion

![Termshark — help, recovery, or completion](media/state-3.png)

Derived directly from `media/product-motion.gif`; 724×590, 71093 bytes, SHA-256 `4574bb12393f8dff6438af5249fd2a850e79675ad2386f754146bc26646dafb3`.

## First-success journey

**Actor:** Keyboard user evaluating the real terminal application  
**Goal:** Reach the first inspectable networking result in Termshark, discover controls, and recover from a blocked or transient state  

| State | User action | System response | Evidence |
|---:|---|---|---|
| 1 | Launch Termshark with the recorded prerequisite/fixture | The application claims the terminal and begins its first render | official upstream motion at the opening segment |
...
- Upstream owner: `gcla`
- Source/capture URL: https://raw.githubusercontent.com/gcla/termshark/gh-pages/images/demo4.gif
