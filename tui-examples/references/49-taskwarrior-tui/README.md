...
**Product:** [https://github.com/kdheepak/taskwarrior-tui](https://github.com/kdheepak/taskwarrior-tui)  
...
This is authentic product motion, not an animation synthesized from the catalog still. Source: [https://github.com/user-attachments/assets/a3c4f79b-3967-4904-b614-8bbd500c54c2](https://github.com/user-attachments/assets/a3c4f79b-3967-4904-b614-8bbd500c54c2). Local SHA-256: `910bdbcb04871066792415804930f63859e66d28dc325c96562285e45ebeeea9`. Duration: 86.600s; frames/output events: 2165; bytes: 2675278; dimensions: 1160 × 820.

## Key states

### first stable surface

![taskwarrior-tui — first stable surface](media/state-1.png)

Derived directly from `media/product-motion.mp4`; 1160×820, 272847 bytes, SHA-256 `0ffa4f846065f72bdfb0433d6faa17c5aa2ce00dd9540609ae756c03186c1b30`.

### selection or detail transition

![taskwarrior-tui — selection or detail transition](media/state-2.png)

Derived directly from `media/product-motion.mp4`; 1160×820, 312395 bytes, SHA-256 `d5560f9b194b3586d98c11c99b37da1a4818e96e80d550858c408758cec591de`.

### help, recovery, or completion

![taskwarrior-tui — help, recovery, or completion](media/state-3.png)

Derived directly from `media/product-motion.mp4`; 1160×820, 169725 bytes, SHA-256 `5302b5799475e0c2301882c1503abd45af55e4b6a4c5379489719bb4f7c1e636`.

## First-success journey

**Actor:** Keyboard user evaluating the real terminal application  
**Goal:** Reach the first inspectable tasks result in taskwarrior-tui, discover controls, and recover from a blocked or transient state  

| State | User action | System response | Evidence |
|---:|---|---|---|
| 1 | Launch taskwarrior-tui with the recorded prerequisite/fixture | The application claims the terminal and begins its first render | official upstream motion at the opening segment |
...
- Upstream owner: `kdheepak`
- Source/capture URL: https://github.com/user-attachments/assets/a3c4f79b-3967-4904-b614-8bbd500c54c2
