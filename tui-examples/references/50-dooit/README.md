...
**Product:** [https://github.com/kraanzu/dooit](https://github.com/kraanzu/dooit)  
...
`agg media/product-motion.cast /tmp/dooit.gif` then play `/tmp/dooit.gif`

This is authentic product motion, not an animation synthesized from the catalog still. Source: [https://github.com/kraanzu/dooit](https://github.com/kraanzu/dooit). Local SHA-256: `931376c489a372751a785029e129cc252e550f4b586e39cea5400d720b7f90c6`. Duration: 7.482s; frames/output events: 119; bytes: 133448; dimensions: terminal columns in cast header × terminal rows in cast header.

## Key states

### first stable surface

![Dooit — first stable surface](media/state-1.png)
...
![Dooit — selection or detail transition](media/state-2.png)

Derived directly from `media/product-motion.cast`; 983×694, 4155 bytes, SHA-256 `c8c513bd24479d0794c2458f93988f6efd1654561d52956d5fd3128e13363310`.

### help, recovery, or completion

![Dooit — help, recovery, or completion](media/state-3.png)

Derived directly from `media/product-motion.cast`; 983×694, 9277 bytes, SHA-256 `0381250ef5643691138c85a470bb6e5f98da9121a5b67eacf88097b46c534f5c`.

## First-success journey

**Actor:** Keyboard user evaluating the real terminal application  
**Goal:** Reach the first inspectable tasks result in Dooit, discover controls, and recover from a blocked or transient state  

| State | User action | System response | Evidence |
|---:|---|---|---|
| 1 | Launch Dooit with the recorded prerequisite/fixture | The application claims the terminal and begins its first render | isolated real-program terminal cast at the opening segment |
...
- Upstream owner: `kraanzu`
- Source/capture URL: https://github.com/kraanzu/dooit
