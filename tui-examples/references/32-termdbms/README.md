...
**Product:** [https://github.com/mathaou/termdbms](https://github.com/mathaou/termdbms)  
...
This is authentic product motion, not an animation synthesized from the catalog still. Source: [https://i.imgur.com/vmK0DVn.gif](https://i.imgur.com/vmK0DVn.gif). Local SHA-256: `fde9d7d2fbaab802df02558ea69e6cc68bf0ab6a79189f73d2cc2b82a740c4e2`. Duration: 11.140s; frames/output events: 167; bytes: 539274; dimensions: 901 × 453.

## Key states

### first stable surface

![Termdbms — first stable surface](media/state-1.png)

Derived directly from `media/product-motion.gif`; 901×453, 53017 bytes, SHA-256 `969d41b1d1c4b6a524ac35cc63f3652f4bdd0d2b4dbcbb0a5be8151930a616d1`.

### selection or detail transition

![Termdbms — selection or detail transition](media/state-2.png)

Derived directly from `media/product-motion.gif`; 901×453, 53789 bytes, SHA-256 `ae8f99328120f340986877ccb88922889a44f7513ece318d27789aa61e951fa9`.

### help, recovery, or completion

![Termdbms — help, recovery, or completion](media/state-3.png)

Derived directly from `media/product-motion.gif`; 901×453, 57756 bytes, SHA-256 `dc2ef4273bab0febf21bd4ceafadd25ac71f04b5cd2ca238d78c216b30fc4444`.

## First-success journey

**Actor:** Keyboard user evaluating the real terminal application  
**Goal:** Reach the first inspectable databases result in Termdbms, discover controls, and recover from a blocked or transient state  

| State | User action | System response | Evidence |
|---:|---|---|---|
| 1 | Launch Termdbms with the recorded prerequisite/fixture | The application claims the terminal and begins its first render | official upstream motion at the opening segment |
...
- Upstream owner: `mathaou`
- Source/capture URL: https://i.imgur.com/vmK0DVn.gif
