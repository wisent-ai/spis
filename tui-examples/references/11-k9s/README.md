...
**Product:** [https://github.com/derailed/k9s](https://github.com/derailed/k9s)  
...
`agg media/product-motion.cast /tmp/k9s.gif` then play `/tmp/k9s.gif`

This is authentic product motion, not an animation synthesized from the catalog still. Source: [https://asciinema.org/a/UbXKPal6IWpTaVAjBBFmizcGN.cast](https://asciinema.org/a/UbXKPal6IWpTaVAjBBFmizcGN.cast). Local SHA-256: `2d9ef3a5092efe7640f11c3efeb1809df10018e13e0e35a11f7b0f78bb8a5d01`. Duration: 62.545s; frames/output events: 445; bytes: 448050; dimensions: terminal columns in cast header × terminal rows in cast header.

## Key states

### first stable surface

![K9s — first stable surface](media/state-1.png)

Derived directly from `media/product-motion.cast`; 983×694, 5774 bytes, SHA-256 `945a9347e6a583aa8bccf6b7b26bddcd19242b973498281627814bda383f859f`.

### selection or detail transition

![K9s — selection or detail transition](media/state-2.png)

Derived directly from `media/product-motion.cast`; 983×694, 55578 bytes, SHA-256 `db4f5f536e76da357ed5ab0f87cb1d6db803d16617eee67587b3a90a7019a336`.

### help, recovery, or completion

![K9s — help, recovery, or completion](media/state-3.png)

Derived directly from `media/product-motion.cast`; 983×694, 19775 bytes, SHA-256 `d9ed55743a3422d55e4141b28e4ad8dc1c27e91b0f2d78d1b6ca6aee91ac5e8f`.

## First-success journey

**Actor:** Keyboard user evaluating the real terminal application  
**Goal:** Reach the first inspectable kubernetes result in K9s, discover controls, and recover from a blocked or transient state  

| State | User action | System response | Evidence |
|---:|---|---|---|
| 1 | Launch K9s with the recorded prerequisite/fixture | The application claims the terminal and begins its first render | official upstream motion at the opening segment |
...
- Upstream owner: `derailed`
- Source/capture URL: https://asciinema.org/a/UbXKPal6IWpTaVAjBBFmizcGN.cast
