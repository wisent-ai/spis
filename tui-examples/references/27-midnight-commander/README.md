# 27 — Midnight Commander

**Product:** [https://github.com/MidnightCommander/mc](https://github.com/MidnightCommander/mc)  
...
`agg media/product-motion.cast /tmp/midnight-commander.gif` then play `/tmp/midnight-commander.gif`

This is authentic product motion, not an animation synthesized from the catalog still. Source: [https://github.com/MidnightCommander/mc](https://github.com/MidnightCommander/mc). Local SHA-256: `78507e49c126694d2ee3acfa725eaba2a46c1cfa7d15b620946497c71c84b72e`. Duration: 5.150s; frames/output events: 33; bytes: 22343; dimensions: terminal columns in cast header × terminal rows in cast header.

## Key states

### first stable surface

![Midnight Commander — first stable surface](media/state-1.png)
...
![Midnight Commander — selection or detail transition](media/state-2.png)

Derived directly from `media/product-motion.cast`; 983×694, 52786 bytes, SHA-256 `47bf01c5edd5ece67081ae53d9f28af2cb9d24fbacefce4928b0b6cde8d1454a`.

### help, recovery, or completion

![Midnight Commander — help, recovery, or completion](media/state-3.png)

Derived directly from `media/product-motion.cast`; 983×694, 53245 bytes, SHA-256 `c49aa8a6d88c186aca4811f3ccb9d2ed572e0afcba83d7df8bdc64f40fe847a0`.

## First-success journey

**Actor:** Keyboard user evaluating the real terminal application  
**Goal:** Reach the first inspectable file management result in Midnight Commander, discover controls, and recover from a blocked or transient state  

| State | User action | System response | Evidence |
|---:|---|---|---|
| 1 | Launch Midnight Commander with the recorded prerequisite/fixture | The application claims the terminal and begins its first render | isolated real-program terminal cast at the opening segment |
...
- Upstream owner: `MidnightCommander`
- Source/capture URL: https://github.com/MidnightCommander/mc
