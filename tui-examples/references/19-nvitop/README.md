...
**Product:** [https://github.com/XuehaiPan/nvitop](https://github.com/XuehaiPan/nvitop)  
...
This is authentic product motion, not an animation synthesized from the catalog still. Source: [https://user-images.githubusercontent.com/16078332/113173772-508dc380-927c-11eb-84c5-b6f496e54c08.gif](https://user-images.githubusercontent.com/16078332/113173772-508dc380-927c-11eb-84c5-b6f496e54c08.gif). Local SHA-256: `c06e135e1ce65de10b0a2710c5485ffc16d16d567059f0c5b6585540acb5a8fc`. Duration: 42.810s; frames/output events: 685; bytes: 7376422; dimensions: 1920 × 1080.

## Key states

### first stable surface

![nvitop — first stable surface](media/state-1.png)

Derived directly from `media/product-motion.gif`; 1920×1080, 132560 bytes, SHA-256 `47c3b95c1de4414342b165d58155d2c66044353243f9c7a9aecae595438f52fd`.

### selection or detail transition

![nvitop — selection or detail transition](media/state-2.png)

Derived directly from `media/product-motion.gif`; 1920×1080, 280077 bytes, SHA-256 `9ee82beb2e1fd738820d50d57b2406217021f08e06094f1d07ee6f81e3587a74`.

### help, recovery, or completion

![nvitop — help, recovery, or completion](media/state-3.png)

Derived directly from `media/product-motion.gif`; 1920×1080, 329764 bytes, SHA-256 `f96bcc525e7fb6f73a7258f2703c9c5ed3da8b595bea56fe503d96d928082ebe`.

## First-success journey

**Actor:** Keyboard user evaluating the real terminal application  
**Goal:** Reach the first inspectable system monitoring result in nvitop, discover controls, and recover from a blocked or transient state  

| State | User action | System response | Evidence |
|---:|---|---|---|
| 1 | Launch nvitop with the recorded prerequisite/fixture | The application claims the terminal and begins its first render | official upstream motion at the opening segment |
...
- Upstream owner: `XuehaiPan`
- Source/capture URL: https://user-images.githubusercontent.com/16078332/113173772-508dc380-927c-11eb-84c5-b6f496e54c08.gif
