...
**Product:** [https://github.com/htop-dev/htop](https://github.com/htop-dev/htop)  
...
`agg media/product-motion.cast /tmp/htop.gif` then play `/tmp/htop.gif`

This is authentic product motion, not an animation synthesized from the catalog still. Source: [https://github.com/htop-dev/htop](https://github.com/htop-dev/htop). Local SHA-256: `46838e222c544e26a2ea1c12c60bce4a5f272e094c300a9023894e5305783787`. Duration: 5.897s; frames/output events: 76; bytes: 22831; dimensions: terminal columns in cast header × terminal rows in cast header.

## Key states

### first stable surface

![htop — first stable surface](media/state-1.png)
...
![htop — selection or detail transition](media/state-2.png)

Derived directly from `media/product-motion.cast`; 983×694, 178758 bytes, SHA-256 `b5038aa0ccd9be33fa397098de31d96e75ce220873ac5b8970c0e43475c94e8a`.

### help, recovery, or completion

![htop — help, recovery, or completion](media/state-3.png)

Derived directly from `media/product-motion.cast`; 983×694, 179205 bytes, SHA-256 `97c76215fa0f359f02f90dc2c5bde9e23dae70f076e5953f574b57e37b0c1ca9`.

## First-success journey

**Actor:** Keyboard user evaluating the real terminal application  
**Goal:** Reach the first inspectable system monitoring result in htop, discover controls, and recover from a blocked or transient state  

| State | User action | System response | Evidence |
|---:|---|---|---|
| 1 | Launch htop with the recorded prerequisite/fixture | The application claims the terminal and begins its first render | isolated real-program terminal cast at the opening segment |
...
- Upstream owner: `htop-dev`
- Source/capture URL: https://github.com/htop-dev/htop
