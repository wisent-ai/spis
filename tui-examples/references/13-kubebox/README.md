...
**Product:** [https://github.com/astefanutti/kubebox](https://github.com/astefanutti/kubebox)  
...
`agg media/product-motion.cast /tmp/kubebox.gif` then play `/tmp/kubebox.gif`

This is authentic product motion, not an animation synthesized from the catalog still. Source: [https://github.com/astefanutti/kubebox](https://github.com/astefanutti/kubebox). Local SHA-256: `f30168f8c0d84810d37af4b2c75b64300b5345a1685acfa59f18a04e81433d74`. Duration: 5.124s; frames/output events: 12; bytes: 4362; dimensions: terminal columns in cast header × terminal rows in cast header.

## Key states

### first stable surface

![Kubebox — first stable surface](media/state-1.png)
...
![Kubebox — selection or detail transition](media/state-2.png)

Derived directly from `media/product-motion.cast`; 983×694, 19124 bytes, SHA-256 `3bdc04df51daa1060afd55ad2f59aea46f16c65160651beea0d072579b0d8f33`.

### help, recovery, or completion

![Kubebox — help, recovery, or completion](media/state-3.png)

Derived directly from `media/product-motion.cast`; 983×694, 20891 bytes, SHA-256 `482e4d55c9a3b9d48b6db8c1a9868099e3ed8962ba3e70d4ca1508689d71b060`.

## First-success journey

**Actor:** Keyboard user evaluating the real terminal application  
**Goal:** Reach the first inspectable kubernetes result in Kubebox, discover controls, and recover from a blocked or transient state  

| State | User action | System response | Evidence |
|---:|---|---|---|
| 1 | Launch Kubebox with the recorded prerequisite/fixture | The application claims the terminal and begins its first render | isolated real-program terminal cast at the opening segment |
...
- Upstream owner: `astefanutti`
- Source/capture URL: https://github.com/astefanutti/kubebox
