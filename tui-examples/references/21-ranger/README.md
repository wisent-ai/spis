...
**Product:** [https://github.com/ranger/ranger](https://github.com/ranger/ranger)  
...
`agg media/product-motion.cast /tmp/ranger.gif` then play `/tmp/ranger.gif`

This is authentic product motion, not an animation synthesized from the catalog still. Source: [https://github.com/ranger/ranger](https://github.com/ranger/ranger). Local SHA-256: `19a033affea40e24bb3adb63d7dda9652437309d0019d4af4721ec0d7bef3165`. Duration: 5.120s; frames/output events: 17; bytes: 4568; dimensions: terminal columns in cast header × terminal rows in cast header.

## Key states

### first stable surface

![Ranger — first stable surface](media/state-1.png)

Derived directly from `media/product-motion.cast`; 983×694, 17492 bytes, SHA-256 `222d72ace8fc3786b0bdce8da1585b8a9348218207d4b47bc7a6dc178732d1dd`.

### selection or detail transition

![Ranger — selection or detail transition](media/state-2.png)

Derived directly from `media/product-motion.cast`; 983×694, 16137 bytes, SHA-256 `ea62abcfa1868d088178c7047a7e4334dff2ece4ee0fbc69839f1908cb32e5c5`.

### help, recovery, or completion

![Ranger — help, recovery, or completion](media/state-3.png)

Derived directly from `media/product-motion.cast`; 983×694, 29491 bytes, SHA-256 `eb273f1cb4da43470e7c502913f3423ceb18e3b3e131b3f233fcfead1355533b`.

## First-success journey

**Actor:** Keyboard user evaluating the real terminal application  
**Goal:** Reach the first inspectable file management result in Ranger, discover controls, and recover from a blocked or transient state  

| State | User action | System response | Evidence |
|---:|---|---|---|
| 1 | Launch Ranger with the recorded prerequisite/fixture | The application claims the terminal and begins its first render | isolated real-program terminal cast at the opening segment |
...
- Upstream owner: `ranger`
- Source/capture URL: https://github.com/ranger/ranger
