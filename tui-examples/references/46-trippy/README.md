...
**Product:** [https://github.com/fujiapple852/trippy](https://github.com/fujiapple852/trippy)  
...
This is authentic product motion, not an animation synthesized from the catalog still. Source: [https://raw.githubusercontent.com/fujiapple852/trippy/master/assets/0.12.0/demo.gif](https://raw.githubusercontent.com/fujiapple852/trippy/master/assets/0.12.0/demo.gif). Local SHA-256: `caf622a95c726be47bffd6ce1af94d9c75bda366866083c8aa19c1060f0d8f2d`. Duration: 16.560s; frames/output events: 497; bytes: 2160468; dimensions: 1700 × 1370.

## Key states

### first stable surface

![Trippy — first stable surface](media/state-1.png)

Derived directly from `media/product-motion.gif`; 1700×1370, 127321 bytes, SHA-256 `5cfcbf569b296fc34e6c49d05aad4365090f24eaa6dddced88c92fbc2b815921`.

### selection or detail transition

![Trippy — selection or detail transition](media/state-2.png)

Derived directly from `media/product-motion.gif`; 1700×1370, 86591 bytes, SHA-256 `586eac81ef755138ff69b0eab34c5f7b40d0b75cdf25ce69ef729d722dcaa73f`.

### help, recovery, or completion

![Trippy — help, recovery, or completion](media/state-3.png)

Derived directly from `media/product-motion.gif`; 1700×1370, 80227 bytes, SHA-256 `33232b3a999a5d3747f62f7c9f614182174d3717c9cda3e1c866764d98b8cce9`.

## First-success journey

**Actor:** Keyboard user evaluating the real terminal application  
**Goal:** Reach the first inspectable networking result in Trippy, discover controls, and recover from a blocked or transient state  

| State | User action | System response | Evidence |
|---:|---|---|---|
| 1 | Launch Trippy with the recorded prerequisite/fixture | The application claims the terminal and begins its first render | official upstream motion at the opening segment |
...
- Upstream owner: `fujiapple852`
- Source/capture URL: https://raw.githubusercontent.com/fujiapple852/trippy/master/assets/0.12.0/demo.gif
