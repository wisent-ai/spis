...
**Product:** [https://github.com/neomutt/neomutt](https://github.com/neomutt/neomutt)  
...
`agg media/product-motion.cast /tmp/neomutt.gif` then play `/tmp/neomutt.gif`

This is authentic product motion, not an animation synthesized from the catalog still. Source: [https://github.com/neomutt/neomutt](https://github.com/neomutt/neomutt). Local SHA-256: `99c0c509cfd57e2aa72512f7a46d7b38943209c26f680fe60f4a9fa8d174360e`. Duration: 5.370s; frames/output events: 22; bytes: 5072; dimensions: terminal columns in cast header × terminal rows in cast header.

## Key states

### first stable surface

![NeoMutt — first stable surface](media/state-1.png)

Derived directly from `media/product-motion.cast`; 983×694, 9231 bytes, SHA-256 `346fa7a7284a1e9e73c391d97b363f5b0b3da34fdcf1f1c161b99c38b429ec16`.

### selection or detail transition

![NeoMutt — selection or detail transition](media/state-2.png)

Derived directly from `media/product-motion.cast`; 983×694, 20003 bytes, SHA-256 `6a4756c16a2af896a509d158b96727a8fb65e8d02dd28c4ca9d4f6301cdbb294`.

### help, recovery, or completion

![NeoMutt — help, recovery, or completion](media/state-3.png)

Derived directly from `media/product-motion.cast`; 983×694, 93378 bytes, SHA-256 `8e48f1ca0dfc3f92874c16c17783ff951337ba2c51bef658a818ab63c2c38ba0`.

## First-success journey

**Actor:** Keyboard user evaluating the real terminal application  
**Goal:** Reach the first inspectable mail result in NeoMutt, discover controls, and recover from a blocked or transient state  

| State | User action | System response | Evidence |
|---:|---|---|---|
| 1 | Launch NeoMutt with the recorded prerequisite/fixture | The application claims the terminal and begins its first render | isolated real-program terminal cast at the opening segment |
...
- Upstream owner: `neomutt`
- Source/capture URL: https://github.com/neomutt/neomutt
