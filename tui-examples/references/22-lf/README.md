...
**Product:** [https://github.com/gokcehan/lf](https://github.com/gokcehan/lf)  
...
`agg media/product-motion.cast /tmp/lf.gif` then play `/tmp/lf.gif`

This is authentic product motion, not an animation synthesized from the catalog still. Source: [https://github.com/gokcehan/lf](https://github.com/gokcehan/lf). Local SHA-256: `51f0bd9af848988f9c97f386e0fd755d1043821d8a8352db1214002e9d4ed636`. Duration: 7.496s; frames/output events: 31; bytes: 11493; dimensions: terminal columns in cast header × terminal rows in cast header.

## Key states

### first stable surface

![lf — first stable surface](media/state-1.png)
...
![lf — selection or detail transition](media/state-2.png)

Derived directly from `media/product-motion.cast`; 983×694, 29017 bytes, SHA-256 `232978afc198c803c22a21948bf992a17126060409fd361ee6b8a172b083f01f`.

### help, recovery, or completion

![lf — help, recovery, or completion](media/state-3.png)

Derived directly from `media/product-motion.cast`; 983×694, 29550 bytes, SHA-256 `8ef0fcb3a764b7a5ce9f27fea7ce14f336b85bfd7b1cca8e929ea974d99e9663`.

## First-success journey

**Actor:** Keyboard user evaluating the real terminal application  
**Goal:** Reach the first inspectable file management result in lf, discover controls, and recover from a blocked or transient state  

| State | User action | System response | Evidence |
|---:|---|---|---|
| 1 | Launch lf with the recorded prerequisite/fixture | The application claims the terminal and begins its first render | isolated real-program terminal cast at the opening segment |
...
- Upstream owner: `gokcehan`
- Source/capture URL: https://github.com/gokcehan/lf
