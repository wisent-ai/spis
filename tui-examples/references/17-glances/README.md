...
**Product:** [https://github.com/nicolargo/glances](https://github.com/nicolargo/glances)  
...
`agg media/product-motion.cast /tmp/glances.gif` then play `/tmp/glances.gif`

This is authentic product motion, not an animation synthesized from the catalog still. Source: [https://github.com/nicolargo/glances](https://github.com/nicolargo/glances). Local SHA-256: `ccd5c5cd11bb4b103ae776929863cdc40e96ee07677af83b8454cb2d8686c120`. Duration: 4.358s; frames/output events: 14; bytes: 11294; dimensions: terminal columns in cast header × terminal rows in cast header.

## Key states

### first stable surface

![Glances — first stable surface](media/state-1.png)
...
![Glances — selection or detail transition](media/state-2.png)
...
![Glances — help, recovery, or completion](media/state-3.png)

Derived directly from `media/product-motion.cast`; 983×694, 91286 bytes, SHA-256 `ae6d65066d6e73c541288daf99a548f807fa0301b046f2d69ceb003bf534792e`.

## First-success journey

**Actor:** Keyboard user evaluating the real terminal application  
**Goal:** Reach the first inspectable system monitoring result in Glances, discover controls, and recover from a blocked or transient state  

| State | User action | System response | Evidence |
|---:|---|---|---|
| 1 | Launch Glances with the recorded prerequisite/fixture | The application claims the terminal and begins its first render | isolated real-program terminal cast at the opening segment |
...
- Upstream owner: `nicolargo`
- Source/capture URL: https://github.com/nicolargo/glances
