...
**Product:** [https://github.com/laixintao/iredis](https://github.com/laixintao/iredis)  
...
`agg media/product-motion.cast /tmp/iredis.gif` then play `/tmp/iredis.gif`

This is authentic product motion, not an animation synthesized from the catalog still. Source: [https://github.com/laixintao/iredis/blob/HEAD/docs/assets/demo.cast](https://github.com/laixintao/iredis/blob/HEAD/docs/assets/demo.cast). Local SHA-256: `6397f74097ce9e5fec46b763690139fa956c2e862b7e7a2b8e14cb8d75667b0b`. Duration: 67.726s; frames/output events: 385; bytes: 93477; dimensions: terminal columns in cast header × terminal rows in cast header.

## Key states

### first stable surface

![iredis — first stable surface](media/state-1.png)

Derived directly from `media/product-motion.cast`; 983×694, 16071 bytes, SHA-256 `daf02064a1fc1f11bc9419a5e3f3dbad44dd56d9cb6392e0bcac0d55de309ee8`.

### selection or detail transition

![iredis — selection or detail transition](media/state-2.png)

Derived directly from `media/product-motion.cast`; 983×694, 50684 bytes, SHA-256 `fcfecca1058fb9150907d5160e6e515c438a9ab9521ea99c7ed3592cb41b2a97`.

### help, recovery, or completion

![iredis — help, recovery, or completion](media/state-3.png)

Derived directly from `media/product-motion.cast`; 983×694, 51309 bytes, SHA-256 `ae3de8bf31aa3d9db3f24d6cbb7b2061a6e9e2a59c67c4b78a1a75e495d8ebd3`.

## First-success journey

**Actor:** Keyboard user evaluating the real terminal application  
**Goal:** Reach the first inspectable databases result in iredis, discover controls, and recover from a blocked or transient state  

| State | User action | System response | Evidence |
|---:|---|---|---|
| 1 | Launch iredis with the recorded prerequisite/fixture | The application claims the terminal and begins its first render | official upstream motion at the opening segment |
...
- Upstream owner: `laixintao`
- Source/capture URL: https://github.com/laixintao/iredis/blob/HEAD/docs/assets/demo.cast
