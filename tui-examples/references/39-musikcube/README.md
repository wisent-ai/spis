...
**Product:** [https://github.com/clangen/musikcube](https://github.com/clangen/musikcube)  
...
`agg media/product-motion.cast /tmp/musikcube.gif` then play `/tmp/musikcube.gif`

This is authentic product motion, not an animation synthesized from the catalog still. Source: [https://asciinema.org/a/129748.cast](https://asciinema.org/a/129748.cast). Local SHA-256: `171784a0c6b3c15895d0b9d983c96249c6dd34f6266723ed46d4b47da7292af2`. Duration: 186.703s; frames/output events: 1055; bytes: 679854; dimensions: terminal columns in cast header × terminal rows in cast header.

## Key states

### first stable surface

![musikcube — first stable surface](media/state-1.png)

Derived directly from `media/product-motion.cast`; 983×694, 46525 bytes, SHA-256 `efdd10c87f696a9aa085c7bdca81151ad4a1f91553c68a5201a54640c898b7e0`.

### selection or detail transition

![musikcube — selection or detail transition](media/state-2.png)

Derived directly from `media/product-motion.cast`; 983×694, 60341 bytes, SHA-256 `aec4ac7928c2a833a4e6973c5f91743bc47c01536061f755bc91ac41852bb518`.

### help, recovery, or completion

![musikcube — help, recovery, or completion](media/state-3.png)

Derived directly from `media/product-motion.cast`; 983×694, 97232 bytes, SHA-256 `4da95f00174aed9efe60cd77b09d1442a075eb449a4202f8d682a9418aaea6fd`.

## First-success journey

**Actor:** Keyboard user evaluating the real terminal application  
**Goal:** Reach the first inspectable music result in musikcube, discover controls, and recover from a blocked or transient state  

| State | User action | System response | Evidence |
|---:|---|---|---|
| 1 | Launch musikcube with the recorded prerequisite/fixture | The application claims the terminal and begins its first render | official upstream motion at the opening segment |
...
- Upstream owner: `clangen`
- Source/capture URL: https://asciinema.org/a/129748.cast
