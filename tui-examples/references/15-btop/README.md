...
**Product:** [https://github.com/aristocratos/btop](https://github.com/aristocratos/btop)  
...
`agg media/product-motion.cast /tmp/btop.gif` then play `/tmp/btop.gif`

This is authentic product motion, not an animation synthesized from the catalog still. Source: [https://github.com/aristocratos/btop](https://github.com/aristocratos/btop). Local SHA-256: `1df65d5f2f7782d9d3c315aa98941a220c8d0fa9effd2879433c235e46bf53dc`. Duration: 6.626s; frames/output events: 155; bytes: 193227; dimensions: terminal columns in cast header × terminal rows in cast header.

## Key states

### first stable surface

![btop — first stable surface](media/state-1.png)

Derived directly from `media/product-motion.cast`; 983×694, 3558 bytes, SHA-256 `23eaca15eba8fdd8692b2cd468ef22641fecf84e1d341269a22a706f59ce5d19`.

### selection or detail transition

![btop — selection or detail transition](media/state-2.png)

Derived directly from `media/product-motion.cast`; 983×694, 92292 bytes, SHA-256 `473b207a01b60a208dfcd70c56bcfd6afe5650d34cc2e913bd54f6c48b0dae65`.

### help, recovery, or completion

![btop — help, recovery, or completion](media/state-3.png)

Derived directly from `media/product-motion.cast`; 983×694, 129917 bytes, SHA-256 `51504d99a68a11e645f1757b7bf6a133bb76f4ebaeec0d885044399f2757f205`.

## First-success journey

**Actor:** Keyboard user evaluating the real terminal application  
**Goal:** Reach the first inspectable system monitoring result in btop, discover controls, and recover from a blocked or transient state  

| State | User action | System response | Evidence |
|---:|---|---|---|
| 1 | Launch btop with the recorded prerequisite/fixture | The application claims the terminal and begins its first render | isolated real-program terminal cast at the opening segment |
...
- Upstream owner: `aristocratos`
- Source/capture URL: https://github.com/aristocratos/btop
