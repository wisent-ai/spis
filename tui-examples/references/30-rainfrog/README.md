...
**Product:** [https://github.com/achristmascarl/rainfrog](https://github.com/achristmascarl/rainfrog)  
...
This is authentic product motion, not an animation synthesized from the catalog still. Source: [https://raw.githubusercontent.com/achristmascarl/rainfrog/HEAD/vhs/demo.gif](https://raw.githubusercontent.com/achristmascarl/rainfrog/HEAD/vhs/demo.gif). Local SHA-256: `b9e60c669f96864003d405d137aede615c8cd5f4d52b3e7b5f14280f49ce5b72`. Duration: 65.200s; frames/output events: 1630; bytes: 3501463; dimensions: 1800 × 1000.

## Key states

### first stable surface

![Rainfrog — first stable surface](media/state-1.png)

Derived directly from `media/product-motion.gif`; 1800×1000, 12495 bytes, SHA-256 `b9d941fd75928ede76cb3e8174355ae4e020eed0299afaea95b144e7c9d1dde1`.

### selection or detail transition

![Rainfrog — selection or detail transition](media/state-2.png)

Derived directly from `media/product-motion.gif`; 1800×1000, 376042 bytes, SHA-256 `76ad1ba6107df4db74b1278582431fece65c0c4211b31307da0242f803b08a0c`.

### help, recovery, or completion

![Rainfrog — help, recovery, or completion](media/state-3.png)

Derived directly from `media/product-motion.gif`; 1800×1000, 195319 bytes, SHA-256 `ea6b1ce7e47a3514e8724a8d1af3f2470f1cb76fab045056220311dd64c11a90`.

## First-success journey

**Actor:** Keyboard user evaluating the real terminal application  
**Goal:** Reach the first inspectable databases result in Rainfrog, discover controls, and recover from a blocked or transient state  

| State | User action | System response | Evidence |
|---:|---|---|---|
| 1 | Launch Rainfrog with the recorded prerequisite/fixture | The application claims the terminal and begins its first render | official upstream motion at the opening segment |
...
- Upstream owner: `achristmascarl`
- Source/capture URL: https://raw.githubusercontent.com/achristmascarl/rainfrog/HEAD/vhs/demo.gif
