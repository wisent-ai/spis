...
**Product:** [https://github.com/pazz/alot](https://github.com/pazz/alot)  
...
`agg media/product-motion.cast /tmp/alot.gif` then play `/tmp/alot.gif`

This is authentic product motion, not an animation synthesized from the catalog still. Source: [https://github.com/pazz/alot](https://github.com/pazz/alot). Local SHA-256: `4e8e6c181617fc4a6051b23a7916f7150fefb010deec926911e367d70743eace`. Duration: 4.344s; frames/output events: 11; bytes: 6460; dimensions: terminal columns in cast header × terminal rows in cast header.

## Key states

### first stable surface

![alot — first stable surface](media/state-1.png)
...
![alot — selection or detail transition](media/state-2.png)

Derived directly from `media/product-motion.cast`; 983×694, 12977 bytes, SHA-256 `29facfbbb164f39ec0bd40f5cff5a5b29cb5ccb7e8a8e1f2f95467c3709a24c8`.

### help, recovery, or completion

![alot — help, recovery, or completion](media/state-3.png)

Derived directly from `media/product-motion.cast`; 983×694, 44906 bytes, SHA-256 `8e721a9f1a32bab81cb1db37aef92743f14f5ec04320151b912264104a248759`.

## First-success journey

**Actor:** Keyboard user evaluating the real terminal application  
**Goal:** Reach the first inspectable mail result in alot, discover controls, and recover from a blocked or transient state  

| State | User action | System response | Evidence |
|---:|---|---|---|
| 1 | Launch alot with the recorded prerequisite/fixture | The application claims the terminal and begins its first render | isolated real-program terminal cast at the opening segment |
...
- Upstream owner: `pazz`
- Source/capture URL: https://github.com/pazz/alot
