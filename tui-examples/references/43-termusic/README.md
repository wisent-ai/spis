...
**Product:** [https://github.com/tramhao/termusic](https://github.com/tramhao/termusic)  
...
`agg media/product-motion.cast /tmp/termusic.gif` then play `/tmp/termusic.gif`

This is authentic product motion, not an animation synthesized from the catalog still. Source: [https://github.com/tramhao/termusic](https://github.com/tramhao/termusic). Local SHA-256: `971914c4c865ff949945e5092b4c6ee57e2f75a9245c310412ac2fbe1fd8c35b`. Duration: 7.161s; frames/output events: 28; bytes: 10991; dimensions: terminal columns in cast header × terminal rows in cast header.

## Key states

### first stable surface

![Termusic — first stable surface](media/state-1.png)
...
![Termusic — selection or detail transition](media/state-2.png)

Derived directly from `media/product-motion.cast`; 983×694, 29654 bytes, SHA-256 `303f0a51846cfd7b3a4f96ecb18dcb392dd0ad2cc11a2788d4fc9ea7fa2e3537`.

### help, recovery, or completion

![Termusic — help, recovery, or completion](media/state-3.png)

Derived directly from `media/product-motion.cast`; 983×694, 33612 bytes, SHA-256 `72239998999415b8cf1cc349a2435b56117eb406b2d3391cb74a0a06d54383c8`.

## First-success journey

**Actor:** Keyboard user evaluating the real terminal application  
**Goal:** Reach the first inspectable music result in Termusic, discover controls, and recover from a blocked or transient state  

| State | User action | System response | Evidence |
|---:|---|---|---|
| 1 | Launch Termusic with the recorded prerequisite/fixture | The application claims the terminal and begins its first render | isolated real-program terminal cast at the opening segment |
...
- Upstream owner: `tramhao`
- Source/capture URL: https://github.com/tramhao/termusic
