...
**Product:** [https://github.com/orf/gping](https://github.com/orf/gping)  
...
This is authentic product motion, not an animation synthesized from the catalog still. Source: [https://raw.githubusercontent.com/orf/gping/master/images/readme-example.gif](https://raw.githubusercontent.com/orf/gping/master/images/readme-example.gif). Local SHA-256: `b5d534bbe19716a3aec50dccb8d85ac376b33e48a4db75f6725121dc5a028431`. Duration: 21.280s; frames/output events: 266; bytes: 1236707; dimensions: 1411 × 757.

## Key states

### first stable surface

![gping — first stable surface](media/state-1.png)

Derived directly from `media/product-motion.gif`; 1411×757, 33906 bytes, SHA-256 `e2d97408e23df8703afef14469e0377b6aba87dc67e33ee207dc51415f313bc3`.

### selection or detail transition

![gping — selection or detail transition](media/state-2.png)

Derived directly from `media/product-motion.gif`; 1411×757, 73283 bytes, SHA-256 `6635f055bd0c3736ac98ea18f5316a7ce3ea4863caadea74f4a6f06f30e1358b`.

### help, recovery, or completion

![gping — help, recovery, or completion](media/state-3.png)

Derived directly from `media/product-motion.gif`; 1411×757, 77334 bytes, SHA-256 `1af66065a7afd5e04ddbfd2367ced2e68f1b85430c3bb3b531aea7ebabeaf4af`.

## First-success journey

**Actor:** Keyboard user evaluating the real terminal application  
**Goal:** Reach the first inspectable networking result in gping, discover controls, and recover from a blocked or transient state  

| State | User action | System response | Evidence |
|---:|---|---|---|
| 1 | Launch gping with the recorded prerequisite/fixture | The application claims the terminal and begins its first render | official upstream motion at the opening segment |
...
- Upstream owner: `orf`
- Source/capture URL: https://raw.githubusercontent.com/orf/gping/master/images/readme-example.gif
