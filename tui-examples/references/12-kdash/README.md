...
**Product:** [https://github.com/kdash-rs/kdash](https://github.com/kdash-rs/kdash)  
...
This is authentic product motion, not an animation synthesized from the catalog still. Source: [https://raw.githubusercontent.com/kdash-rs/kdash/HEAD/screenshots/ui.gif](https://raw.githubusercontent.com/kdash-rs/kdash/HEAD/screenshots/ui.gif). Local SHA-256: `dfea7779afb83407a8d6ae8e588fa544e1672a0fa2c9136e05da443ea6e6eb6c`. Duration: 40.580s; frames/output events: 120; bytes: 845123; dimensions: 1281 × 608.

## Key states

### first stable surface

![KDash — first stable surface](media/state-1.png)

Derived directly from `media/product-motion.gif`; 1281×608, 64353 bytes, SHA-256 `39eff6fb9f0e1d708831850307edc35cab9a841aafa71a144445a782cac922d2`.

### selection or detail transition

![KDash — selection or detail transition](media/state-2.png)

Derived directly from `media/product-motion.gif`; 1281×608, 45699 bytes, SHA-256 `fe3ab38e1c54c7abe76891255695727d2f2ec110225e76925b9f8c27bcbda15e`.

### help, recovery, or completion

![KDash — help, recovery, or completion](media/state-3.png)

Derived directly from `media/product-motion.gif`; 1281×608, 64341 bytes, SHA-256 `9e57d3c9e86087743860899a3bca42295e419a0322c5263b738937cdc5440911`.

## First-success journey

**Actor:** Keyboard user evaluating the real terminal application  
**Goal:** Reach the first inspectable kubernetes result in KDash, discover controls, and recover from a blocked or transient state  

| State | User action | System response | Evidence |
|---:|---|---|---|
| 1 | Launch KDash with the recorded prerequisite/fixture | The application claims the terminal and begins its first render | official upstream motion at the opening segment |
...
- Upstream owner: `kdash-rs`
- Source/capture URL: https://raw.githubusercontent.com/kdash-rs/kdash/HEAD/screenshots/ui.gif
