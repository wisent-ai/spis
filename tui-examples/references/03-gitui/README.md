...
**Product:** [https://github.com/gitui-org/gitui](https://github.com/gitui-org/gitui)  
...
This is authentic product motion, not an animation synthesized from the catalog still. Source: [https://raw.githubusercontent.com/gitui-org/gitui/HEAD/demo.gif](https://raw.githubusercontent.com/gitui-org/gitui/HEAD/demo.gif). Local SHA-256: `371d5856951ff2d42f14a5f49be82494649f646e299b59461b7392099f78eda1`. Duration: 32.120s; frames/output events: 173; bytes: 1877839; dimensions: 1024 × 622.

## Key states

### first stable surface

![GitUI — first stable surface](media/state-1.png)

Derived directly from `media/product-motion.gif`; 1024×622, 133613 bytes, SHA-256 `1baa5dfbaacbc1ea986f35db8e2fd3d95379430a693b1b86b3510cd1fad3ad57`.

### selection or detail transition

![GitUI — selection or detail transition](media/state-2.png)

Derived directly from `media/product-motion.gif`; 1024×622, 216442 bytes, SHA-256 `f9cd55d6404529f89afe5c9e7db0b5a570861d3e35a77cf8aeacf7e25671c3a0`.

### help, recovery, or completion

![GitUI — help, recovery, or completion](media/state-3.png)

Derived directly from `media/product-motion.gif`; 1024×622, 67553 bytes, SHA-256 `0abf9c1513d4dad8b11c6873c67dc0f191a4d325c5eb2c3428cccbb77976b7bb`.

## First-success journey

**Actor:** Keyboard user evaluating the real terminal application  
**Goal:** Reach the first inspectable git and developer workflows result in GitUI, discover controls, and recover from a blocked or transient state  

| State | User action | System response | Evidence |
|---:|---|---|---|
| 1 | Launch GitUI with the recorded prerequisite/fixture | The application claims the terminal and begins its first render | official upstream motion at the opening segment |
...
- Upstream owner: `gitui-org`
- Source/capture URL: https://raw.githubusercontent.com/gitui-org/gitui/HEAD/demo.gif
