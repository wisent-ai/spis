...
**Product:** [https://github.com/jesseduffield/lazydocker](https://github.com/jesseduffield/lazydocker)  
...
This is authentic product motion, not an animation synthesized from the catalog still. Source: [https://raw.githubusercontent.com/jesseduffield/lazydocker/HEAD/docs/resources/demo3.gif](https://raw.githubusercontent.com/jesseduffield/lazydocker/HEAD/docs/resources/demo3.gif). Local SHA-256: `74034836caf209e7434969b7ae1d5de721a0f090cea551d073cd38fc4fc64d09`. Duration: 9.540s; frames/output events: 143; bytes: 5447632; dimensions: 1706 × 960.

## Key states

### first stable surface

![lazydocker — first stable surface](media/state-1.png)

Derived directly from `media/product-motion.gif`; 1706×960, 367477 bytes, SHA-256 `adb52a45c54fbfc09d4990561c1aed5d1dffc62c62af5fbbd7cdba3a68e7f881`.

### selection or detail transition

![lazydocker — selection or detail transition](media/state-2.png)

Derived directly from `media/product-motion.gif`; 1706×960, 604168 bytes, SHA-256 `cd4bd61cab7ccad0b625a7bc33981524e14b37675650fba29ab6a4074be69836`.

### help, recovery, or completion

![lazydocker — help, recovery, or completion](media/state-3.png)

Derived directly from `media/product-motion.gif`; 1706×960, 486107 bytes, SHA-256 `eda6deb117ca7f13d42dffd1e8db420a093cbee6d1dc717135cbb4c54e021360`.

## First-success journey

**Actor:** Keyboard user evaluating the real terminal application  
**Goal:** Reach the first inspectable containers result in lazydocker, discover controls, and recover from a blocked or transient state  

| State | User action | System response | Evidence |
|---:|---|---|---|
| 1 | Launch lazydocker with the recorded prerequisite/fixture | The application claims the terminal and begins its first render | official upstream motion at the opening segment |
...
- Source/capture URL: https://raw.githubusercontent.com/jesseduffield/lazydocker/HEAD/docs/resources/demo3.gif
