...
**Product:** [https://github.com/rjarry/aerc](https://github.com/rjarry/aerc)  
...
`agg media/product-motion.cast /tmp/aerc.gif` then play `/tmp/aerc.gif`

This is authentic product motion, not an animation synthesized from the catalog still. Source: [https://github.com/rjarry/aerc](https://github.com/rjarry/aerc). Local SHA-256: `7e0d326f065a86151c85c3ccc30a664b7525ee46899702272dd4ab667f8688bf`. Duration: 4.374s; frames/output events: 20; bytes: 6708; dimensions: terminal columns in cast header × terminal rows in cast header.

## Key states

### first stable surface

![aerc — first stable surface](media/state-1.png)

Derived directly from `media/product-motion.cast`; 983×694, 14185 bytes, SHA-256 `9b13bcfa180d6d53ba921bf4dbdfa345034574f8d7be6f4472d1e78b66571c4d`.

### selection or detail transition

![aerc — selection or detail transition](media/state-2.png)

Derived directly from `media/product-motion.cast`; 983×694, 11293 bytes, SHA-256 `c26d8fa8ca19ca3bf77480a09683294c7b2709c40a97890f0eee671b22e56ebd`.

### help, recovery, or completion

![aerc — help, recovery, or completion](media/state-3.png)

Derived directly from `media/product-motion.cast`; 983×694, 10262 bytes, SHA-256 `4d82ab5354d78fac340b2537471d8cb9eecfce58daac606a3b4bd9e33f4c009a`.

## First-success journey

**Actor:** Keyboard user evaluating the real terminal application  
**Goal:** Reach the first inspectable mail result in aerc, discover controls, and recover from a blocked or transient state  

| State | User action | System response | Evidence |
|---:|---|---|---|
| 1 | Launch aerc with the recorded prerequisite/fixture | The application claims the terminal and begins its first render | isolated real-program terminal cast at the opening segment |
...
- Upstream owner: `rjarry`
- Source/capture URL: https://github.com/rjarry/aerc
