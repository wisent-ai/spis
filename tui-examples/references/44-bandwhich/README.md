...
**Product:** [https://github.com/imsnif/bandwhich](https://github.com/imsnif/bandwhich)  
...
This is authentic product motion, not an animation synthesized from the catalog still. Source: [https://raw.githubusercontent.com/imsnif/bandwhich/HEAD/res/demo.gif](https://raw.githubusercontent.com/imsnif/bandwhich/HEAD/res/demo.gif). Local SHA-256: `ef71c315ae09af574b18ae06b7ea1e7dfe3ce56a8b5702258b34da45ee4fcc15`. Duration: 24.360s; frames/output events: 731; bytes: 3698090; dimensions: 1572 × 828.

## Key states

### first stable surface

![bandwhich — first stable surface](media/state-1.png)

Derived directly from `media/product-motion.gif`; 1572×828, 120866 bytes, SHA-256 `7601c8cf68e7900d5a71b55c34eb450f0c6ace3071f6ff58123cc1d89eae9b7d`.

### selection or detail transition

![bandwhich — selection or detail transition](media/state-2.png)

Derived directly from `media/product-motion.gif`; 1572×828, 117295 bytes, SHA-256 `549c1d1a81cdce2035b5775d12afa736154040ad87f02cd71b6a4be587b5c9bd`.

### help, recovery, or completion

![bandwhich — help, recovery, or completion](media/state-3.png)

Derived directly from `media/product-motion.gif`; 1572×828, 118145 bytes, SHA-256 `c1fe3345f640f4c0e131c65ab097bd3127075a82bf2bd18d093e47f86ccec6cb`.

## First-success journey

**Actor:** Keyboard user evaluating the real terminal application  
**Goal:** Reach the first inspectable networking result in bandwhich, discover controls, and recover from a blocked or transient state  

| State | User action | System response | Evidence |
|---:|---|---|---|
| 1 | Launch bandwhich with the recorded prerequisite/fixture | The application claims the terminal and begins its first render | official upstream motion at the opening segment |
...
- Upstream owner: `imsnif`
- Source/capture URL: https://raw.githubusercontent.com/imsnif/bandwhich/HEAD/res/demo.gif
