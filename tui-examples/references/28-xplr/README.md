...
**Product:** [https://github.com/sayanarijit/xplr](https://github.com/sayanarijit/xplr)  
...
Open [`media/product-motion.mp4`](media/product-motion.mp4) in a local player.

This is authentic product motion, not an animation synthesized from the catalog still. Source: [https://user-images.githubusercontent.com/11632726/166747867-8a4573f2-cb2f-43a6-a23d-c99fc30c6594.mp4](https://user-images.githubusercontent.com/11632726/166747867-8a4573f2-cb2f-43a6-a23d-c99fc30c6594.mp4). Local SHA-256: `8e326ff16f177237c4f4e6a34b04288221b38e4a704203552dfb17cbd50b59d5`. Duration: 119.932s; frames/output events: 3598; bytes: 16162992; dimensions: 1280 × 674.

## Key states

### first stable surface

![xplr — first stable surface](media/state-1.png)

Derived directly from `media/product-motion.mp4`; 1280×674, 258828 bytes, SHA-256 `3272951ae769e02b04f4ee7f77cadc258a5436b60761839db1405a5c1e479772`.

### selection or detail transition

![xplr — selection or detail transition](media/state-2.png)

Derived directly from `media/product-motion.mp4`; 1280×674, 348027 bytes, SHA-256 `2367bca8be959face2ea7839c2d7f501614592e05130324fda95af3fe8c6277e`.

### help, recovery, or completion

![xplr — help, recovery, or completion](media/state-3.png)

Derived directly from `media/product-motion.mp4`; 1280×674, 213499 bytes, SHA-256 `1ab6244bffef2264ea96b4bb86756c1a4a3d5110b0e0cb9ba265120f612db4b7`.

## First-success journey

**Actor:** Keyboard user evaluating the real terminal application  
**Goal:** Reach the first inspectable file management result in xplr, discover controls, and recover from a blocked or transient state  

| State | User action | System response | Evidence |
|---:|---|---|---|
| 1 | Launch xplr with the recorded prerequisite/fixture | The application claims the terminal and begins its first render | official upstream motion at the opening segment |
...
- Upstream owner: `sayanarijit`
- Source/capture URL: https://user-images.githubusercontent.com/11632726/166747867-8a4573f2-cb2f-43a6-a23d-c99fc30c6594.mp4
