...
**Product:** [https://github.com/moncho/dry](https://github.com/moncho/dry)  
...
`agg media/product-motion.cast /tmp/dry.gif` then play `/tmp/dry.gif`

This is authentic product motion, not an animation synthesized from the catalog still. Source: [https://asciinema.org/a/35825.cast](https://asciinema.org/a/35825.cast). Local SHA-256: `12195a33ff512c8ebe90a9fecf2e3f90a982a37ff02f514a35ae534f9702d688`. Duration: 117.101s; frames/output events: 841; bytes: 743131; dimensions: terminal columns in cast header × terminal rows in cast header.

## Key states

### first stable surface

![Dry — first stable surface](media/state-1.png)

Derived directly from `media/product-motion.cast`; 983×694, 66643 bytes, SHA-256 `2688b2138de42425d2140de5b261a3decc46f30335b19d174fd9621a5ecbce8a`.

### selection or detail transition

![Dry — selection or detail transition](media/state-2.png)

Derived directly from `media/product-motion.cast`; 983×694, 93945 bytes, SHA-256 `c027f4be8f1c501ce8f782d2aa10629b511caa86cc762bc9c35afa7525738fea`.

### help, recovery, or completion

![Dry — help, recovery, or completion](media/state-3.png)

Derived directly from `media/product-motion.cast`; 983×694, 36683 bytes, SHA-256 `75406fcdce90a4ff306f481be51f4d53db881b993778f09da8bf11cf57391732`.

## First-success journey

**Actor:** Keyboard user evaluating the real terminal application  
**Goal:** Reach the first inspectable containers result in Dry, discover controls, and recover from a blocked or transient state  

| State | User action | System response | Evidence |
|---:|---|---|---|
| 1 | Launch Dry with the recorded prerequisite/fixture | The application claims the terminal and begins its first render | official upstream motion at the opening segment |
...
- Upstream owner: `moncho`
- Source/capture URL: https://asciinema.org/a/35825.cast
