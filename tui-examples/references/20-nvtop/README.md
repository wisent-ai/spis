...
**Product:** [https://github.com/Syllo/nvtop](https://github.com/Syllo/nvtop)  
...
`agg media/product-motion.cast /tmp/nvtop.gif` then play `/tmp/nvtop.gif`

This is authentic product motion, not an animation synthesized from the catalog still. Source: [https://github.com/Syllo/nvtop](https://github.com/Syllo/nvtop). Local SHA-256: `47d074d4de41d489a49d219cc8a8114a09de8686a5f9240ad920b885b0241091`. Duration: 3.605s; frames/output events: 10; bytes: 8040; dimensions: terminal columns in cast header × terminal rows in cast header.

## Key states

### first stable surface

![NVTOP — first stable surface](media/state-1.png)
...
![NVTOP — selection or detail transition](media/state-2.png)

Derived directly from `media/product-motion.cast`; 983×694, 55931 bytes, SHA-256 `c83dcb524e68e201502a1b5a0de2738869be5d3538a8b44ffc02801202e7c94a`.

### help, recovery, or completion

![NVTOP — help, recovery, or completion](media/state-3.png)

Derived directly from `media/product-motion.cast`; 983×694, 55929 bytes, SHA-256 `155f7628bad4ced64f6e99c03f52b0588241e5a731ae973f0ecb770af7003e66`.

## First-success journey

**Actor:** Keyboard user evaluating the real terminal application  
**Goal:** Reach the first inspectable system monitoring result in NVTOP, discover controls, and recover from a blocked or transient state  

| State | User action | System response | Evidence |
|---:|---|---|---|
| 1 | Launch NVTOP with the recorded prerequisite/fixture | The application claims the terminal and begins its first render | isolated real-program terminal cast at the opening segment |
...
- Upstream owner: `Syllo`
- Source/capture URL: https://github.com/Syllo/nvtop
