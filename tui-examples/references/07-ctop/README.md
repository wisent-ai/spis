...
**Product:** [https://github.com/bcicen/ctop](https://github.com/bcicen/ctop)  
...
This is authentic product motion, not an animation synthesized from the catalog still. Source: [https://raw.githubusercontent.com/bcicen/ctop/HEAD/_docs/img/grid.gif](https://raw.githubusercontent.com/bcicen/ctop/HEAD/_docs/img/grid.gif). Local SHA-256: `22b1a1c2f4b457a39cfe491552634c1e0d1cf726b081a17e1e771c85cf6872cf`. Duration: 4.750s; frames/output events: 19; bytes: 691694; dimensions: 1195 × 414.

## Key states

### first stable surface

![ctop — first stable surface](media/state-1.png)

Derived directly from `media/product-motion.gif`; 1195×414, 270369 bytes, SHA-256 `9dbd7363f0101c9359d986d61e9dc2a960f1c1d92b02fe57cf65862f4c19035c`.

### selection or detail transition

![ctop — selection or detail transition](media/state-2.png)

Derived directly from `media/product-motion.gif`; 1195×414, 279420 bytes, SHA-256 `eaa7c0051d6bb3a5d3f74894d8fe651d1f8427a1ccc660b4809cebe30b6c8ea4`.

### help, recovery, or completion

![ctop — help, recovery, or completion](media/state-3.png)

Derived directly from `media/product-motion.gif`; 1195×414, 280472 bytes, SHA-256 `7d35e8c76b273bd88a8d20b00dca0f0b23d1607e1383015ff8bb8637aa9e8a0e`.

## First-success journey

**Actor:** Keyboard user evaluating the real terminal application  
**Goal:** Reach the first inspectable containers result in ctop, discover controls, and recover from a blocked or transient state  

| State | User action | System response | Evidence |
|---:|---|---|---|
| 1 | Launch ctop with the recorded prerequisite/fixture | The application claims the terminal and begins its first render | official upstream motion at the opening segment |
...
- Upstream owner: `bcicen`
- Source/capture URL: https://raw.githubusercontent.com/bcicen/ctop/HEAD/_docs/img/grid.gif
