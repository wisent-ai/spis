...
**Product:** [https://github.com/altsem/gitu](https://github.com/altsem/gitu)  
...
This is authentic product motion, not an animation synthesized from the catalog still. Source: [https://raw.githubusercontent.com/altsem/gitu/HEAD/vhs/rec.gif](https://raw.githubusercontent.com/altsem/gitu/HEAD/vhs/rec.gif). Local SHA-256: `eba2e0341d40cd6c8a7d274ca3f4576c7248ca547cd24cc6a9ab7785dcee9bc9`. Duration: 31.960s; frames/output events: 799; bytes: 3533338; dimensions: 1200 × 800.

## Key states

### first stable surface

![Gitu — first stable surface](media/state-1.png)

Derived directly from `media/product-motion.gif`; 1200×800, 238246 bytes, SHA-256 `fda6b7a2a194f87fcc0885cc88e5aa30587db953639d49938f537b8d6bb7c91d`.

### selection or detail transition

![Gitu — selection or detail transition](media/state-2.png)

Derived directly from `media/product-motion.gif`; 1200×800, 265032 bytes, SHA-256 `643389e653052ee8734ccbf5c2612750236abea106c7b921e06db1b098b296c9`.

### help, recovery, or completion

![Gitu — help, recovery, or completion](media/state-3.png)

Derived directly from `media/product-motion.gif`; 1200×800, 466569 bytes, SHA-256 `1d09fb591ee86a2d745b32810d6e353c8cd1c3759ae0b1f4a97ba7a78eefab9a`.

## First-success journey

**Actor:** Keyboard user evaluating the real terminal application  
**Goal:** Reach the first inspectable git and developer workflows result in Gitu, discover controls, and recover from a blocked or transient state  

| State | User action | System response | Evidence |
|---:|---|---|---|
| 1 | Launch Gitu with the recorded prerequisite/fixture | The application claims the terminal and begins its first render | official upstream motion at the opening segment |
...
- Upstream owner: `altsem`
- Source/capture URL: https://raw.githubusercontent.com/altsem/gitu/HEAD/vhs/rec.gif
