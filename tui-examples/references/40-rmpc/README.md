...
**Product:** [https://github.com/mierak/rmpc](https://github.com/mierak/rmpc)  
...
`agg media/product-motion.cast /tmp/rmpc.gif` then play `/tmp/rmpc.gif`

This is authentic product motion, not an animation synthesized from the catalog still. Source: [https://github.com/mierak/rmpc](https://github.com/mierak/rmpc). Local SHA-256: `0d4473b631ad0825e1c39b0d27a49ad03baec2a986a4970718a8cc613c6bf5da`. Duration: 4.354s; frames/output events: 122; bytes: 115276; dimensions: terminal columns in cast header × terminal rows in cast header.

## Key states

### first stable surface

![rmpc — first stable surface](media/state-1.png)
...
![rmpc — selection or detail transition](media/state-2.png)

Derived directly from `media/product-motion.cast`; 983×694, 22570 bytes, SHA-256 `e38a11b6c6bf08991113012f2acdc5277ca68a71d9bc8ea5d8f81cfc053d514b`.

### help, recovery, or completion

![rmpc — help, recovery, or completion](media/state-3.png)

Derived directly from `media/product-motion.cast`; 983×694, 22512 bytes, SHA-256 `acef1c14967a543542a52235f747b58a3ce42c4f1ad73b480cde3fbd1991b1f8`.

## First-success journey

**Actor:** Keyboard user evaluating the real terminal application  
**Goal:** Reach the first inspectable music result in rmpc, discover controls, and recover from a blocked or transient state  

| State | User action | System response | Evidence |
|---:|---|---|---|
| 1 | Launch rmpc with the recorded prerequisite/fixture | The application claims the terminal and begins its first render | isolated real-program terminal cast at the opening segment |
...
- Upstream owner: `mierak`
- Source/capture URL: https://github.com/mierak/rmpc
