...
**Product:** [https://github.com/ncmpcpp/ncmpcpp](https://github.com/ncmpcpp/ncmpcpp)  
...
`agg media/product-motion.cast /tmp/ncmpcpp.gif` then play `/tmp/ncmpcpp.gif`

This is authentic product motion, not an animation synthesized from the catalog still. Source: [https://github.com/ncmpcpp/ncmpcpp](https://github.com/ncmpcpp/ncmpcpp). Local SHA-256: `bba2f6267027562c2b7adce1a498ff5ae5d3c747ca98078c62d8469559e6b6fd`. Duration: 5.890s; frames/output events: 30; bytes: 2791; dimensions: terminal columns in cast header × terminal rows in cast header.

## Key states

### first stable surface

![ncmpcpp — first stable surface](media/state-1.png)

Derived directly from `media/product-motion.cast`; 983×694, 12026 bytes, SHA-256 `c79a7a2b4cb7d567616c76567f25f54a2923518d48e5a11e9de2a1f33f31808d`.

### selection or detail transition

![ncmpcpp — selection or detail transition](media/state-2.png)

Derived directly from `media/product-motion.cast`; 983×694, 8929 bytes, SHA-256 `a67cc172959bc262e2c210f14a874700af31d95649919ff843967beab6f4ca7a`.

### help, recovery, or completion

![ncmpcpp — help, recovery, or completion](media/state-3.png)

Derived directly from `media/product-motion.cast`; 983×694, 11558 bytes, SHA-256 `6e40f8f3b95cb3d13d3add5502087542192a78004c706ed72bf4198d5c4d625c`.

## First-success journey

**Actor:** Keyboard user evaluating the real terminal application  
**Goal:** Reach the first inspectable music result in ncmpcpp, discover controls, and recover from a blocked or transient state  

| State | User action | System response | Evidence |
|---:|---|---|---|
| 1 | Launch ncmpcpp with the recorded prerequisite/fixture | The application claims the terminal and begins its first render | isolated real-program terminal cast at the opening segment |
...
- Upstream owner: `ncmpcpp`
- Source/capture URL: https://github.com/ncmpcpp/ncmpcpp
