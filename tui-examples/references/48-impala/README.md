...
**Product:** [https://github.com/pythops/impala](https://github.com/pythops/impala)  
...
This is authentic product motion, not an animation synthesized from the catalog still. Source: [https://private-user-images.githubusercontent.com/57548585/502253762-55c800ff-d0aa-4454-aa6b-3990833ce530.gif](https://private-user-images.githubusercontent.com/57548585/502253762-55c800ff-d0aa-4454-aa6b-3990833ce530.gif). Local SHA-256: `78eb4b02af61d9d10499a357bd59c0855b5abba28b90edc439ab8a8186670092`. Duration: 17.830s; frames/output events: 40; bytes: 340773; dimensions: 1289 × 1134.

## Key states

### first stable surface

![Impala — first stable surface](media/state-1.png)

Derived directly from `media/product-motion.gif`; 1289×1134, 84229 bytes, SHA-256 `c88daf558ade319ae27e84ac519edcb1a361663b8d3d7a90bce11b860dd565c2`.

### selection or detail transition

![Impala — selection or detail transition](media/state-2.png)

Derived directly from `media/product-motion.gif`; 1289×1134, 70927 bytes, SHA-256 `23da5796542f1624a5a7e9ab300ad5dbf7f882ebb6fd64ea7b812aa88cb43283`.

### help, recovery, or completion

![Impala — help, recovery, or completion](media/state-3.png)

Derived directly from `media/product-motion.gif`; 1289×1134, 72594 bytes, SHA-256 `142355217deed670c915f13de5fbf290cc784dfd2ff760b11924a805e60bf001`.

## First-success journey

**Actor:** Keyboard user evaluating the real terminal application  
**Goal:** Reach the first inspectable networking result in Impala, discover controls, and recover from a blocked or transient state  

| State | User action | System response | Evidence |
|---:|---|---|---|
| 1 | Launch Impala with the recorded prerequisite/fixture | The application claims the terminal and begins its first render | official upstream motion at the opening segment |
...
- Upstream owner: `pythops`
- Source/capture URL: https://private-user-images.githubusercontent.com/57548585/502253762-55c800ff-d0aa-4454-aa6b-3990833ce530.gif
