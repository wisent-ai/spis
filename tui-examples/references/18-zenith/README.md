...
**Product:** [https://github.com/bvaisvil/zenith](https://github.com/bvaisvil/zenith)  
...
`agg media/product-motion.cast /tmp/zenith.gif` then play `/tmp/zenith.gif`

This is authentic product motion, not an animation synthesized from the catalog still. Source: [https://github.com/bvaisvil/zenith](https://github.com/bvaisvil/zenith). Local SHA-256: `0ca2618235719f29047cc86ee70f72dbf64c37f2f32afd3a8263e4873ea174d5`. Duration: 5.138s; frames/output events: 25; bytes: 17242; dimensions: terminal columns in cast header × terminal rows in cast header.

## Key states

### first stable surface

![Zenith — first stable surface](media/state-1.png)

Derived directly from `media/product-motion.cast`; 983×694, 8726 bytes, SHA-256 `bf672d677169ee15bdf79846fa995f6dc04dbf0e539227897e2caf3ce36cb44d`.

### selection or detail transition

![Zenith — selection or detail transition](media/state-2.png)

Derived directly from `media/product-motion.cast`; 983×694, 109034 bytes, SHA-256 `c950f5150552fb68136f0c9218f289023950287ea9f84f964c698fd0b6e9e241`.

### help, recovery, or completion

![Zenith — help, recovery, or completion](media/state-3.png)

Derived directly from `media/product-motion.cast`; 983×694, 110637 bytes, SHA-256 `1baf7425c522d3c875316501aa5107f39dbe0db5451ae449caccb32dc1aecf7b`.

## First-success journey

**Actor:** Keyboard user evaluating the real terminal application  
**Goal:** Reach the first inspectable system monitoring result in Zenith, discover controls, and recover from a blocked or transient state  

| State | User action | System response | Evidence |
|---:|---|---|---|
| 1 | Launch Zenith with the recorded prerequisite/fixture | The application claims the terminal and begins its first render | isolated real-program terminal cast at the opening segment |
...
- Upstream owner: `bvaisvil`
- Source/capture URL: https://github.com/bvaisvil/zenith
